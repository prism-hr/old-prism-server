			...
			<tr>
		  	...
		  	<tr>
		    	...
		    	<td width="500">
			      	...
			      	<p>
			      		<font face="Arial, Helvetica, sans-serif" size="2">${application.applicant.firstName} ${application.applicant.lastName} has updated Application ${application.applicationNumber} for UCL 
