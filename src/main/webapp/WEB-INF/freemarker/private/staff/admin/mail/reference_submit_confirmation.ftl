			...
			<tr>
		  	...
		  	<tr>
		    	...
		    	<td width="500">
			      	...
			      	<p>
			      		<font face="Arial, Helvetica, sans-serif" size="2">A reference has been provided for application ${application.id?string("######")} by ${referee.firstname?html} ${referee.lastname?html}. You can view the application here: </font>
			      	</p>
			      	<p>
			      		<font face="Arial, Helvetica, sans-serif" size="2">
			      			<a href="${host}/pgadmissions/application?view=view&id=${application.id?string("######")}">View the application</a>
			      		</font>
			      	</p>
			      	<p>
