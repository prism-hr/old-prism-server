...
public class SubmitAdmissionsApplicationRequestBuilderTest extends UclIntegrationBaseTest {
    ...
    public void shouldBuildValidWebServiceRequest() throws JAXBException, DatatypeConfigurationException {
        ...
        request.getApplication().getCourseApplication().setCreationDate(null);
        for (EnglishLanguageTp languageTp : request.getApplication().getApplicant().getEnglishLanguageQualificationList().getEnglishLanguageQualification()) {
            languageTp.setDateTaken(null);
        }
