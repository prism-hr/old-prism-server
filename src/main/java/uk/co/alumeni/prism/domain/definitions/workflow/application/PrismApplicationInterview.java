...
public class PrismApplicationInterview extends PrismWorkflowState {
    ...
    protected void setStateActions() {
        stateActions.add(new PrismStateAction() //
                ...
                .withStateTransitions(new PrismStateTransition() //
                        ...
                        .withTransitionAction(PrismAction.APPLICATION_PROVIDE_INTERVIEW_AVAILABILITY) //
        ...
        stateActions.add(applicationCompleteState(PrismAction.APPLICATION_COMPLETE_INTERVIEW_STAGE, state, APPLICATION_PARENT_ADMINISTRATOR_GROUP));
    ...
    public static PrismStateAction applicationCompleteInterviewScheduling(PrismState state) {
        return applicationCompleteState(PrismAction.APPLICATION_COMPLETE_INTERVIEW_STAGE, state, //
    ...
    public static PrismStateAction applicationProvideInterviewFeedback() {
        return new PrismStateAction() //
                ...
                .withAssignments(PrismRole.APPLICATION_INTERVIEWER);
    }
    ...
    public static PrismStateAction applicationViewEditInterviewScheduling(PrismState state) {
        return applicationViewEditInterviewScheduled(state) //
                .withAssignments(PrismRole.APPLICATION_POTENTIAL_INTERVIEWER, PrismActionEnhancement.APPLICATION_VIEW_AS_RECRUITER);
    }
    ...
    public static PrismStateAction applicationViewEditInterviewScheduled(PrismState state) {
        return applicationViewEditWithViewerRecruiter(state) //
                .withAssignments(PrismRole.APPLICATION_INTERVIEWER, PrismActionEnhancement.APPLICATION_VIEW_AS_RECRUITER);
    }
