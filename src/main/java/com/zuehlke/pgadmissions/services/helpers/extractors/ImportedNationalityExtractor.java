...
@Component
public class ImportedNationalityExtractor implements ImportedEntityExtractor {
    ...
    public List<String> extract(Institution institution, PrismImportedEntity prismImportedEntity, List<Object> definitions) throws Exception {
        ...
        for (Object definition : definitions) {
            Nationality nationality = (Nationality) definition;
            ...
            cells.add(prepareStringForSqlInsert(nationality.getCode()));
            cells.add(prepareStringForSqlInsert(nationality.getName()));
