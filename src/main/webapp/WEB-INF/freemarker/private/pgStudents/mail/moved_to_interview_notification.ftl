			...
			<tr>
		  	...
		  	<tr>
		    	...
		    	<td width="500">
			      	...
			      	<p>
			      		<font face="Arial, Helvetica, sans-serif" size="2">The interview will take place at ${application.latestInterview.interviewTime?datetime("hh:mm a")} on ${application.latestInterview.interviewDueDate?datetime("dd/MM/yyyy")}.</font>
			      	</p>
			      	<p>
