...
public enum PrismStateGroup {
    ...
    APPLICATION_REVIEW(3, true, APPLICATION), //
    APPLICATION_INTERVIEW(4, true, APPLICATION), //
    APPLICATION_APPROVAL(5, true, APPLICATION), //
    APPLICATION_APPROVED(6, true, APPLICATION), //
    APPLICATION_REJECTED(7, true, APPLICATION), //
    APPLICATION_WITHDRAWN(8, false, APPLICATION), //
