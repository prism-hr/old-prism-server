...
public class Comment {
    ...
    @OneToMany(cascade = CascadeType.ALL, orphanRemoval = true)
    @JoinColumn(name = "comment_id", nullable = false)
    @PrismConstraintRequiredStateTransition(state = APPLICATION_INTERVIEW, action = APPLICATION_ASSIGN_INTERVIEWERS, transitionState = APPLICATION_INTERVIEW_PENDING_SCHEDULING,
            error = SYSTEM_VALIDATION_REQUIRED)
