...
public enum PrismDisplayPropertyDefinition {
    ...
    SYSTEM_INSTITUTION_PLURAL(SYSTEM_GLOBAL, "Institutions", SYSTEM), //
    SYSTEM_DEPARTMENT(SYSTEM_GLOBAL, "Department", SYSTEM), //
    SYSTEM_DEPARTMENT_PLURAL(SYSTEM_GLOBAL, "Departments", SYSTEM), //
    SYSTEM_PROGRAM(SYSTEM_GLOBAL, "Program", SYSTEM), //
    SYSTEM_PROGRAM_PLURAL(SYSTEM_GLOBAL, "Programs", SYSTEM), //
    SYSTEM_PROJECT(SYSTEM_GLOBAL, "Project", SYSTEM), //
    SYSTEM_PROJECT_PLURAL(SYSTEM_GLOBAL, "Projects", SYSTEM), //
    SYSTEM_CLOSING_DATE(SYSTEM_GLOBAL, "Closing Date", SYSTEM), //
    SYSTEM_CLOSING_DATE_PLURAL(SYSTEM_GLOBAL, "Closing Dates", SYSTEM), //
    SYSTEM_PANEL_DEADLINE(SYSTEM_GLOBAL, "Panel Deadline", SYSTEM), //
    SYSTEM_PANEL_DEADLINE_PLURAL(SYSTEM_GLOBAL, "Panel Deadlines", SYSTEM), //
    SYSTEM_APPLICATION(SYSTEM_GLOBAL, "Application", SYSTEM), //
    SYSTEM_APPLICATION_PLURAL(SYSTEM_GLOBAL, "Applications", SYSTEM), //
    ...
    SYSTEM_LINK(SYSTEM_GLOBAL, "Link", SYSTEM), //
    ...
    SYSTEM_ADDRESS_LINE_MOCK(SYSTEM_INTEGRATION, "Address Line", SYSTEM), //
    SYSTEM_ADDRESS_CODE_MOCK(SYSTEM_INTEGRATION, "Address Code", SYSTEM), //
    SYSTEM_PHONE_MOCK(SYSTEM_INTEGRATION, "0000000000", SYSTEM), //
    ...
    APPLICATION_PRIMARY_THEME(APPLICATION_GLOBAL, "Primary Subjects", APPLICATION), //
    APPLICATION_SECONDARY_THEME(APPLICATION_GLOBAL, "Secondary Subjects", APPLICATION), //
    APPLICATION_REFEREES(APPLICATION_GLOBAL, "Referees", APPLICATION), //
    ...
    APPLICATION_EMPLOYER_ADDRESS(APPLICATION_GLOBAL, "Employer Address", APPLICATION), //
    ...
    APPLICATION_REFEREE_TYPE_ACADEMIC(APPLICATION_REFEREE, "Academic", APPLICATION), //
    APPLICATION_REFEREE_TYPE_EMPLOYER(APPLICATION_REFEREE, "Employer", APPLICATION), //
    ...
    APPLICATION_CONFIRM_ELIGIBILITY_DURATION_LABEL(APPLICATION_STATE_DURATION, "Eligibility Confirmation Duration", APPLICATION), //
