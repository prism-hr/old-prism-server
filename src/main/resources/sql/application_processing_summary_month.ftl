...
left join application_language_qualification
	on application_personal_detail.application_language_qualification_id = application_language_qualification.id
...
order by application.application_year, application.application_month_sequence;
