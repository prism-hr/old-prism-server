...
public enum PrismDisplayPropertyDefinition {
	...
	APPLICATION_RESERVE_NOTIFICATION_LABEL(SYSTEM_NOTIFICATION, "Application Confirm Reserved Notification"),
	APPLICATION_RESERVE_NOTIFICATION_TOOLTIP(SYSTEM_NOTIFICATION,
	        "Confirmation to an applicant that they have been placed on the reserve list"),
	...
	APPLICATION_CORRECT_REQUEST_LABEL(SYSTEM_NOTIFICATION, "Application Correct Request"),
	APPLICATION_CORRECT_REQUEST_TOOLTIP(SYSTEM_NOTIFICATION, "First request to correct errors in an applicaton that could not be exported"),
	APPLICATION_CORRECT_REQUEST_REMINDER_LABEL(SYSTEM_NOTIFICATION, "Application Correct Request Reminder"),
	APPLICATION_CORRECT_REQUEST_REMINDER_TOOLTIP(SYSTEM_NOTIFICATION, "Reminder to correct errors in an applicaton that could not be exported"),
	...
	APPLICATION_RESERVE_RATING_FIRST(APPLICATION_GLOBAL, "First Reserve Group"),
	APPLICATION_RESERVE_RATING_SECOND(APPLICATION_GLOBAL, "Second Reserve Group"),
	APPLICATION_RESERVE_RATING_THIRD(APPLICATION_GLOBAL, "Third Reserve Group"),
