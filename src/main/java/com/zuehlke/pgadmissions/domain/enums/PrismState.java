...
public enum PrismState {
    ...
    APPLICATION_APPROVAL(null, PrismScope.APPLICATION), //
    APPLICATION_APPROVAL_PENDING_COMPLETION(null, PrismScope.APPLICATION), //
    APPLICATION_APPROVAL_PENDING_FEEDBACK(7, PrismScope.APPLICATION), //
    APPLICATION_APPROVED(null, PrismScope.APPLICATION), //
    APPLICATION_APPROVED_COMPLETED(null, PrismScope.APPLICATION), //
    APPLICATION_APPROVED_PENDING_CORRECTION(null, PrismScope.APPLICATION), //
    APPLICATION_APPROVED_PENDING_EXPORT(null, PrismScope.APPLICATION), //
    APPLICATION_INTERVIEW(null, PrismScope.APPLICATION), //
    APPLICATION_INTERVIEW_PENDING_AVAILABILITY(3, PrismScope.APPLICATION), //
    APPLICATION_INTERVIEW_PENDING_COMPLETION(null, PrismScope.APPLICATION), //
    APPLICATION_INTERVIEW_PENDING_FEEDBACK(7, PrismScope.APPLICATION), //
    APPLICATION_INTERVIEW_PENDING_INTERVIEW(null, PrismScope.APPLICATION), //
    APPLICATION_INTERVIEW_PENDING_SCHEDULING(null, PrismScope.APPLICATION), //
    APPLICATION_REJECTED(null, PrismScope.APPLICATION), //
    APPLICATION_REJECTED_COMPLETED(null, PrismScope.APPLICATION), //
    APPLICATION_REJECTED_PENDING_CORRECTION(null, PrismScope.APPLICATION), //
    APPLICATION_REJECTED_PENDING_EXPORT(null, PrismScope.APPLICATION), //
    APPLICATION_REVIEW(null, PrismScope.APPLICATION), //
    APPLICATION_REVIEW_PENDING_COMPLETION(null, PrismScope.APPLICATION), //
    APPLICATION_REVIEW_PENDING_FEEDBACK(7, PrismScope.APPLICATION), //
    APPLICATION_UNSUBMITTED(28, PrismScope.APPLICATION), //
    APPLICATION_UNSUBMITTED_PENDING_COMPLETION(null,PrismScope.APPLICATION), //
    APPLICATION_VALIDATION(null, PrismScope.APPLICATION), //
    APPLICATION_VALIDATION_PENDING_COMPLETION(null, PrismScope.APPLICATION), //
    APPLICATION_VALIDATION_PENDING_FEEDBACK(3, PrismScope.APPLICATION), //
    APPLICATION_WITHDRAWN(null, PrismScope.APPLICATION), //
    APPLICATION_WITHDRAWN_COMPLETED(null, PrismScope.APPLICATION), //
    APPLICATION_WITHDRAWN_PENDING_CORRECTION(null, PrismScope.APPLICATION), //
    INSTITUTION_APPROVED(null, PrismScope.INSTITUTION), //
    PROGRAM_APPROVAL(null, PrismScope.PROGRAM), //
    PROGRAM_APPROVAL_PENDING_CORRECTION(null, PrismScope.PROGRAM), //
    PROGRAM_APPROVED(null, PrismScope.PROGRAM), //
    PROGRAM_DEACTIVATED(null, PrismScope.PROGRAM), //
    PROGRAM_DISABLED(28, PrismScope.PROGRAM), //
    PROGRAM_DISABLED_COMPLETED(null, PrismScope.PROGRAM), //
    PROGRAM_DISABLED_PENDING_IMPORT_REACTIVATION(28, PrismScope.PROGRAM), //
    PROGRAM_DISABLED_PENDING_REACTIVATION(28, PrismScope.PROGRAM), //
    PROGRAM_REJECTED(null, PrismScope.PROGRAM), //
    PROGRAM_WITHDRAWN(null, PrismScope.PROGRAM), //
    PROJECT_APPROVED(null, PrismScope.PROJECT), //
    PROJECT_DEACTIVATED(null, PrismScope.PROJECT), //
    PROJECT_DISABLED(28, PrismScope.PROJECT), //
    PROJECT_DISABLED_COMPLETED(null, PrismScope.PROJECT), //
    PROJECT_DISABLED_PENDING_PROGRAM_REACTIVATION(null, PrismScope.PROJECT), //
    PROJECT_DISABLED_PENDING_REACTIVATION(28, PrismScope.PROJECT), //
    SYSTEM_APPROVED(null, PrismScope.SYSTEM);
    ...
    private PrismState(Integer duration, PrismScope scope) {
