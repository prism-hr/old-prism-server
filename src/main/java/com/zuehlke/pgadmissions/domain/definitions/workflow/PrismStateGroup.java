...
public enum PrismStateGroup {
	...
	APPLICATION_SHORTLISTING(6, true, APPLICATION, APPLICATION_REVIEW_STATE_GROUP), //
	APPLICATION_INTERVIEW(7, true, APPLICATION, APPLICATION_INTERVIEW_STATE_GROUP), //
	APPLICATION_APPROVAL(8, true, APPLICATION, APPLICATION_APPROVAL_STATE_GROUP), //
	APPLICATION_APPROVED(9, true, APPLICATION, APPLICATION_APPROVED_STATE_GROUP), //
	APPLICATION_REJECTED(10, true, APPLICATION, APPLICATION_REJECTED_STATE_GROUP), //
	APPLICATION_WITHDRAWN(11, false, APPLICATION, APPLICATION_WITHDRAWN_STATE_GROUP), //
