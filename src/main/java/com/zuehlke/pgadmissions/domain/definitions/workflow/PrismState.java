...
import static com.zuehlke.pgadmissions.domain.definitions.workflow.PrismStateDurationEvaluation.APPLICATION_PANEL_DATE;
...
import com.zuehlke.pgadmissions.domain.definitions.workflow.states.PrismApplicationShortlisting;
import com.zuehlke.pgadmissions.domain.definitions.workflow.states.PrismApplicationShortlistingPendingCompletion;
import com.zuehlke.pgadmissions.domain.definitions.workflow.states.PrismApplicationShortlistingPendingFeedback;
import com.zuehlke.pgadmissions.domain.definitions.workflow.states.PrismApplicationShortlistingPendingPanel;
import com.zuehlke.pgadmissions.domain.definitions.workflow.states.PrismApplicationShortlistingPendingRescheduledPanel;
...
public enum PrismState {
	...
	APPLICATION_SHORTLISTING(PrismStateGroup.APPLICATION_SHORTLISTING, APPLICATION_ESCALATE_DURATION, null, false, false, APPLICATION,
	        PrismApplicationShortlisting.class), //
	APPLICATION_SHORTLISTING_PENDING_PANEL(PrismStateGroup.APPLICATION_SHORTLISTING, null, APPLICATION_PANEL_DATE, false, false, APPLICATION,
	        PrismApplicationShortlistingPendingPanel.class), //
	APPLICATION_SHORTLISTING_PENDING_RESCHEDULED_PANEL(PrismStateGroup.APPLICATION_SHORTLISTING, null, APPLICATION_PANEL_DATE, false, false, APPLICATION,
	        PrismApplicationShortlistingPendingRescheduledPanel.class), //
	APPLICATION_SHORTLISTING_PENDING_FEEDBACK(PrismStateGroup.APPLICATION_SHORTLISTING, APPLICATION_ESCALATE_DURATION, null, false, false, APPLICATION,
	        PrismApplicationShortlistingPendingFeedback.class), //
	APPLICATION_SHORTLISTING_PENDING_COMPLETION(PrismStateGroup.APPLICATION_SHORTLISTING, APPLICATION_ESCALATE_DURATION, null, false, false, APPLICATION,
	        PrismApplicationShortlistingPendingCompletion.class), //
