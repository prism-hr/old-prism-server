...
public enum PrismDisplayPropertyDefinition implements PrismConfigurationCategorizable<PrismDisplayPropertyCategory> {
    ...
    SYSTEM_ENTITY_DOMICILE(SYSTEM_IMPORTED_ENTITY, "Domicile"),
    SYSTEM_ENTITY_NATIONALITY(SYSTEM_IMPORTED_ENTITY, "Nationality"),
    SYSTEM_ENTITY_AGE_RANGE(SYSTEM_IMPORTED_ENTITY, "Age Range"),
    SYSTEM_ENTITY_DISABILITY(SYSTEM_IMPORTED_ENTITY, "Disability"),
    SYSTEM_ENTITY_ETHNICITY(SYSTEM_IMPORTED_ENTITY, "Ethnicity"),
    SYSTEM_ENTITY_GENDER(SYSTEM_IMPORTED_ENTITY, "Gender"),
    SYSTEM_ENTITY_OPPORTUNITY_TYPE(SYSTEM_IMPORTED_ENTITY, "Opportunity Type"),
    SYSTEM_ENTITY_REJECTION_REASON(SYSTEM_IMPORTED_ENTITY, "Rejection Reason"),
    SYSTEM_ENTITY_STUDY_OPTION(SYSTEM_IMPORTED_ENTITY, "Position type"),
    SYSTEM_ENTITY_UNIVERSITY_INSTITUTION(SYSTEM_IMPORTED_ENTITY, "University"),
    SYSTEM_ENTITY_UNIVERSITY_DEPARTMENT(SYSTEM_IMPORTED_ENTITY, "Department"),
    SYSTEM_ENTITY_UNIVERSITY_PROGRAM(SYSTEM_IMPORTED_ENTITY, "Program"),
    SYSTEM_ENTITY_UNIVERSITY_PROJECT(SYSTEM_IMPORTED_ENTITY, "Project"),
    SYSTEM_ENTITY_EMPLOYER_INSTITUTION(SYSTEM_IMPORTED_ENTITY, "Organization"),
    SYSTEM_ENTITY_EMPLOYER_DEPARTMENT(SYSTEM_IMPORTED_ENTITY, "Division"),
