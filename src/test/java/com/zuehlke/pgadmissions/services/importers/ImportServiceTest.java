...
public class ImportServiceTest {
	...
	public void testMergeData() {
		...
		currentData.add(new CountryBuilder().id(34).code("PL").enabled(true).name("PL2").toCountry()); //another enabled with same code
	...
	public void testMergeProgrammeData() {
		...
		Program p1 = pb.code("A").title("A").id(1).toProgram();
		Program p2 = pb.code("B").title("B").id(2).toProgram();
