...
public enum PrismState {
    ...
    PROJECT_APPROVAL_PARENT(PrismStateGroup.PROJECT_APPROVAL_INSTITUTION, PROGRAM_ESCALATE_DURATION, null,
            PrismProjectApprovalParent.class),
    ...
    PROGRAM_APPROVAL_PARENT(PrismStateGroup.PROGRAM_APPROVAL_INSTITUTION, PROGRAM_ESCALATE_DURATION, null,
    ...
    DEPARTMENT_APPROVAL_PARENT(PrismStateGroup.DEPARTMENT_APPROVAL_INSTITUTION, DEPARTMENT_ESCALATE_DURATION, null,
