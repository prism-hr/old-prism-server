...
public class DocumentService {
    ...
    public Document getByIdSafe(Integer id, PrismFileCategory category) {
        Document document = getById(id, category);
        Preconditions.checkState(document.getContentType().equals("image/jpeg"), "Unexpected image type: " + document.getContentType());
        return document;
    }	
