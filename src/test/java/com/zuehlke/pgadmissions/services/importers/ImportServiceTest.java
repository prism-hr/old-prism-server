...
public class ImportServiceTest {
	...
	public void testMergeProgrammeData() {
		...
		currentData.add(new ProgramInstanceBuilder().id(2).academicYear("1").identifier("0002").program(p1).applicationDeadline(deadline).applicationStartDate(startDate).studyOption("2", "option2").enabled(true).build());
		currentData.add(new ProgramInstanceBuilder().id(3).academicYear("1").identifier("0001").program(p2).applicationDeadline(deadline).applicationStartDate(startDate).studyOption("1", "option").enabled(false).build());
		currentData.add(new ProgramInstanceBuilder().id(4).academicYear("1").identifier("0002").program(p2).applicationDeadline(deadline).applicationStartDate(startDate).studyOption("2", "option2").enabled(false).build());
		...
		Assert.assertEquals(Integer.valueOf(2), ((ProgramInstance)changes.get(0)).getId());
		Assert.assertEquals(Integer.valueOf(3), ((ProgramInstance)changes.get(1)).getId());
		Assert.assertEquals("B", changes.get(2).getName());
		Assert.assertEquals("C", changes.get(3).getName());
		Assert.assertEquals("B", changes.get(3).getStringCode());
		Assert.assertEquals("D", changes.get(4).getName());
		Assert.assertEquals("D", changes.get(5).getName());
