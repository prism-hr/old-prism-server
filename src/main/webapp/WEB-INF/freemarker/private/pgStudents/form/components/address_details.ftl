...
<div>
  <form>
    ...
    <div class="row-group">
      ...
      <!-- Address body -->
      <div class="row"> <span class="plain-label">Is this the same as your current address?</span> <span class="hint" data-desc="<@spring.message 'addressDetails.ContactAddress.sameAsCurrentAddress'/>"></span>
        <div class="field">
      ...
      <div class="row"> <span id="add-two-lb-1" class="plain-label">House name / number & street<em id="add-two-em">*</em></span> <span class="hint" data-desc="<@spring.message 'addressDetails.house'/>"></span>
        <div class="field"> <input id="contactAddress1" type="text" class="max" <#if addressSectionDTO.sameAddress> disabled="disabled" </#if> <#if applicationForm.isDecided() || applicationForm.isWithdrawn()> readonly="readonly" </#if> value="
          ${(addressSectionDTO.contactAddress1?html)!}
          " /> </div>
      </div>
      <div class="row">
        <div class="field"> <input id="contactAddress2" type="text" class="max" <#if addressSectionDTO.sameAddress> disabled="disabled" </#if> <#if applicationForm.isDecided() || applicationForm.isWithdrawn()> readonly="readonly" </#if> value="
          ${(addressSectionDTO.contactAddress2?html)!}
          " />
      ...
      <div class="row">
        ...
        <span class="hint" data-desc="<@spring.message 'addressDetails.town'/>"></span>
        <div class="field"> <input id="contactAddress3" type="text" class="full" <#if addressSectionDTO.sameAddress> disabled="disabled" </#if> <#if applicationForm.isDecided() || applicationForm.isWithdrawn()> readonly="readonly" </#if> value="
          ${(addressSectionDTO.contactAddress3?html)!}
          " />
      ...
      <div class="row">
        ...
        <span class="hint" data-desc="<@spring.message 'addressDetails.state'/>"></span>
        <div class="field"> <input id="contactAddress4" type="text" class="full" <#if addressSectionDTO.sameAddress> disabled="disabled" </#if> <#if applicationForm.isDecided() || applicationForm.isWithdrawn()> readonly="readonly" </#if> value="
          ${(addressSectionDTO.contactAddress4?html)!}
          " />
      ...
      <div class="row">
        ...
        <span class="hint" data-desc="<@spring.message 'addressDetails.zip'/>"></span>
        <div class="field"> <input id="contactAddress5" type="text" class="full" <#if addressSectionDTO.sameAddress> disabled="disabled" </#if> <#if applicationForm.isDecided() || applicationForm.isWithdrawn()> readonly="readonly" </#if> value="
          ${(addressSectionDTO.contactAddress5?html)!}
          " />
      ...
      <div class="row"> <span id="country-two-lb" class="plain-label">Country<em id="country-two-em">*</em></span> <span class="hint" data-desc="<@spring.message 'addressDetails.ContactAddress.country'/>"></span>
        <div class="field"> <select class="full" name="contactAddressCountry" id="contactAddressCountry"<#if (applicationForm.isDecided() || applicationForm.isWithdrawn()) || (addressSectionDTO.sameAddress)> disabled="disabled" </#if>>
          <option value="">Select...</option>
          <#list countries as country> <option value="${encrypter.encrypt(country.id)}"<#if addressSectionDTO.contactAddressCountry?? && addressSectionDTO.contactAddressCountry.id == country.id> selected="selected"</#if>>
          ${country.name?html}
          </option>
          </#list>
          </select>
