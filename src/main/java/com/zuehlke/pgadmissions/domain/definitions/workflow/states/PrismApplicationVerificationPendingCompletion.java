...
public class PrismApplicationVerificationPendingCompletion extends PrismWorkflowState {
    ...
    protected void setStateActions() {
        ...
        stateActions.add(new PrismStateAction() //
            .withAction(PrismAction.APPLICATION_COMPLETE_VERIFICATION_STAGE) //
            ...
            .withNotificationTemplate(PrismNotificationDefinition.SYSTEM_APPLICATION_TASK_REQUEST) //
                ...
                .withTransitions(Arrays.asList( //
                    new PrismStateTransition() //
                        ...
                        .withStateTransitionEvaluation(PrismStateTransitionEvaluation.APPLICATION_COMPLETED_VERIFICATION_STATE_OUTCOME), //
                    new PrismStateTransition() //
