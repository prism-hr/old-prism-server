...
public enum PrismDisplayPropertyDefinition implements PrismConfigurationCategorizable<PrismDisplayPropertyCategory> {
    ...
    SYSTEM_STATE_GROUP_PROJECT_APPROVAL_PARTNER_INSTITUTION(SYSTEM_STATE_GROUP, "Partner Initialization"),
    ...
    SYSTEM_STATE_GROUP_PROGRAM_APPROVAL_PARTNER_INSTITUTION(SYSTEM_STATE_GROUP, "Partner Initialization"),
    ...
    SYSTEM_ACTION_INSTITUTION_PROVIDE_SPONSORSHIP(SYSTEM_ACTION, "Sponsor Institution"),
    SYSTEM_ACTION_PROGRAM_STARTUP(SYSTEM_ACTION, "Program Startup"),
    SYSTEM_ACTION_PROGRAM_COMPLETE_APPROVAL_PARTNER_STAGE(SYSTEM_ACTION, "Complete Partner Approval"),
    ...
    SYSTEM_ACTION_PROGRAM_PROVIDE_SPONSORSHIP(SYSTEM_ACTION, "Sponsor Program"),
    SYSTEM_ACTION_PROJECT_STARTUP(SYSTEM_ACTION, "Project Startup"),
    SYSTEM_ACTION_PROJECT_COMPLETE_APPROVAL_PARTNER_STAGE(SYSTEM_ACTION, "Complete Partner Approval"),
    ...
    SYSTEM_ACTION_PROJECT_DEACTIVATE(SYSTEM_ACTION, "Deactivate"),
    ...
    SYSTEM_ACTION_PROJECT_PROVIDE_SPONSORSHIP(SYSTEM_ACTION, "Sponsor Project"),
    ...
    SYSTEM_NOTIFICATION_TEMPLATE_INSTITUTION_SPONSOR_NOTIFICATION(SYSTEM_NOTIFICATION_TEMPLATE, "Institution Sponsor Notification"),
    SYSTEM_NOTIFICATION_TEMPLATE_PROGRAM_COMPLETE_APPROVAL_PARTNER_STAGE_NOTIFICATION(SYSTEM_NOTIFICATION_TEMPLATE, "Complete Partner Approval Stage Notification"),
    ...
    SYSTEM_NOTIFICATION_TEMPLATE_PROJECT_SPONSOR_NOTIFICATION(SYSTEM_NOTIFICATION_TEMPLATE, "Project Sponsor Notification"),
    ...
    SYSTEM_RESOURCE_PARENT_APPLY_HOMEPAGE_HINT(SYSTEM_HTML_RESOURCE_PARENT, "Link to your application page for the opportunity. Should be prefixed with http:// or mailto:"),
    ...
    SYSTEM_RESOURCE_PARENT_ALLOW_PARTNERS_CREATE(SYSTEM_ADVERTISE_SECTION, "Make it public"),
    ...
    SYSTEM_RESOURCE_PARENT_ACCEPT_SPONSOR(SYSTEM_ADVERTISE_SECTION, "Accept new Sponsors"),
    ...
    SYSTEM_SPONSORSHIP_AMOUNT_SPECIFIED_LABEL(SYSTEM_HTML_SPONSORSHIP, "Amount"),
    SYSTEM_SPONSORSHIP_AMOUNT_SPECIFIED_HINT(SYSTEM_HTML_SPONSORSHIP, "???"),
    SYSTEM_SPONSORSHIP_CONTENT_LABEL(SYSTEM_HTML_SPONSORSHIP, "Message"),
    SYSTEM_SPONSORSHIP_CONTENT_HINT(SYSTEM_HTML_SPONSORSHIP, "???"),
    SYSTEM_SPONSORSHIP_SPONSOR_INSTITUTION_HEADER(SYSTEM_HTML_SPONSORSHIP, "Sponsor Organization"),
    /*
     * *************** SYSTEM HTML RESOURCE CONFIGURATION *********************
     */
    ...
    INSTITUTION_ADVERT_SPONSORSHIP_TARGET_HINT(INSTITUTION_ADVERT_SPONSORSHIP, "Amount of money you need to collect in your selected currency"),
    INSTITUTION_ADVERT_SPONSORSHIP_PURPOSE_LABEL(INSTITUTION_ADVERT_SPONSORSHIP, "Purpose"),
    INSTITUTION_ADVERT_SPONSORSHIP_PURPOSE_HINT(INSTITUTION_ADVERT_SPONSORSHIP, "Summary of your Sponsorship purpose"),
    ...
    APPLICATION_ACTION_REJECTION_RECOMMEND_LABEL(APPLICATION_ACTION, "Recommend other opportunities"),
    APPLICATION_ACTION_REJECTION_RECOMMEND_HINT(APPLICATION_ACTION, "Recommend other opportunities in your department / institution to the applicant."),
