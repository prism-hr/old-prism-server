            ...
            <td width="500">
                ...
                <p>
                    <font face="Arial, Helvetica, sans-serif" size="2">
                        You have been nominated as the primary supervisor for ${application.applicant.firstName?html} ${application.applicant.lastName?html} Application ${application.applicationNumber} for UCL <#if application.researchHomePage??><a href="${application.researchHomePage}">${application.program.title}</a><#else>${application.program.title}</#if>.
                    </font>
                </p>

                <p>
                    <font face="Arial, Helvetica, sans-serif" size="2">
                        You must confirm this supervision arrangement so that a study offer can be initiated.
                    </font>
                </p>
                ...
                <p>
                    <font face="Arial, Helvetica, sans-serif" size="2">
                        We will send reminders until you respond to this request.
                    </font>
                </p>
                <p>
                    <font face="Arial, Helvetica, sans-serif" size="2">
