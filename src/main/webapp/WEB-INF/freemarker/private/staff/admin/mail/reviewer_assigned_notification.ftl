			...
			<tr>
		  	...
		  	<tr>
		    	...
		    	<td width="500">
			      	...
			      	<p>
			      		<font face="Arial, Helvetica, sans-serif" size="2">${newReviewer.user.firstName?html} ${newReviewer.user.lastName?html} has assigned additional reviewers to the academic review panel for ${application.applicant.firstName?html} ${application.applicant.lastName?html} Application ${application.applicationNumber} for UCL 
			  		...
			  		<p>
			      		<font face="Arial, Helvetica, sans-serif" size="2"></font>
							...
							<p>
				            	<!-- Button -->
								<a style="text-decoration:none;" href="${host}/pgadmissions/review/assignReviewers?applicationId=${application.applicationNumber}&activationCode=${admin.activationCode}" title="View Application">
