...
public enum PrismDisplayPropertyDefinition implements PrismConfigurationCategorizable<PrismDisplayPropertyCategory> {
    ...
    SYSTEM_ENTITY_IMPORTED_STUDY_OPTION(SYSTEM_IMPORTED_ENTITY, "Study Option"),
    ...
    APPLICATION_DOCUMENT_RESEARCH_STATEMENT_HINT(
            APPLICATION_DOCUMENT,
            "Your research statement. This should summarise your proposed position and its significance to your field, and why the position is appropriate for your proposed organization, and explain why you would like to work with your proposed supervisor. Please provide no more than 1 page of A4."),
