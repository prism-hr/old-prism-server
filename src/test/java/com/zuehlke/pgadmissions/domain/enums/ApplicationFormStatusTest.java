...
public class ApplicationFormStatusTest {
	...
	public void shouldOutputCorrectDisplayValues(){
		...
		assertEquals("Offer Recommended", ApplicationFormStatus.APPROVED.displayValue());
    ...
    public void shouldConvertCorrectly(){
        ...
        assertEquals(ApplicationFormStatus.APPROVED, ApplicationFormStatus.convert("Offer"));
