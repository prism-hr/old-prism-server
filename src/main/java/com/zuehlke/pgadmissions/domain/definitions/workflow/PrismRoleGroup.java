...
public enum PrismRoleGroup {
    ...
    PROJECT_ENDORSER_GROUP(INSTITUTION_ADMINISTRATOR, DEPARTMENT_ADMINISTRATOR, PROGRAM_ADMINISTRATOR, PROJECT_ADMINISTRATOR, PROJECT_APPROVER, //
            PROJECT_VIEWER, PROJECT_PRIMARY_SUPERVISOR, PROJECT_SECONDARY_SUPERVISOR), //
    PROJECT_STAFF_GROUP(PROJECT_ADMINISTRATOR, PROJECT_APPROVER, PROJECT_VIEWER, PROJECT_PRIMARY_SUPERVISOR, PROJECT_SECONDARY_SUPERVISOR), //
    ...
    PROGRAM_ENDORSER_GROUP(INSTITUTION_ADMINISTRATOR, DEPARTMENT_ADMINISTRATOR, PROGRAM_ADMINISTRATOR, PROGRAM_APPROVER, PROGRAM_VIEWER), //
    PROGRAM_STAFF_GROUP(PROGRAM_ADMINISTRATOR, PROGRAM_APPROVER, PROGRAM_VIEWER), //
    ...
    DEPARTMENT_ENDORSER_GROUP(INSTITUTION_ADMINISTRATOR, DEPARTMENT_ADMINISTRATOR, DEPARTMENT_APPROVER, DEPARTMENT_VIEWER), //
    DEPARTMENT_STAFF_GROUP(DEPARTMENT_ADMINISTRATOR, DEPARTMENT_APPROVER, DEPARTMENT_VIEWER), //
    
    INSTITUTION_ADMINISTRATOR_GROUP(SYSTEM_ADMINISTRATOR, INSTITUTION_ADMINISTRATOR), //
    INSTITUTION_ENDORSER_GROUP(INSTITUTION_ADMINISTRATOR, INSTITUTION_APPROVER, INSTITUTION_VIEWER, DEPARTMENT_ADMINISTRATOR), //
    INSTITUTION_STAFF_GROUP(INSTITUTION_ADMINISTRATOR, INSTITUTION_APPROVER, INSTITUTION_VIEWER), //
