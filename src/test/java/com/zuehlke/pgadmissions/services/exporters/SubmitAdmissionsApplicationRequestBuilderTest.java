...
public class SubmitAdmissionsApplicationRequestBuilderTest {
    ...
    public void shouldBuildValidWebServiceRequestContainingAtasStatement() throws JAXBException, DatatypeConfigurationException {
        ...
        ApprovalRound appRound = new ApprovalRoundBuilder().id(15).projectAbstract("abstract").recommendedConditionsAvailable(true)
                .recommendedConditions("conditions").build();
    ...
    @Test
    public void shouldBuildValidWebServiceRequestWithAgreedSupervisor() throws JAXBException, DatatypeConfigurationException {
        final DateTime dateInThePast = new DateTime(2013, 1, 1, 8, 0);
        applicationForm.getProgrammeDetails().setStartDate(dateInThePast.toDate());
        ...
        ApprovalRound appRound = new ApprovalRoundBuilder().id(15).supervisors(primarySupervisor).build();
        applicationForm.setLatestApprovalRound(appRound);
        ...
        NameTp supervisorName = request.getApplication().getCourseApplication().getSupervisorName();
        assertEquals("Franciszek", supervisorName.getForename1());
        assertEquals("Pieczka", supervisorName.getSurname());
    }

    @Test
    public void shouldBuildValidWebServiceRequestWithSuggestedSupervisor() throws JAXBException, DatatypeConfigurationException {
        final DateTime dateInThePast = new DateTime(2013, 1, 1, 8, 0);
        ...
        NameTp supervisorName = request.getApplication().getCourseApplication().getSupervisorName();
        assertEquals("Eugeniusz", supervisorName.getForename1());
        assertEquals("Kowalski", supervisorName.getSurname());
    }
