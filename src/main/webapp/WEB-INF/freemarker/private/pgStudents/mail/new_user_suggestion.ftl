		  	...
		  	<tr>
		    	...
		    	<td width="500">
		      		<h1 style="font-size: 12pt;">
		      			<font face="Arial, Helvetica, sans-serif" color="#0055A1">Dear ${newAdminUserSuggested.newUserFirstName},</font>
		      		</h1>		
			      	<p>
			      		<font face="Arial, Helvetica, sans-serif" size="2">You have been suggested as a new user.</font>
			      	</p>
			      	<p>
			      		<font face="Arial, Helvetica, sans-serif" size="2">
			      			<a href="${host}/pgadmissions/">(Continue to Application)</a>
			      		</font>
			      	</p>			      	
			      	<p>
