...
public enum PrismDisplayPropertyDefinition {
    ...
    SYSTEM_APPLICATION_STUDY_DETAIL_TOOLTIP(SYSTEM_WORKFLOW, "Enable collection of advanced study preferences"),
    SYSTEM_APPLICATION_THEME_PRIMARY_LABEL(SYSTEM_WORKFLOW, "Primary Themes"),
    SYSTEM_APPLICATION_THEME_PRIMARY_TOOLTIP(SYSTEM_WORKFLOW, "Enable selection of primary study themes"),
    SYSTEM_APPLICATION_THEME_SECONDARY_LABEL(SYSTEM_WORKFLOW, "Secondary Themes"),
    SYSTEM_APPLICATION_THEME_SECONDARY_TOOLTIP(SYSTEM_WORKFLOW, "Enable selection of secondary study themes"),
    SYSTEM_APPLICATION_CREATOR_DEMOGRAPHIC_LABEL(SYSTEM_WORKFLOW, "Equal Opportunities Information"),
    SYSTEM_APPLICATION_CREATOR_DEMOGRAPHIC_TOOLTIP(SYSTEM_WORKFLOW, "Enable collection of applicant equal opportunities information"),
    SYSTEM_APPLICATION_LANGUAGE_LABEL(SYSTEM_WORKFLOW, "Language Competence"),
    SYSTEM_APPLICATION_LANGUAGE_TOOLTIP(SYSTEM_WORKFLOW, "Enable collection of language competence information"),
    SYSTEM_APPLICATION_LANGUAGE_PROOF_OF_AWARD_LABEL(SYSTEM_WORKFLOW, "Proof of Language Competence"),
    SYSTEM_APPLICATION_LANGUAGE_PROOF_OF_AWARD_TOOLTIP(SYSTEM_WORKFLOW, "Enable collection of documentary proof of language competence"),
    SYSTEM_APPLICATION_RESIDENCE_LABEL(SYSTEM_WORKFLOW, "Right of Residence"),
    SYSTEM_APPLICATION_RESIDENCE_TOOLTIP(SYSTEM_WORKFLOW, "Enable collection of right of residence information"),
    SYSTEM_APPLICATION_QUALIFICATION_LABEL(SYSTEM_WORKFLOW, "Qualifications"),
    SYSTEM_APPLICATION_QUALIFICATION_TOOLTIP(SYSTEM_WORKFLOW, "Enable collection of qualification information"),
    SYSTEM_APPLICATION_QUALIFICATION_PROOF_OF_AWARD_LABEL(SYSTEM_WORKFLOW, "Proof of Qualification"),
    SYSTEM_APPLICATION_QUALIFICATION_PROOF_OF_AWARD_TOOLTIP(SYSTEM_WORKFLOW, "Enable collection of documentary proof of qualification"),
    SYSTEM_APPLICATION_EMPLOYMENT_POSITION_LABEL(SYSTEM_WORKFLOW, "Employment History"),
    SYSTEM_APPLICATION_EMPLOYMENT_POSITION_TOOLTIP(SYSTEM_WORKFLOW, "Enable collection of employment history information"),
    SYSTEM_APPLICATION_FUNDING_LABEL(SYSTEM_WORKFLOW, "Funding"),
    SYSTEM_APPLICATION_FUNDING_TOOLTIP(SYSTEM_WORKFLOW, "Enable collection of funding information"),
    SYSTEM_APPLICATION_FUNDING_PROOF_OF_AWARD_LABEL(SYSTEM_WORKFLOW, "Proof of Funding"),
    SYSTEM_APPLICATION_FUNDING_PROOF_OF_AWARD_TOOLTIP(SYSTEM_WORKFLOW, "Enable collection of documentary proof of funding"),
    SYSTEM_APPLICATION_PRIZE_LABEL(SYSTEM_WORKFLOW, "Prizes"),
    SYSTEM_APPLICATION_PRIZE_TOOLTIP(SYSTEM_WORKFLOW, "Enable collection of information about prizes and achievements"),
    SYSTEM_APPLICATION_DOCUMENT_PERSONAL_STATEMENT_LABEL(SYSTEM_WORKFLOW, "Personal Statement"),
    SYSTEM_APPLICATION_DOCUMENT_PERSONAL_STATEMENT_TOOLTIP(SYSTEM_WORKFLOW, "Enable upload of a personal statement"),
    SYSTEM_APPLICATION_DOCUMENT_RESEARCH_STATEMENT_LABEL(SYSTEM_WORKFLOW, "Research Statement"),
    SYSTEM_APPLICATION_DOCUMENT_RESEARCH_STATEMENT_TOOLTIP(SYSTEM_WORKFLOW, "Enable upload of a research statement"),
    SYSTEM_APPLICATION_DOCUMENT_CV_LABEL(SYSTEM_WORKFLOW, "CV/Resume"),
    SYSTEM_APPLICATION_DOCUMENT_CV_TOOLTIP(SYSTEM_WORKFLOW, "Enable upload of a cv/resume"),
    SYSTEM_APPLICATION_DOCUMENT_COVERING_LETTER_LABEL(SYSTEM_WORKFLOW, "Covering Letter"),
    SYSTEM_APPLICATION_DOCUMENT_COVERING_LETTER_TOOLTIP(SYSTEM_WORKFLOW, "Enable upload of a covering letter"),
    SYSTEM_APPLICATION_CRIMINAL_CONVICTION_LABEL(SYSTEM_WORKFLOW, "Criminal Convictions"),
    SYSTEM_APPLICATION_CRIMINAL_CONVICTION_TOOLTIP(SYSTEM_WORKFLOW, "Enable collection of criminal conviction information"),
    SYSTEM_APPLICATION_ASSIGN_SUGGESTED_SUPERVISOR_LABEL(SYSTEM_WORKFLOW, "Provisional Supervisor Assignment"),
    SYSTEM_APPLICATION_ASSIGN_SUGGESTED_SUPERVISOR_TOOLTIP(SYSTEM_WORKFLOW, "Specify how many provisional supervisors may be assigned during application"),
    SYSTEM_APPLICATION_ASSIGN_REFEREE_LABEL(SYSTEM_WORKFLOW, "Referee Assignment"),
    SYSTEM_APPLICATION_ASSIGN_REFEREE_TOOLTIP(SYSTEM_WORKFLOW, "Specify how many referees may be assigned during application"),
    SYSTEM_APPLICATION_ASSIGN_REVIEWER_LABEL(SYSTEM_WORKFLOW, "Reviewer Assignment"),
    SYSTEM_APPLICATION_ASSIGN_REVIEWER_TOOLTIP(SYSTEM_WORKFLOW, "Specify how many reviewers may be assigned during any application processing action"),
    SYSTEM_APPLICATION_ASSIGN_INTERVIEWER_LABEL(SYSTEM_WORKFLOW, "Interviewer Assignment"),
    SYSTEM_APPLICATION_ASSIGN_INTERVIEWER_TOOLTIP(SYSTEM_WORKFLOW, "Specify how many interviewers may be assigned during any application processing action"),
    SYSTEM_APPLICATION_ASSIGN_PRIMARY_SUPERVISOR_LABEL(SYSTEM_WORKFLOW, "Primary Supervisor Assignment"),
    SYSTEM_APPLICATION_ASSIGN_PRIMARY_SUPERVISOR_TOOLTIP(SYSTEM_WORKFLOW, "Specify how many primary supervisors may be assigned during any application processing action"),
    SYSTEM_APPLICATION_ASSIGN_SECONDARY_SUPERVISOR_LABEL(SYSTEM_WORKFLOW, "Secondary Supervisor Assignment"),
    SYSTEM_APPLICATION_ASSIGN_SECONDARY_SUPERVISOR_TOOLTIP(SYSTEM_WORKFLOW, "Specify how many secondary supervisors may be assigned during any application processing action"),
    SYSTEM_APPLICATION_POSITION_DETAIL_LABEL(SYSTEM_WORKFLOW, "Project Detail"),
    SYSTEM_APPLICATION_POSITION_DETAIL_TOOLTIP(SYSTEM_WORKFLOW, "Enable collection of advanced project information"),
    SYSTEM_APPLICATION_OFFER_DETAIL_LABEL(SYSTEM_WORKFLOW, "Offer Detail"),
    SYSTEM_APPLICATION_OFFER_DETAIL_TOOLTIP(SYSTEM_WORKFLOW, "Enable collection of advanced terms of offer information"),
    ...
    APPLICATION_PERSONAL_DETAIL_FIRST_NAMES_LABEL(APPLICATION_PERSONAL_DETAIL, "First Names"),
    APPLICATION_PERSONAL_DETAIL_FIRST_NAMES_HINT(APPLICATION_PERSONAL_DETAIL, "Edit your first name(s)."),
    APPLICATION_PERSONAL_DETAIL_LAST_NAME_LABEL(APPLICATION_PERSONAL_DETAIL, "Last Name"),
    APPLICATION_PERSONAL_DETAIL_LAST_NAME_HINT(APPLICATION_PERSONAL_DETAIL, "Edit your last name."),
