...
//    }
    ...
    public void shouldReturnRedirectToReviewIfReviewNextStatus() {
        ApplicationForm applicationForm = new ApplicationFormBuilder().applicationNumber("ABC").nextStatus(ApplicationFormStatus.REVIEW).build();
    ...
    public void shouldReturnRedirectToInterviewIfInterviewNextStatus() {
        ApplicationForm applicationForm = new ApplicationFormBuilder().applicationNumber("ABC").nextStatus(ApplicationFormStatus.INTERVIEW).build();
    ...
    public void shouldReturnRedirectToApprovalIfApprovalNextStatus() {
        ApplicationForm   applicationForm = new ApplicationFormBuilder().applicationNumber("ABC").nextStatus(ApplicationFormStatus.APPROVAL).build();
    ...
    public void shouldReturnRedirectToRejectedIfRejectedNextStatus() {
        ApplicationForm   applicationForm = new ApplicationFormBuilder().applicationNumber("ABC").nextStatus(ApplicationFormStatus.REJECTED).build();
    ...
    public void shouldReturnRedirectToOfferRecommendationIfApprovedNextStatus() {
        ApplicationForm     applicationForm = new ApplicationFormBuilder().applicationNumber("ABC").nextStatus(ApplicationFormStatus.APPROVED).build();
