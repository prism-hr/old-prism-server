...
public class ApplicationFormDAOTest extends AutomaticRollbackTestCase {
    ...
    public void shouldReturnApplicationsDueRevalidationRequest() {
        ApplicationForm form1 = new ApplicationFormBuilder().applicant(user).program(program).registryUsersDueNotification(true).adminRequestedRegistry(user)
                .status(ApplicationFormStatus.REVIEW).build();
        ApplicationForm form2 = new ApplicationFormBuilder().applicant(user).program(program).status(ApplicationFormStatus.REVIEW).build();
        NotificationRecord record = new NotificationRecord(NotificationType.REPEAT_VALIDATION_REQUEST);
        ApplicationForm form3 = new ApplicationFormBuilder().applicant(user).program(program).adminRequestedRegistry(user).notificationRecords(record)
                .status(ApplicationFormStatus.REVIEW).build();
    ...
    public void shouldReturnNoApplicationsDueRevalidationRequest() {
        ApplicationForm form1 = new ApplicationFormBuilder().applicant(user).program(program).adminRequestedRegistry(user)
    ...
    public void shouldReturnNoApplicationsDueRevalidationReminder() {
        ...
        ApplicationForm form1 = new ApplicationFormBuilder().applicant(user).program(program).adminRequestedRegistry(user)
                .status(ApplicationFormStatus.REJECTED).build();
        ApplicationForm form2 = new ApplicationFormBuilder().applicant(user).program(program).status(ApplicationFormStatus.REVIEW).build();
        NotificationRecord record = new NotificationRecordBuilder().notificationType(NotificationType.REPEAT_VALIDATION_REMINDER)
    ...
    public void shouldReturnApplicationsDueRevalidationReminderThatHaveOverDueReminder() {
        ...
        ApplicationForm form1 = new ApplicationFormBuilder().applicant(user).program(program).registryUsersDueNotification(false).adminRequestedRegistry(user)
                .status(ApplicationFormStatus.REJECTED).build();
        ApplicationForm form2 = new ApplicationFormBuilder().applicant(user).program(program).registryUsersDueNotification(null)
                .status(ApplicationFormStatus.REVIEW).build();
        NotificationRecord record = new NotificationRecordBuilder().notificationType(NotificationType.REPEAT_VALIDATION_REMINDER)
                .notificationDate(notificationDate).build();
        ApplicationForm form3 = new ApplicationFormBuilder().applicant(user).program(program).adminRequestedRegistry(user).registryUsersDueNotification(true)
                .notificationRecords(record).status(ApplicationFormStatus.REVIEW).build();
    ...
    public void shouldReturnApplicationsDueRevalidationReminderThatHaveNoReminder() {
        ...
        NotificationRecord record = new NotificationRecordBuilder().notificationType(NotificationType.REPEAT_VALIDATION_REMINDER)
                .notificationDate(notificationDate).build();
        ApplicationForm form3 = new ApplicationFormBuilder().applicant(user).program(program).notificationRecords(record).status(ApplicationFormStatus.REVIEW)
                .build();
    ...
    public void shouldReturnOverDueApplicationInValidationStageWithReminderMoreThanAWeekAgoReminderInterval() {
        ...
        ApplicationForm applicationForm = new ApplicationFormBuilder()
                ...
                .dueDate(oneMonthAgo)
                .notificationRecords(
                        new NotificationRecordBuilder().notificationType(NotificationType.VALIDATION_REMINDER).notificationDate(eightDaysAgo).build()).build();
    ...
    public void shouldReturnOverDueApplicationInValidationStageWithNoReminderForOneWeekReminder() {
        ...
        ApplicationForm applicationForm = new ApplicationFormBuilder().program(program).applicant(user).suppressChangeStateNotifications(false)
    ...
    public void shouldNotReturnApplicationsNotInApprovalStageForOneWeekReminder() {
        ...
        ApplicationForm applicationForm = new ApplicationFormBuilder()
                ...
                .dueDate(oneMonthAgo)
                .notificationRecords(
                        new NotificationRecordBuilder().notificationType(NotificationType.APPROVAL_REMINDER).notificationDate(eightDaysAgo).build()).build();
        save(applicationForm);
    ...
    public void shouldNotReturnOverDueApplicationInValidationStageWithReminderSixDaysWeekAgo() {
        ...
        ApplicationForm applicationForm = new ApplicationFormBuilder()
                ...
                .dueDate(oneMonthAgo)
                .notificationRecords(
                        new NotificationRecordBuilder().notificationType(NotificationType.VALIDATION_REMINDER).notificationDate(sixDaysAgo).build()).build();
        save(applicationForm);
    ...
    public void shouldNotReturnOverDueApplicationInApprovalStageWithReminderSixDaysWeekAgo() {
        ...
        ApplicationForm applicationForm = new ApplicationFormBuilder().program(program).applicant(user).status(ApplicationFormStatus.APPROVAL)
                .dueDate(oneMonthAgo)
                .notificationRecords(new NotificationRecordBuilder().notificationType(NotificationType.APPROVAL_REMINDER).notificationDate(sixDaysAgo).build())
                .build();
        save(applicationForm);
    ...
    public void shouldReturnOverDueApplicationInValidationStageWithReminder1HourAgoForAReminderWith30MinutesInterval() {
        ...
        ApplicationForm applicationForm = new ApplicationFormBuilder()
                ...
                .status(ApplicationFormStatus.VALIDATION)
                .dueDate(oneMonthAgo)
                .notificationRecords(new NotificationRecordBuilder().notificationType(NotificationType.VALIDATION_REMINDER).notificationDate(oneDayAgo).build())
                .build();
        save(applicationForm);
    ...
    public void shouldNotReturnOverDueApplicationInValidationStageWithReminder1HourAgoForAReminderWith2HoursInterval() {
        ...
        ApplicationForm applicationForm = new ApplicationFormBuilder()
                ...
                .dueDate(oneMonthAgo)
                .notificationRecords(
                        new NotificationRecordBuilder().notificationType(NotificationType.VALIDATION_REMINDER).notificationDate(onehourAgo).build()).build();
        save(applicationForm);
    ...
    public void shouldNotReturnOverDueApplicationInValidationStageWithReminder5MinutesAgoForAReminderWith10MinutesInterval() {
        ...
        ApplicationForm applicationForm = new ApplicationFormBuilder()
                ...
                .dueDate(oneMonthAgo)
                .notificationRecords(
                        new NotificationRecordBuilder().notificationType(NotificationType.VALIDATION_REMINDER).notificationDate(fiveMinutesAgo).build())
                .build();
        save(applicationForm);
    ...
    public void shouldReturnOverDueApplicationInValidationStageWithReminder10MinutesAgoForAReminderWith5MinutesInterval() {
        ...
        ApplicationForm applicationForm = new ApplicationFormBuilder()
                ...
                .dueDate(oneMonthAgo)
                .notificationRecords(
                        new NotificationRecordBuilder().notificationType(NotificationType.VALIDATION_REMINDER).notificationDate(tenMinutesAgo).build()).build();
        save(applicationForm);
    ...
    public void shouldNotReturnApplicationForDuplicateNotificationRecords() throws ParseException {
        ...
        ApplicationForm applicationForm = new ApplicationFormBuilder().program(program).applicant(user).lastUpdated(sixtySeventMinutesAgo)
                .status(ApplicationFormStatus.VALIDATION).notificationRecords(updatedNotification, duplicateNpdatedNotification).build();
        ...
        ApplicationForm applicationForm = new ApplicationFormBuilder()
                ...
                .notificationRecords(
                        new NotificationRecordBuilder().notificationType(NotificationType.APPLICANT_MOVED_TO_INTERVIEW_NOTIFICATION)
                                .notificationDate(new Date()).build()).program(program).applicant(user).status(ApplicationFormStatus.REVIEW).applicant(user)
    ...
    public void shouldNotReturnApplicationsWithApprovedNotificationrRecord() {
        ...
        ApplicationForm applicationForm = new ApplicationFormBuilder()
                .notificationRecords(
                        new NotificationRecordBuilder().notificationType(NotificationType.APPROVED_NOTIFICATION).notificationDate(new Date()).build())
                .program(program).applicant(user).status(ApplicationFormStatus.REVIEW).approver(approver).status(ApplicationFormStatus.APPROVED).build();
    ...
    public void shouldNotReturnApplicationNotMovedInApprovalSinceLastAlert() {
        ...
        Supervisor supervisor = new SupervisorBuilder().isPrimary(true).confirmedSupervision(true).user(supervisorUser).build();
        ...
        save(supervisorUser, applicationForm, approvalRound);
    ...
    public void shouldGetApplicationsDueDueApprovalReminder() {
        ...
        ApplicationForm applicationForm = new ApplicationFormBuilder()
                ...
                .notificationRecords(
                        ...
                        new NotificationRecordBuilder().notificationDate(oldDate.toDate()).notificationType(NotificationType.APPROVAL_REMINDER).build())
                .build();
    ...
    public void shouldNotReturnApplicationIfInApprovalButHasApprovalNotificationRecord() {
        ApplicationForm applicationForm = new ApplicationFormBuilder()
                ...
                .status(ApplicationFormStatus.APPROVAL)
                .notificationRecords(
                        new NotificationRecordBuilder().notificationDate(new Date()).notificationType(NotificationType.APPROVAL_NOTIFICATION).build()).build();
        RegisteredUser supervisorUser = new RegisteredUserBuilder().firstName("Super").lastName("Visor").email("super@test.com").username("supervisor")
                .password("password").accountNonExpired(false).accountNonLocked(false).credentialsNonExpired(false).enabled(true).build();
        Supervisor supervisor = new SupervisorBuilder().isPrimary(true).confirmedSupervision(true).user(supervisorUser).build();
        ApprovalRound approvalRound = new ApprovalRoundBuilder().application(applicationForm).supervisors(supervisor).build();
    ...
    public void shouldReturnApplicationFormDueRegistryNotification() {
        ...
        ApplicationForm applicationForm = new ApplicationFormBuilder().registryUsersDueNotification(true).program(program).applicant(user)
                .status(ApplicationFormStatus.REVIEW).events(new StateChangeEventBuilder().date(tenMinutesAgo).newStatus(ApplicationFormStatus.REVIEW).build())
                .build();
        save(applicationForm);
        ...
        ApplicationForm applicationForm = new ApplicationFormBuilder()
                .notificationRecords(
                        new NotificationRecordBuilder().notificationDate(new Date()).notificationType(NotificationType.APPROVAL_RESTART_REQUEST_NOTIFICATION)
                                .build()).pendingApprovalRestart(true).program(program).applicant(user).status(ApplicationFormStatus.APPROVAL).build();
        save(applicationForm);
    ...
    public void shouldReturnApplicationFormPendingApprovalRestartForReminderIfNotificationAndRemindersMoreThanReminderIntervalAgo() {
        ...
        ApplicationForm applicationForm = new ApplicationFormBuilder()
                .notificationRecords(
                        ...
                        new NotificationRecordBuilder().notificationDate(twoWeeksAgo).notificationType(NotificationType.APPROVAL_RESTART_REQUEST_REMINDER)
                                .build()).pendingApprovalRestart(true).program(program).applicant(user).status(ApplicationFormStatus.APPROVAL).build();
        save(applicationForm);
    ...
    public void shouldNoteturnApplicationFormPendingApprovalRestartForReminderIfNotInApproval() {
        ...
        ApplicationForm applicationForm = new ApplicationFormBuilder()
                .notificationRecords(
                        new NotificationRecordBuilder().notificationDate(twoWeeksAgo).notificationType(NotificationType.APPROVAL_RESTART_REQUEST_NOTIFICATION)
                                .build()).pendingApprovalRestart(true).program(program).applicant(user).status(ApplicationFormStatus.REVIEW).build();
        save(applicationForm);
    ...
    public void shouldNotReturnApplicationFormPendingApprovalRestartForReminderIfNotPendingApprovalRestart() {
        ...
        ApplicationForm applicationForm = new ApplicationFormBuilder()
                .notificationRecords(
                        new NotificationRecordBuilder().notificationDate(twoWeeksAgo).notificationType(NotificationType.APPROVAL_RESTART_REQUEST_NOTIFICATION)
                                .build()).pendingApprovalRestart(false).program(program).applicant(user).status(ApplicationFormStatus.APPROVAL).build();
        save(applicationForm);
    ...
    public void shouldNotReturnApplicationFormPendingApprovalRestartForReminderIfReminderWithinReminderPeriod() {
        ...
        ApplicationForm applicationForm = new ApplicationFormBuilder()
                .notificationRecords(
                        new NotificationRecordBuilder().notificationDate(twoWeeksAgo).notificationType(NotificationType.APPROVAL_RESTART_REQUEST_NOTIFICATION)
                                .build(),
                        new NotificationRecordBuilder().notificationDate(threeDaysAgo).notificationType(NotificationType.APPROVAL_RESTART_REQUEST_REMINDER)
                                .build()).pendingApprovalRestart(true).program(program).applicant(user).status(ApplicationFormStatus.APPROVAL).build();
        save(applicationForm);
    ...
    public void shouldNotReturnApplicationsWithApprovalNotificationrRecord() {
        ...
        ApplicationForm applicationForm = new ApplicationFormBuilder()
                .notificationRecords(
                        new NotificationRecordBuilder().notificationType(NotificationType.APPLICATION_MOVED_TO_APPROVAL_NOTIFICATION)
                                .notificationDate(new Date()).build()).program(program).applicant(user).status(ApplicationFormStatus.APPROVAL).build();
