...
public enum PrismDisplayPropertyDefinition implements PrismConfigurationCategorizable<PrismDisplayPropertyCategory> {
    ...
    SYSTEM_FILTER_PROPERTY_STUDY_Department(SYSTEM_FILTER_PROPERTY, "Study Department"),
    ...
    APPLICATION_STUDY_DETAIL_Department_LABEL(APPLICATION_STUDY_DETAIL, "Department of Study"),
    APPLICATION_STUDY_DETAIL_Department_HINT(APPLICATION_STUDY_DETAIL,
