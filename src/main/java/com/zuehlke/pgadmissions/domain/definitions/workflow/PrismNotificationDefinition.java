...
import static com.zuehlke.pgadmissions.domain.definitions.PrismDisplayPropertyDefinition.APPLICATION_CORRECT_REQUEST_LABEL;
import static com.zuehlke.pgadmissions.domain.definitions.PrismDisplayPropertyDefinition.APPLICATION_CORRECT_REQUEST_REMINDER_LABEL;
import static com.zuehlke.pgadmissions.domain.definitions.PrismDisplayPropertyDefinition.APPLICATION_CORRECT_REQUEST_REMINDER_TOOLTIP;
import static com.zuehlke.pgadmissions.domain.definitions.PrismDisplayPropertyDefinition.APPLICATION_CORRECT_REQUEST_TOOLTIP;
...
import static com.zuehlke.pgadmissions.domain.definitions.PrismDisplayPropertyDefinition.APPLICATION_RESERVE_NOTIFICATION_LABEL;
import static com.zuehlke.pgadmissions.domain.definitions.PrismDisplayPropertyDefinition.APPLICATION_RESERVE_NOTIFICATION_TOOLTIP;
...
public enum PrismNotificationDefinition {
	...
	APPLICATION_RESERVE_NOTIFICATION(INDIVIDUAL, UPDATE, APPLICATION, APPLICATION_RESERVE_NOTIFICATION_LABEL, APPLICATION_RESERVE_NOTIFICATION_TOOLTIP, //
	...
	APPLICATION_CONFIRM_REJECTION_NOTIFICATION(INDIVIDUAL, UPDATE, APPLICATION, APPLICATION_CONFIRM_REJECTION_NOTIFICATION_LABEL,
	        APPLICATION_CONFIRM_REJECTION_NOTIFICATION_TOOLTIP, Lists.newArrayList(INSTITUTION_GLOBAL, APPLICATION_GLOBAL, APPLICATION_REJECTED,
	                COMMENT_GLOBAL, TEMPLATE_GLOBAL)), //
	APPLICATION_CORRECT_REQUEST(INDIVIDUAL, REQUEST, APPLICATION, APPLICATION_CORRECT_REQUEST_LABEL, APPLICATION_CORRECT_REQUEST_TOOLTIP, Lists.newArrayList(
	        INSTITUTION_GLOBAL, APPLICATION_GLOBAL, APPLICATION_APPROVED, COMMENT_GLOBAL, TEMPLATE_GLOBAL)), //
	APPLICATION_CORRECT_REQUEST_REMINDER(INDIVIDUAL, REMINDER, APPLICATION, APPLICATION_CORRECT_REQUEST_REMINDER_LABEL,
	        APPLICATION_CORRECT_REQUEST_REMINDER_TOOLTIP, Lists.newArrayList(INSTITUTION_GLOBAL, APPLICATION_GLOBAL, APPLICATION_APPROVED, COMMENT_GLOBAL,
	                TEMPLATE_GLOBAL)), //
	...
	APPLICATION_REVERSE_REJECTION_NOTIFICATION(INDIVIDUAL, UPDATE, APPLICATION, APPLICATION_CONFIRM_REJECTION_NOTIFICATION_LABEL,
	        APPLICATION_CONFIRM_REJECTION_NOTIFICATION_TOOLTIP, Lists.newArrayList(INSTITUTION_GLOBAL, APPLICATION_GLOBAL, APPLICATION_REJECTED,
	                COMMENT_GLOBAL, TEMPLATE_GLOBAL)), //
