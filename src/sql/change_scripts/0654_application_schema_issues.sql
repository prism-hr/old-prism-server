...
CREATE TABLE STATE_TRANSITION_EVALUATION (
	...
	processing_order INT(1) UNSIGNED NOT NULL,
	PRIMARY KEY (id)
) ENGINE = INNODB
	SELECT "PROJECT_STATE_SELECTION" AS id, 0 AS processing_order
		UNION
	SELECT "PROJECT_EXPIRY_STATUS", 0
		UNION
	SELECT "PROGRAM_STATE_SELECTION", 1
		UNION
	SELECT "PROGRAM_INSTITUTION_STATUS", 0
		UNION
	SELECT "PROGRAM_EXPIRY_STATUS", 0
		UNION
	SELECT "APPLICATION_STATE_SELECTION", 0
		UNION
	SELECT "APPLICATION_ELIGIBILITY_STATUS", 0
		UNION
	SELECT "APPLICATION_EXPORT_REQUIREMENT", 0
		UNION
	SELECT "APPLICATION_INTERVIEW_STATUS", 0
		UNION
	SELECT "APPLICATION_EXPORT_STATUS", 0
;
...
INSERT INTO STATE_TRANSITION (state_action_id, state_transition_type_id, transition_state_id, state_transition_evaluation_id)
	SELECT id, "ONE_COMPLETED", "APPLICATION_VALIDATION_PENDING_FEEDBACK", "APPLICATION_ELIGIBILITY_STATUS"
	FROM STATE_ACTION
	WHERE state_id = "APPLICATION_VALIDATION"
		AND action_id = "APPLICATION_ASSESS_ELIGIBILITY"
		UNION
	SELECT id, "ONE_COMPLETED", "APPLICATION_VALIDATION_PENDING_COMPLETION", "APPLICATION_ELIGIBILITY_STATUS"
	FROM STATE_ACTION
	WHERE state_id = "APPLICATION_VALIDATION"
		AND action_id = "APPLICATION_ASSESS_ELIGIBILITY"
		UNION
	SELECT id, "ONE_COMPLETED", "APPLICATION_WITHDRAWN", "APPLICATION_EXPORT_REQUIREMENT"
	FROM STATE_ACTION
	WHERE state_id = "APPLICATION_VALIDATION"
		AND action_id = "APPLICATION_WITHDRAW"
		UNION
	SELECT id, "ONE_COMPLETED", "APPLICATION_WITHDRAWN_COMPLETED", "APPLICATION_EXPORT_REQUIREMENT"
	FROM STATE_ACTION
	WHERE state_id = "APPLICATION_VALIDATION"
		AND action_id = "APPLICATION_WITHDRAW"
		UNION
	SELECT id, "PROPAGATION", "APPLICATION_REJECTED_PENDING_EXPORT", "APPLICATION_EXPORT_REQUIREMENT"
	FROM STATE_ACTION
	WHERE state_id = "APPLICATION_VALIDATION"
		AND action_id = "APPLICATION_ESCALATE"
		UNION
	SELECT id, "PROPAGATION", "APPLICATION_REJECTED_COMPLETED", "APPLICATION_EXPORT_REQUIREMENT"
	FROM STATE_ACTION
	WHERE state_id = "APPLICATION_VALIDATION"
		AND action_id = "APPLICATION_ESCALATE"
;
...
INSERT INTO STATE_TRANSITION (state_action_id, state_transition_type_id, transition_state_id, state_transition_evaluation_id, display_order)
	SELECT id, "ONE_COMPLETED", "APPLICATION_VALIDATION_PENDING_COMPLETION", NULL, NULL
	FROM STATE_ACTION
	WHERE state_id = "APPLICATION_VALIDATION_PENDING_FEEDBACK"
		AND action_id = "APPLICATION_CONFIRM_ELIGIBILITY"
		UNION
	SELECT id, "ONE_COMPLETED", "APPLICATION_REVIEW", "APPLICATION_STATE_SELECTION", 0
	FROM STATE_ACTION
	WHERE state_id = "APPLICATION_VALIDATION_PENDING_FEEDBACK"
		AND action_id = "APPLICATION_COMPLETE_VALIDATION_STAGE"
		UNION
	SELECT id, "ONE_COMPLETED", "APPLICATION_INTERVIEW", "APPLICATION_STATE_SELECTION", 1
	FROM STATE_ACTION
	WHERE state_id = "APPLICATION_VALIDATION_PENDING_FEEDBACK"
		AND action_id = "APPLICATION_COMPLETE_VALIDATION_STAGE"
		UNION
	SELECT id, "ONE_COMPLETED", "APPLICATION_APPROVAL", "APPLICATION_STATE_SELECTION", 2
	FROM STATE_ACTION
	WHERE state_id = "APPLICATION_VALIDATION_PENDING_FEEDBACK"
		AND action_id = "APPLICATION_COMPLETE_VALIDATION_STAGE"
		UNION
	SELECT id, "ONE_COMPLETED", "APPLICATION_APPROVED", "APPLICATION_STATE_SELECTION", 3
	FROM STATE_ACTION
	WHERE state_id = "APPLICATION_VALIDATION_PENDING_FEEDBACK"
		AND action_id = "APPLICATION_COMPLETE_VALIDATION_STAGE"
		UNION
	SELECT id, "ONE_COMPLETED", "APPLICATION_REJECTED", "APPLICATION_STATE_SELECTION", 4
	FROM STATE_ACTION
	WHERE state_id = "APPLICATION_VALIDATION_PENDING_FEEDBACK"
		AND action_id = "APPLICATION_COMPLETE_VALIDATION_STAGE"
		UNION
	SELECT id, "ONE_COMPLETED", "APPLICATION_WITHDRAWN", "APPLICATION_EXPORT_REQUIREMENT",  NULL
	FROM STATE_ACTION
	WHERE state_id = "APPLICATION_VALIDATION_PENDING_FEEDBACK"
		AND action_id = "APPLICATION_WITHDRAW"
		UNION
	SELECT id, "ONE_COMPLETED", "APPLICATION_WITHDRAWN_COMPLETED", "APPLICATION_EXPORT_REQUIREMENT", NULL
	FROM STATE_ACTION
	WHERE state_id = "APPLICATION_VALIDATION_PENDING_FEEDBACK"
		AND action_id = "APPLICATION_WITHDRAW"
		UNION
	SELECT id, "PROPAGATION", "APPLICATION_REJECTED_PENDING_EXPORT", "APPLICATION_EXPORT_REQUIREMENT", NULL
	FROM STATE_ACTION
	WHERE state_id = "APPLICATION_VALIDATION_PENDING_FEEDBACK"
		AND action_id = "APPLICATION_ESCALATE"
		UNION
	SELECT id, "PROPAGATION", "APPLICATION_REJECTED_COMPLETED", "APPLICATION_EXPORT_REQUIREMENT", NULL
	FROM STATE_ACTION
	WHERE state_id = "APPLICATION_VALIDATION_PENDING_FEEDBACK"
		AND action_id = "APPLICATION_ESCALATE"
;
...
INSERT INTO STATE_TRANSITION (state_action_id, state_transition_type_id, transition_state_id, state_transition_evaluation_id, display_order)
	SELECT id, "ONE_COMPLETED", "APPLICATION_REVIEW_PENDING_FEEDBACK", NULL, NULL
	FROM STATE_ACTION
	WHERE state_id = "APPLICATION_REVIEW"
		AND action_id = "APPLICATION_ASSIGN_REVIEWERS"
		UNION
	SELECT id, "ONE_COMPLETED", "APPLICATION_INTERVIEW", "APPLICATION_STATE_SELECTION", 0
	FROM STATE_ACTION
	WHERE state_id = "APPLICATION_REVIEW"
		AND action_id = "APPLICATION_MOVE_TO_DIFFERENT_STAGE"
		UNION
	SELECT id, "ONE_COMPLETED", "APPLICATION_APPROVAL", "APPLICATION_STATE_SELECTION", 1
	FROM STATE_ACTION
	WHERE state_id = "APPLICATION_REVIEW"
		AND action_id = "APPLICATION_MOVE_TO_DIFFERENT_STAGE"
		UNION
	SELECT id, "ONE_COMPLETED", "APPLICATION_APPROVED", "APPLICATION_STATE_SELECTION", 2
	FROM STATE_ACTION
	WHERE state_id = "APPLICATION_REVIEW"
		AND action_id = "APPLICATION_MOVE_TO_DIFFERENT_STAGE"
		UNION
	SELECT id, "ONE_COMPLETED", "APPLICATION_REJECTED", "APPLICATION_STATE_SELECTION", 3
	FROM STATE_ACTION
	WHERE state_id = "APPLICATION_REVIEW"
		AND action_id = "APPLICATION_MOVE_TO_DIFFERENT_STAGE"
		UNION
	...
	WHERE state_id = "APPLICATION_REVIEW"
		AND action_id = "APPLICATION_WITHDRAW"
		UNION
	SELECT id, "ONE_COMPLETED", "APPLICATION_REVIEW", NULL, NULL
	FROM STATE_ACTION
	WHERE state_id = "APPLICATION_REVIEW"
...
INSERT INTO ROLE_TRANSITION (state_transition_id, role_id, role_transition_type_id, transition_role_id)
	...
	FROM STATE_TRANSITION INNER JOIN STATE_ACTION
		ON STATE_TRANSITION.state_action_id = STATE_ACTION.id
	WHERE STATE_ACTION.action_id IN ("APPLICATION_WITHDRAW", "APPLICATION_ESCALATE")
		AND STATE_ACTION.state_id = "APPLICATION_REVIEW"
		UNION
...
INSERT INTO STATE_TRANSITION (state_action_id, state_transition_type_id, transition_state_id, state_transition_evaluation_id, display_order)
	...
	WHERE state_id = "APPLICATION_REVIEW_PENDING_FEEDBACK"
		...
		UNION
	SELECT id, "ALL_COMPLETED", "APPLICATION_REVIEW_PENDING_COMPLETION", NULL, NULL
	FROM STATE_ACTION
	WHERE state_id = "APPLICATION_REVIEW_PENDING_FEEDBACK"
		AND action_id = "APPLICATION_PROVIDE_REVIEW"
		UNION
	SELECT id, "DUE_DATE_EXPIRY", "APPLICATION_REVIEW_PENDING_COMPLETION", NULL, NULL
	FROM STATE_ACTION
	WHERE state_id = "APPLICATION_REVIEW_PENDING_FEEDBACK"
		AND action_id = "APPLICATION_ESCALATE"
		UNION
...
INSERT INTO ROLE_TRANSITION (state_transition_id, role_id, role_transition_type_id, transition_role_id)
	...
	FROM STATE_TRANSITION INNER JOIN STATE_ACTION
		ON STATE_TRANSITION.state_action_id = STATE_ACTION.id
	INNER JOIN ROLE
	WHERE STATE_ACTION.action_id IN ("APPLICATION_WITHDRAW", "APPLICATION_ESCALATE", "APPLICATION_COMPLETE_REVIEW_STAGE")
		AND STATE_ACTION.state_id = "APPLICATION_REVIEW_PENDING_FEEDBACK"
		AND ROLE.id IN ("APPLICATION_ADMINISTRATOR", "APPLICATION_REVIEWER")
		UNION
	SELECT STATE_TRANSITION.id, "APPLICATION_REFEREE", "UPDATE_ALL", "APPLICATION_VIEWER_REFEREE"
...
INSERT INTO STATE_TRANSITION (state_action_id, state_transition_type_id, transition_state_id, state_transition_evaluation_id, display_order)
	...
	WHERE state_id = "APPLICATION_REVIEW_PENDING_COMPLETION"
		AND action_id = "APPLICATION_WITHDRAW"
		UNION
	SELECT id, "ONE_COMPLETED", "APPLICATION_REVIEW_PENDING_COMPLETION", NULL, NULL
	FROM STATE_ACTION
	WHERE state_id = "APPLICATION_REVIEW_PENDING_COMPLETION"
		AND action_id = "APPLICATION_PROVIDE_REVIEW"
		UNION
...
INSERT INTO STATE_TRANSITION (state_action_id, state_transition_type_id, transition_state_id, state_transition_evaluation_id, display_order)
	SELECT id, "ONE_COMPLETED", "APPLICATION_INTERVIEW_PENDING_SCHEDULING", "APPLICATION_INTERVIEW_STATUS", NULL
	FROM STATE_ACTION
	WHERE state_id = "APPLICATION_INTERVIEW"
		AND action_id = "APPLICATION_ASSIGN_INTERVIEWERS"
		UNION
	SELECT id, "ONE_COMPLETED", "APPLICATION_INTERVIEW_PENDING_INTERVIEW", "APPLICATION_INTERVIEW_STATUS", NULL
	FROM STATE_ACTION
	WHERE state_id = "APPLICATION_INTERVIEW"
		AND action_id = "APPLICATION_ASSIGN_INTERVIEWERS"
		UNION
	SELECT id, "ONE_COMPLETED", "APPLICATION_INTERVIEW_PENDING_FEEDBACK", "APPLICATION_INTERVIEW_STATUS", NULL
	FROM STATE_ACTION
	WHERE state_id = "APPLICATION_INTERVIEW"
		AND action_id = "APPLICATION_ASSIGN_INTERVIEWERS"
		UNION
	...
	WHERE state_id = "APPLICATION_INTERVIEW"
		AND action_id = "APPLICATION_WITHDRAW"
		UNION
	SELECT id, "ONE_COMPLETED", "APPLICATION_INTERVIEW", NULL, NULL
	FROM STATE_ACTION
	WHERE state_id = "APPLICATION_INTERVIEW"
		AND action_id = "APPLICATION_PROVIDE_REFERENCE"
		UNION
...
INSERT INTO STATE_TRANSITION (state_action_id, state_transition_type_id, transition_state_id, state_transition_evaluation_id, display_order)
	SELECT id, "ONE_COMPLETED", "APPLICATION_INTERVIEW_PENDING_AVAILABILITY", NULL, NULL
	FROM STATE_ACTION
	WHERE state_id = "APPLICATION_INTERVIEW_PENDING_AVAILABILITY"
		AND action_id = "APPLICATION_PROVIDE_INTERVIEW_AVAILABILITY"		
		UNION
	SELECT id, "ALL_COMPLETED", "APPLICATION_INTERVIEW_PENDING_SCHEDULING", NULL, NULL
	FROM STATE_ACTION
	WHERE state_id = "APPLICATION_INTERVIEW_PENDING_AVAILABILITY"
		AND action_id = "APPLICATION_PROVIDE_INTERVIEW_AVAILABILITY"	
		UNION
	SELECT id, "DUE_DATE_EXPIRY", "APPLICATION_INTERVIEW_PENDING_SCHEDULING", NULL, NULL
	FROM STATE_ACTION
	WHERE state_id = "APPLICATION_INTERVIEW_PENDING_AVAILABILITY"
		AND action_id = "APPLICATION_ESCALATE"		
		UNION
...
INSERT INTO ROLE_TRANSITION (state_transition_id, role_id, role_transition_type_id, transition_role_id)
	...
	FROM STATE_TRANSITION INNER JOIN STATE_ACTION
		ON STATE_TRANSITION.state_action_id = STATE_ACTION.id
	INNER JOIN ROLE
	WHERE STATE_ACTION.action_id IN ("APPLICATION_WITHDRAW", "APPLICATION_ESCALATE", "APPLICATION_COMPLETE_INTERVIEW_STAGE")
		AND STATE_ACTION.state_id = "APPLICATION_INTERVIEW_PENDING_AVAILABILITY"
...
INSERT INTO STATE_TRANSITION (state_action_id, state_transition_type_id, transition_state_id, state_transition_evaluation_id, display_order)
	SELECT id, "ONE_COMPLETED", "APPLICATION_INTERVIEW_PENDING_SCHEDULING", NULL, NULL
	FROM STATE_ACTION
...
INSERT INTO STATE_TRANSITION (state_action_id, state_transition_type_id, transition_state_id, state_transition_evaluation_id, display_order)
	...
	WHERE state_id = "APPLICATION_INTERVIEW_PENDING_INTERVIEW"
		AND action_id = "APPLICATION_WITHDRAW"
		UNION
	SELECT id, "ONE_COMPLETED", "APPLICATION_INTERVIEW_PENDING_INTERVIEW", NULL, NULL
	FROM STATE_ACTION
	WHERE state_id = "APPLICATION_INTERVIEW_PENDING_INTERVIEW"
		AND action_id = "APPLICATION_PROVIDE_REFERENCE"
		UNION
	SELECT id, "DUE_DATE_EXPIRY", "APPLICATION_INTERVIEW_PENDING_FEEDBACK", NULL, NULL
	FROM STATE_ACTION
	WHERE state_id = "APPLICATION_INTERVIEW_PENDING_INTERVIEW"
		AND action_id = "APPLICATION_ESCALATE"
		UNION
...
INSERT INTO STATE_TRANSITION (state_action_id, state_transition_type_id, transition_state_id, state_transition_evaluation_id, display_order)
	SELECT id, "ONE_COMPLETED", "APPLICATION_INTERVIEW_PENDING_FEEDBACK", NULL, NULL
	FROM STATE_ACTION
	WHERE state_id = "APPLICATION_INTERVIEW_PENDING_FEEDBACK"
		AND action_id = "APPLICATION_PROVIDE_INTERVIEW_FEEDBACK"		
		UNION
	SELECT id, "ALL_COMPLETED", "APPLICATION_INTERVIEW_PENDING_COMPLETION", NULL, NULL
	FROM STATE_ACTION
	WHERE state_id = "APPLICATION_INTERVIEW_PENDING_FEEDBACK"
		AND action_id = "APPLICATION_PROVIDE_INTERVIEW_FEEDBACK"		
		UNION
	SELECT id, "DUE_DATE_EXPIRY", "APPLICATION_INTERVIEW_PENDING_COMPLETION", NULL, NULL
	FROM STATE_ACTION
	WHERE state_id = "APPLICATION_INTERVIEW_PENDING_FEEDBACK"
		AND action_id = "APPLICATION_ESCALATE"		
		UNION
...
INSERT INTO STATE_TRANSITION (state_action_id, state_transition_type_id, transition_state_id, state_transition_evaluation_id, display_order)
	SELECT id, "ONE_COMPLETED", "APPLICATION_INTERVIEW_PENDING_COMPLETION", NULL, NULL
	FROM STATE_ACTION
...
INSERT INTO STATE_TRANSITION (state_action_id, state_transition_type_id, transition_state_id, state_transition_evaluation_id, display_order)
	SELECT id, "ONE_COMPLETED", "APPLICATION_APPROVAL_PENDING_FEEDBACK", NULL, NULL
	FROM STATE_ACTION
	...
	WHERE state_id = "APPLICATION_APPROVAL"
		AND action_id = "APPLICATION_WITHDRAW"
		UNION
	SELECT id, "ONE_COMPLETED", "APPLICATION_APPROVAL", NULL, NULL
	FROM STATE_ACTION
	WHERE state_id = "APPLICATION_APPROVAL"
		AND action_id = "APPLICATION_PROVIDE_REFERENCE"
		UNION
...
INSERT INTO STATE_TRANSITION (state_action_id, state_transition_type_id, transition_state_id, state_transition_evaluation_id, display_order)
	...
	WHERE state_id = "APPLICATION_APPROVAL_PENDING_FEEDBACK"
		...
		UNION
	SELECT id, "ALL_COMPLETED", "APPLICATION_APPROVAL_PENDING_COMPLETION", NULL, NULL
	FROM STATE_ACTION
	WHERE state_id = "APPLICATION_APPROVAL_PENDING_FEEDBACK"
		AND action_id = "APPLICATION_CONFIRM_PRIMARY_SUPERVISION"
		UNION
	SELECT id, "DUE_DATE_EXPIRY", "APPLICATION_APPROVAL_PENDING_COMPLETION", NULL, NULL
	FROM STATE_ACTION
	WHERE state_id = "APPLICATION_APPROVAL_PENDING_FEEDBACK"
		AND action_id = "APPLICATION_ESCALATE"
		UNION
...
INSERT INTO ROLE_TRANSITION (state_transition_id, role_id, role_transition_type_id, transition_role_id)
	...
	FROM STATE_TRANSITION INNER JOIN STATE_ACTION
		ON STATE_TRANSITION.state_action_id = STATE_ACTION.id
	INNER JOIN ROLE
	WHERE STATE_ACTION.action_id IN ("APPLICATION_WITHDRAW", "APPLICATION_ESCALATE", "APPLICATION_COMPLETE_APPROVAL_STAGE")
		AND STATE_ACTION.state_id = "APPLICATION_APPROVAL_PENDING_FEEDBACK"
...
INSERT INTO STATE_TRANSITION (state_action_id, state_transition_type_id, transition_state_id, state_transition_evaluation_id, display_order)
	SELECT id, "ONE_COMPLETED", "APPLICATION_APPROVAL_PENDING_COMPLETION", NULL, NULL
	FROM STATE_ACTION
...
INSERT INTO STATE_TRANSITION (state_action_id, state_transition_type_id, transition_state_id, state_transition_evaluation_id, display_order)
	SELECT id, "ONE_COMPLETED", "APPLICATION_APPROVED_PENDING_EXPORT", "APPLICATION_EXPORT_REQUIREMENT", NULL
	FROM STATE_ACTION
	WHERE state_id = "APPLICATION_APPROVED"
		AND action_id = "APPLICATION_CONFIRM_OFFER_RECOMMENDATION"
		UNION
	SELECT id, "ONE_COMPLETED", "APPLICATION_APPROVED_COMPLETED", "APPLICATION_EXPORT_REQUIREMENT", NULL
	FROM STATE_ACTION
	WHERE state_id = "APPLICATION_APPROVED"
		AND action_id = "APPLICATION_CONFIRM_OFFER_RECOMMENDATION"
		UNION
	...
	WHERE state_id = "APPLICATION_APPROVED"
		AND action_id = "APPLICATION_WITHDRAW"
		UNION
	SELECT id, "ONE_COMPLETED", "APPLICATION_APPROVED", NULL, NULL
	FROM STATE_ACTION
	WHERE state_id = "APPLICATION_APPROVED"
		AND action_id = "APPLICATION_PROVIDE_REFERENCE"
		UNION
...
INSERT INTO ROLE_TRANSITION (state_transition_id, role_id, role_transition_type_id, transition_role_id)
	...
	FROM STATE_TRANSITION INNER JOIN STATE_ACTION
		ON STATE_TRANSITION.state_action_id = STATE_ACTION.id
	WHERE STATE_ACTION.action_id IN ("APPLICATION_WITHDRAW", "APPLICATION_ESCALATE", "APPLICATION_CONFIRM_OFFER_RECOMMENDATION")
		AND STATE_ACTION.state_id = "APPLICATION_APPROVED"
;
...
INSERT INTO STATE_TRANSITION (state_action_id, state_transition_type_id, transition_state_id, state_transition_evaluation_id)
	SELECT id, "DUE_DATE_EXPIRY", "APPLICATION_APPROVED_COMPLETED", "APPLICATION_EXPORT_STATUS"
	FROM STATE_ACTION
	WHERE state_id = "APPLICATION_APPROVED_PENDING_EXPORT"
		AND action_id = "APPLICATION_EXPORT"
		UNION
	SELECT id, "DUE_DATE_EXPIRY", "APPLICATION_APPROVED_PENDING_CORRECTION", "APPLICATION_EXPORT_STATUS"
	FROM STATE_ACTION
	WHERE state_id = "APPLICATION_APPROVED_PENDING_EXPORT"
		AND action_id = "APPLICATION_EXPORT"
;
...
INSERT INTO STATE_TRANSITION (state_action_id, state_transition_type_id, transition_state_id, state_transition_evaluation_id, display_order)
	SELECT id, "ONE_COMPLETED", "APPLICATION_REJECTED_PENDING_EXPORT", NULL, NULL
	FROM STATE_ACTION
	...
	WHERE state_id = "APPLICATION_REJECTED"
		AND action_id = "APPLICATION_WITHDRAW"
		UNION
	SELECT id, "ONE_COMPLETED", "APPLICATION_REJECTED", NULL, NULL
	FROM STATE_ACTION
	WHERE state_id = "APPLICATION_REJECTED"
		AND action_id = "APPLICATION_PROVIDE_REFERENCE"
		UNION
...
INSERT INTO ROLE_TRANSITION (state_transition_id, role_id, role_transition_type_id, transition_role_id)
	...
	FROM STATE_TRANSITION INNER JOIN STATE_ACTION
		ON STATE_TRANSITION.state_action_id = STATE_ACTION.id
	WHERE STATE_ACTION.action_id IN ("APPLICATION_WITHDRAW", "APPLICATION_ESCALATE", "APPLICATION_CONFIRM_REJECTION")
		AND STATE_ACTION.state_id = "APPLICATION_REJECTED"
;
...
INSERT INTO STATE_TRANSITION (state_action_id, state_transition_type_id, transition_state_id, state_transition_evaluation_id)
	SELECT id, "DUE_DATE_EXPIRY", "APPLICATION_REJECTED_COMPLETED", "APPLICATION_EXPORT_STATUS"
	FROM STATE_ACTION
	WHERE state_id = "APPLICATION_REJECTED_PENDING_EXPORT"
		AND action_id = "APPLICATION_EXPORT"
		UNION
	SELECT id, "DUE_DATE_EXPIRY", "APPLICATION_REJECTED_PENDING_CORRECTION", "APPLICATION_EXPORT_STATUS"
	FROM STATE_ACTION
	WHERE state_id = "APPLICATION_REJECTED_PENDING_EXPORT"
		AND action_id = "APPLICATION_EXPORT"
;
...
INSERT INTO STATE_TRANSITION (state_action_id, state_transition_type_id, transition_state_id, state_transition_evaluation_id)
	SELECT id, "DUE_DATE_EXPIRY", "APPLICATION_WITHDRAWN_COMPLETED", "APPLICATION_EXPORT_STATUS"
	FROM STATE_ACTION
	WHERE state_id = "APPLICATION_WITHDRAWN"
		AND action_id = "APPLICATION_EXPORT"
		UNION
	SELECT id, "DUE_DATE_EXPIRY", "APPLICATION_WITHDRAWN_PENDING_CORRECTION", "APPLICATION_EXPORT_STATUS"
	FROM STATE_ACTION
	WHERE state_id = "APPLICATION_WITHDRAWN"
		AND action_id = "APPLICATION_EXPORT"
;
...
INSERT INTO STATE_TRANSITION (state_action_id, state_transition_type_id, transition_state_id)
	...
	WHERE state_id = "INSTITUTION_APPROVED"
		AND action_id = "INSTITUTION_SUGGEST_PROGRAM"
		UNION
	SELECT id, "ONE_COMPLETED", "PROGRAM_APPROVED"
	FROM STATE_ACTION
	WHERE state_id = "INSTITUTION_APPROVED"
...
INSERT INTO STATE_TRANSITION (state_action_id, state_transition_type_id, transition_state_id, state_transition_evaluation_id, display_order)
	SELECT id, "ONE_COMPLETED", "PROGRAM_APPROVED", "APPLICATION_STATE_SELECTION", 0
	FROM STATE_ACTION
	WHERE state_id = "PROGRAM_APPROVAL"
		AND action_id = "PROGRAM_COMPLETE_APPROVAL_STAGE"
		UNION
	SELECT id, "ONE_COMPLETED", "PROGRAM_REJECTED", "APPLICATION_STATE_SELECTION", 1
	FROM STATE_ACTION
	WHERE state_id = "PROGRAM_APPROVAL"
		AND action_id = "PROGRAM_COMPLETE_APPROVAL_STAGE"
;
...
INSERT INTO ROLE_TRANSITION (state_transition_id, role_id, role_transition_type_id, transition_role_id)
	...
	WHERE STATE_ACTION.action_id = "PROGRAM_COMPLETE_APPROVAL_STAGE"
		...
		UNION
	SELECT STATE_TRANSITION.id, "PROGRAM_CREATOR", "REMOVE_ALL", NULL
	FROM STATE_TRANSITION INNER JOIN STATE_ACTION
		ON STATE_TRANSITION.state_action_id = STATE_ACTION.id
	WHERE STATE_ACTION.action_id = "PROGRAM_COMPLETE_APPROVAL_STAGE"
		AND STATE_ACTION.state_id = "PROGRAM_APPROVAL"
		AND STATE_TRANSITION.transition_state_id = "PROGRAM_REJECTED"
;

/* Program approved */

INSERT INTO STATE_TRANSITION (state_action_id, state_transition_type_id, transition_state_id, state_transition_evaluation_id, display_order)
	SELECT id, "ONE_COMPLETED", "PROGRAM_DEACTIVATED", "PROGRAM_STATE_SELECTION", 0
	FROM STATE_ACTION
	WHERE state_id = "PROGRAM_APPROVED"
		AND action_id = "PROGRAM_CONFIGURE"
		UNION
	SELECT id, "ONE_COMPLETED", "PROGRAM_DISABLED", "PROGRAM_STATE_SELECTION", 1
	FROM STATE_ACTION
	WHERE state_id = "PROGRAM_APPROVED"
		AND action_id = "PROGRAM_CONFIGURE"
		UNION
	SELECT id, "ONE_COMPLETED", "PROGRAM_APPROVAL", "PROGRAM_INSTITUTION_STATUS", NULL
	FROM STATE_ACTION
	WHERE state_id = "PROGRAM_APPROVED"
		AND action_id = "PROGRAM_CONFIGURE"
		UNION
	SELECT id, "DUE_DATE_EXPIRY", "PROGRAM_DISABLED_PENDING_REACTIVATION", "PROGRAM_EXPIRY_STATUS", NULL
	FROM STATE_ACTION
	WHERE state_id = "PROGRAM_APPROVED"
		AND action_id = "PROGRAM_ESCALATE"
		UNION
	SELECT id, "DUE_DATE_EXPIRY", "PROGRAM_DISABLED_PENDING_IMPORT_REACTIVATION", "PROGRAM_EXPIRY_STATUS", NULL
	FROM STATE_ACTION
	WHERE state_id = "PROGRAM_APPROVED"
		AND action_id = "PROGRAM_ESCALATE"
		UNION
	SELECT id, "ONE_COMPLETED", "APPLICATION_UNSUBMITTED", NULL, NULL
	FROM STATE_ACTION
	WHERE state_id = "PROGRAM_APPROVED"
		AND action_id = "PROGRAM_CREATE_APPLICATION"
;
		
INSERT INTO ROLE_TRANSITION (state_transition_id, role_id, role_transition_type_id, transition_role_id)
	SELECT STATE_TRANSITION.id, "PROGRAM_APPLICATION_CREATOR", "REMOVE_ALL", NULL
	FROM STATE_TRANSITION INNER JOIN STATE_ACTION
		ON STATE_TRANSITION.state_action_id = STATE_ACTION.id
	WHERE STATE_ACTION.action_id = "PROGRAM_CREATE_APPLICATION"
		AND STATE_ACTION.state_id = "PROGRAM_APPROVED"
		AND STATE_TRANSITION.transition_state_id = "APPLICATION_UNSUBMITTED"
;

/* Program deactivated */

INSERT INTO STATE_TRANSITION (state_action_id, state_transition_type_id, transition_state_id, state_transition_evaluation_id, display_order)
	SELECT id, "ONE_COMPLETED", "PROGRAM_APPROVED", "PROGRAM_STATE_SELECTION", 0
	FROM STATE_ACTION
...
INSERT INTO STATE_TRANSITION (state_action_id, state_transition_type_id, transition_state_id, state_transition_evaluation_id, display_order)
	...
	WHERE state_id = "PROGRAM_DISABLED_PENDING_REACTIVATION"
		AND action_id = "PROGRAM_CONFIGURE"
		UNION
	SELECT id, "ONE_COMPLETED", "PROGRAM_DEACTIVATED", "PROGRAM_STATE_SELECTION", 1
	FROM STATE_ACTION
	WHERE state_id = "PROGRAM_DISABLED_PENDING_REACTIVATION"
		AND action_id = "PROGRAM_CONFIGURE"
		UNION
	...
	WHERE state_id = "PROGRAM_DISABLED_PENDING_REACTIVATION"
		AND action_id = "PROGRAM_CONFIGURE"
		UNION
	SELECT id, "DUE_DATE_EXPIRY", "PROGRAM_DISABLED_COMPLETED", NULL, NULL
	FROM STATE_ACTION
	WHERE state_id = "PROGRAM_DISABLED_PENDING_REACTIVATION"
		AND action_id = "PROGRAM_ESCALATE"
		UNION
...
/* Program disabled pending import reactivation */

INSERT INTO STATE_TRANSITION (state_action_id, state_transition_type_id, transition_state_id, state_transition_evaluation_id, display_order)
	SELECT id, "PROPAGATION", "PROGRAM_APPROVED", "PROGRAM_STATE_SELECTION", 0
	FROM STATE_ACTION
	WHERE state_id = "PROGRAM_DISABLED_PENDING_IMPORT_REACTIVATION"
		AND action_id = "PROGRAM_REACTIVATE"
		UNION
	SELECT id, "PROPAGATION", "PROGRAM_DEACTIVATED", "PROGRAM_STATE_SELECTION", 1
	FROM STATE_ACTION
	WHERE state_id = "PROGRAM_DISABLED_PENDING_IMPORT_REACTIVATION"
		AND action_id = "PROGRAM_REACTIVATE"
		UNION
...
/* Clean up when program is terminated */
...
INSERT INTO STATE_TRANSITION (state_action_id, state_transition_type_id, transition_state_id, state_transition_evaluation_id, display_order)
	SELECT id, "ONE_COMPLETED", "PROJECT_DEACTIVATED", "PROJECT_STATE_SELECTION", 0
	FROM STATE_ACTION
	WHERE state_id = "PROJECT_APPROVED"
		AND action_id = "PROJECT_CONFIGURE"
		UNION
	SELECT id, "ONE_COMPLETED", "PROJECT_DISABLED", "PROJECT_STATE_SELECTION", 1
	FROM STATE_ACTION
	WHERE state_id = "PROJECT_APPROVED"
		AND action_id = "PROJECT_CONFIGURE"
		UNION
	SELECT id, "DUE_DATE_EXPIRY", "PROJECT_DISABLED_PENDING_REACTIVATION", "PROJECT_EXPIRY_STATUS", NULL
	FROM STATE_ACTION
	WHERE state_id = "PROJECT_APPROVED"
		AND action_id = "PROJECT_ESCALATE"
		UNION
	SELECT id, "PROPAGATION", "PROJECT_DISABLED_PENDING_PROGRAM_REACTIVATION", "PROJECT_EXPIRY_STATUS", NULL
	FROM STATE_ACTION
	WHERE state_id = "PROJECT_APPROVED"
		AND action_id = "PROJECT_ESCALATE"
	UNION
	...
	FROM STATE_ACTION
	WHERE state_id = "PROJECT_APPROVED"
		AND action_id = "PROJECT_CREATE_APPLICATION"
;
		
INSERT INTO ROLE_TRANSITION (state_transition_id, role_id, role_transition_type_id, transition_role_id)
	SELECT STATE_TRANSITION.id, "PROJECT_APPLICATION_CREATOR", "REMOVE_ALL", NULL
	FROM STATE_TRANSITION INNER JOIN STATE_ACTION
		ON STATE_TRANSITION.state_action_id = STATE_ACTION.id
...
INSERT INTO STATE_TRANSITION (state_action_id, state_transition_type_id, transition_state_id, state_transition_evaluation_id, display_order)
	SELECT id, "ONE_COMPLETED", "PROJECT_APPROVED", "PROJECT_STATE_SELECTION", 0
	FROM STATE_ACTION
...
INSERT INTO STATE_TRANSITION (state_action_id, state_transition_type_id, transition_state_id, state_transition_evaluation_id, display_order)
	...
	WHERE state_id = "PROJECT_DISABLED_PENDING_REACTIVATION"
		AND action_id = "PROJECT_CONFIGURE"
		UNION
	SELECT id, "ONE_COMPLETED", "PROJECT_DEACTIVATED", "PROJECT_STATE_SELECTION", 1
	FROM STATE_ACTION
	WHERE state_id = "PROJECT_DISABLED_PENDING_REACTIVATION"
		AND action_id = "PROJECT_CONFIGURE"
		UNION
	SELECT id, "DUE_DATE_EXPIRY", "PROJECT_DISABLED_COMPLETED", NULL, NULL
	FROM STATE_ACTION
	WHERE state_id = "PROJECT_DISABLED_PENDING_REACTIVATION"
		AND action_id = "PROJECT_ESCALATE"
		UNION
	SELECT id, "PROPAGATION", "PROJECT_DISABLED_PENDING_PROGRAM_REACTIVATION", NULL, NULL
	FROM STATE_ACTION
	WHERE state_id = "PROJECT_DISABLED_PENDING_REACTIVATION"
		AND action_id = "PROJECT_ESCALATE"
		UNION
...
/* Project disabled pending program reactivation */

INSERT INTO STATE_TRANSITION (state_action_id, state_transition_type_id, transition_state_id)
	SELECT id, "PROPAGATION", "PROJECT_APPROVED"
	FROM STATE_ACTION
	WHERE state_id = "PROJECT_DISABLED_PENDING_PROGRAM_REACTIVATION"
		AND action_id = "PROJECT_REACTIVATE"
		UNION
	SELECT id, "PROPAGATION", "PROJECT_DEACTIVATED"
	FROM STATE_ACTION
	WHERE state_id = "PROJECT_DISABLED_PENDING_PROGRAM_REACTIVATION"
		AND action_id = "PROJECT_REACTIVATE"
		UNION
	SELECT id, "PROPAGATION", "PROJECT_DISABLED_COMPLETED"
	FROM STATE_ACTION
	WHERE state_id = "PROJECT_DISABLED_PENDING_PROGRAM_REACTIVATION"
		AND action_id = "PROJECT_ESCALATE"
	UNION
...
/* Clean up when project is terminated */
...
CREATE TABLE STATE_TRANSITION_PROPAGATION (
	...
	INNER JOIN STATE_ACTION
		ON PROPAGATED_STATE_TRANSITION.state_action_id = STATE_ACTION.id
	WHERE STATE_TRANSITION.transition_state_id = "PROJECT_DISABLED_PENDING_PROGRAM_REACTIVATION"
		AND PROPAGATED_STATE_TRANSITION.state_transition_type_id = "PROPAGATION"
;

ALTER TABLE STATE_TRANSITION_TYPE
	ADD COLUMN processing_order INT(1) UNSIGNED,
	ADD INDEX (processing_order)
;

UPDATE STATE_TRANSITION_TYPE
SET processing_order = 0
WHERE id = "PROPAGATION"
;

UPDATE STATE_TRANSITION_TYPE
SET processing_order = 1
WHERE id = "DUE_DATE_EXPIRY"
;

UPDATE STATE_TRANSITION_TYPE
SET processing_order = 2
WHERE id = "ONE_COMPLETED"
;

UPDATE STATE_TRANSITION_TYPE
SET processing_order = 2
WHERE id = "ALL_COMPLETED"
;
