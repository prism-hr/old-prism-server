...
import com.zuehlke.pgadmissions.referencedata.jaxb.StudyOptions.StudyOption;

@Component
public class ImportedStudyOptionExtractor implements ImportedEntityExtractor {
    ...
    public List<String> extract(Institution institution, PrismImportedEntity prismImportedEntity, List<Object> definitions) throws Exception {
        ...
        for (Object definition : definitions) {
            StudyOption studyOption = (StudyOption) definition;
            ...
            cells.add(prepareStringForSqlInsert(studyOption.getCode()));
            cells.add(prepareStringForSqlInsert(studyOption.getName()));
