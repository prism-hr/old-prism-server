...
CREATE TABLE RESOURCE_LIST_FILTER_CONSTRAINT (
	...
	filter_term_string VARCHAR(50),
	filter_term_date_start DATE,
	filter_term_date_close DATE,
	filter_term_state_group_id VARCHAR(50),
	filter_term_decimal_start DECIMAL(10,2),
	filter_term_decimal_close DECIMAL(10,2),
	PRIMARY KEY (id),
	INDEX (filter_property),
	UNIQUE INDEX (resource_list_filter_id, filter_property, filter_term_string),
	UNIQUE INDEX (resource_list_filter_id, filter_property, filter_term_date_start, filter_term_date_close),
	UNIQUE INDEX (resource_list_filter_id, filter_property, filter_term_state_group_id),
	UNIQUE INDEX (resource_list_filter_id, filter_property, filter_term_decimal_start, filter_term_decimal_close),
