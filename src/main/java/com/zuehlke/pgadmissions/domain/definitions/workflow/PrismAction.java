...
public enum PrismAction {
    ...
    APPLICATION_ASSESS_ELIGIBILITY(USER_INVOCATION, PROCESS_RESOURCE, false, false, false, true, true, false, APPLICATION, null, Arrays.asList(
    ...
    APPLICATION_COMPLETE(USER_INVOCATION, VIEW_EDIT_RESOURCE, false, true, false, true, false, true, APPLICATION, null, null, null), //
    ...
    APPLICATION_EXPORT(SYSTEM_INVOCATION, EXPORT_RESOURCE, false, false, false, true, false, false, APPLICATION, null, null, null), //
    ...
    APPLICATION_PROVIDE_REVIEW(USER_INVOCATION, PROCESS_RESOURCE, true, false, false, true, false, true, APPLICATION, null, Arrays.asList(
            ...
            .addResolution(SUITABLE_FOR_INSTITUTION, NOT_NULL).addResolution(SUITABLE_FOR_OPPORTUNITY, NOT_NULL).addResolution(DESIRE_TO_RECRUIT, NOT_NULL)
            .build()), //
    APPLICATION_PURGE(SYSTEM_INVOCATION, PURGE_RESOURCE, false, false, false, true, false, false, APPLICATION, null, null, null), //
    APPLICATION_TERMINATE(SYSTEM_INVOCATION, PROPAGATE_RESOURCE, false, true, false, true, false, false, APPLICATION, null, null, null), //
    ...
    APPLICATION_WITHDRAW(USER_INVOCATION, WITHDRAW_RESOURCE, false, true, false, true, false, false, APPLICATION, null, null, null), //
    INSTITUTION_COMPLETE_APPROVAL_STAGE(USER_INVOCATION, PROCESS_RESOURCE, false, true, false, true, false, false, INSTITUTION, null, null, null), //
    INSTITUTION_STARTUP(SYSTEM_INVOCATION, INITIALISE_RESOURCE, false, false, false, true, false, false, INSTITUTION, null, null, null), //
    INSTITUTION_VIEW_EDIT(USER_INVOCATION, VIEW_EDIT_RESOURCE, false, false, false, false, false, false, INSTITUTION, null, null, null), //
    INSTITUTION_CORRECT(USER_INVOCATION, PROCESS_RESOURCE, false, true, false, true, false, false, INSTITUTION, null, null, null), //
    INSTITUTION_CREATE_PROGRAM(USER_INVOCATION, CREATE_RESOURCE, false, true, false, true, false, false, INSTITUTION, PROGRAM, null, null), //
    INSTITUTION_EMAIL_CREATOR(USER_INVOCATION, EMAIL_RESOURCE_CREATOR, false, false, false, false, false, false, INSTITUTION, null, null, null), //
    INSTITUTION_ESCALATE(SYSTEM_INVOCATION, ESCALATE_RESOURCE, false, false, false, false, false, false, INSTITUTION, null, null, null), //
    INSTITUTION_IMPORT_PROGRAM(SYSTEM_INVOCATION, CREATE_RESOURCE, false, true, false, true, false, false, INSTITUTION, PROGRAM, null, null), //
    INSTITUTION_WITHDRAW(USER_INVOCATION, WITHDRAW_RESOURCE, false, true, false, true, false, false, INSTITUTION, null, null, null), //
    PROGRAM_COMPLETE_APPROVAL_STAGE(USER_INVOCATION, PROCESS_RESOURCE, false, true, false, true, false, false, PROGRAM, null, null, null), //
    PROGRAM_CONCLUDE(SYSTEM_INVOCATION, PROPAGATE_RESOURCE, false, true, false, true, false, false, PROGRAM, null, null, null), //
    PROGRAM_VIEW_EDIT(USER_INVOCATION, VIEW_EDIT_RESOURCE, false, false, false, false, false, false, PROGRAM, null, null, null), //
    PROGRAM_CORRECT(USER_INVOCATION, PROCESS_RESOURCE, false, true, false, true, false, false, PROGRAM, null, null, null), //
    PROGRAM_CREATE_APPLICATION(USER_INVOCATION, CREATE_RESOURCE, false, true, false, true, false, false, PROGRAM, APPLICATION, null, null), //
    PROGRAM_CREATE_PROJECT(USER_INVOCATION, CREATE_RESOURCE, false, true, false, true, false, false, PROGRAM, PROJECT, null, null), //
    PROGRAM_EMAIL_CREATOR(USER_INVOCATION, EMAIL_RESOURCE_CREATOR, false, false, false, false, false, false, PROGRAM, null, null, null), //
    PROGRAM_ESCALATE(SYSTEM_INVOCATION, ESCALATE_RESOURCE, false, false, false, false, false, false, PROGRAM, null, null, null), //
    PROGRAM_RESTORE(SYSTEM_INVOCATION, PROPAGATE_RESOURCE, false, true, false, true, false, false, PROGRAM, null, null, null), //
    PROGRAM_WITHDRAW(USER_INVOCATION, WITHDRAW_RESOURCE, false, true, false, true, false, false, PROGRAM, null, null, null), //
    PROJECT_COMPLETE_APPROVAL_STAGE(USER_INVOCATION, PROCESS_RESOURCE, false, true, false, true, false, false, PROJECT, null, null, null), //
    PROJECT_CONCLUDE(SYSTEM_INVOCATION, PROPAGATE_RESOURCE, false, true, false, true, false, false, PROJECT, null, null, null), //
    PROJECT_VIEW_EDIT(USER_INVOCATION, VIEW_EDIT_RESOURCE, false, false, false, false, false, false, PROJECT, null, null, null), //
    PROJECT_CORRECT(USER_INVOCATION, PROCESS_RESOURCE, false, true, false, true, false, false, PROJECT, null, null, null), //
    PROJECT_CREATE_APPLICATION(USER_INVOCATION, CREATE_RESOURCE, false, true, false, true, false, false, PROJECT, APPLICATION, null, null), //
    PROJECT_EMAIL_CREATOR(USER_INVOCATION, EMAIL_RESOURCE_CREATOR, false, false, false, false, false, false, PROJECT, null, null, null), //
    PROJECT_ESCALATE(SYSTEM_INVOCATION, ESCALATE_RESOURCE, false, false, false, false, false, false, PROJECT, null, null, null), //
    PROJECT_RESTORE(SYSTEM_INVOCATION, PROPAGATE_RESOURCE, false, true, false, true, false, false, PROJECT, null, null, null), //
    PROJECT_SUSPEND(SYSTEM_INVOCATION, PROPAGATE_RESOURCE, false, true, false, true, false, false, PROJECT, null, null, null), //
    PROJECT_TERMINATE(SYSTEM_INVOCATION, PROPAGATE_RESOURCE, false, true, false, true, false, false, PROJECT, null, null, null), //
    PROJECT_WITHDRAW(USER_INVOCATION, WITHDRAW_RESOURCE, false, true, false, true, false, false, PROJECT, null, null, null), //
    SYSTEM_VIEW_EDIT(USER_INVOCATION, VIEW_EDIT_RESOURCE, false, false, false, false, false, false, SYSTEM, null, null, null), //
    SYSTEM_CREATE_INSTITUTION(USER_INVOCATION, CREATE_RESOURCE, false, true, false, true, false, false, SYSTEM, INSTITUTION, null, null), //
    SYSTEM_STARTUP(SYSTEM_INVOCATION, INITIALISE_RESOURCE, false, false, false, true, false, false, SYSTEM, SYSTEM, null, null), //
    SYSTEM_MANAGE_ACCOUNT(USER_INVOCATION, MANAGE_ACCOUNT, false, false, false, false, false, false, SYSTEM, null, null, null), //
    SYSTEM_VIEW_APPLICATION_LIST(USER_INVOCATION, VIEW_RESOURCE_LIST, false, false, false, false, false, false, SYSTEM, null, null, null), //
    SYSTEM_VIEW_INSTITUTION_LIST(USER_INVOCATION, VIEW_RESOURCE_LIST, false, false, false, false, false, false, SYSTEM, null, null, null), //
    SYSTEM_VIEW_PROGRAM_LIST(USER_INVOCATION, VIEW_RESOURCE_LIST, false, false, false, false, false, false, SYSTEM, null, null, null), //
    SYSTEM_VIEW_PROJECT_LIST(USER_INVOCATION, VIEW_RESOURCE_LIST, false, false, false, false, false, false, SYSTEM, null, null, null);
    ...
    private static final HashMultimap<PrismAction, PrismState> triggerStates = HashMultimap.create();
    ...
    static {
        ...
        for (PrismState state : new PrismState[] { APPLICATION_REVIEW, APPLICATION_INTERVIEW, APPLICATION_APPROVAL, APPLICATION_APPROVED }) {
            triggerStates.put(APPLICATION_ASSESS_ELIGIBILITY, state);
            triggerStates.put(APPLICATION_PROVIDE_REFERENCE, state);
        }
    }
    ...
    public static Set<PrismState> getTriggerStates(PrismAction action) {
        return triggerStates.get(action);
    }
