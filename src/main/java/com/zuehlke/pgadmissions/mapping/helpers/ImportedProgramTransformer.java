...
@Component
public class ImportedProgramTransformer implements ImportedEntityTransformer<uk.co.alumeni.prism.api.model.imported.ImportedProgram, ImportedProgram> {

    @Inject
    private ImportedEntityService importedEntityService;
    
    @Override
    public void transform(uk.co.alumeni.prism.api.model.imported.ImportedProgram concreteSource, ImportedProgram concreteTarget) {
