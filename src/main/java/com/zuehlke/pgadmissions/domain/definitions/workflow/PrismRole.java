...
import static com.zuehlke.pgadmissions.domain.definitions.PrismDisplayPropertyDefinition.SYSTEM_ROLE_SHORTLISTER;
...
public enum PrismRole {
	...
	APPLICATION_SHORTLISTER(false, APPLICATION, SYSTEM_ROLE_SHORTLISTER), //
