...
UPDATE PROGRAM
SET program_type = "POSTGRADUATE_RESEARCH"
WHERE program_type IN ("RESEARCH_DEGREE", "ENGINEERING_DOCTORATE")
;

UPDATE PROGRAM
SET program_type = "POSTGRADUATE_STUDY"
WHERE program_type IN ("MRES", "MDRES")
;

UPDATE PROGRAM
SET program_type = "INTERNSHIP"
WHERE program_type = "VISITING_RESEARCH"
;

UPDATE PROGRAM
SET program_type = "UNCLASSIFIED"
WHERE program_type = "MSC"
;
