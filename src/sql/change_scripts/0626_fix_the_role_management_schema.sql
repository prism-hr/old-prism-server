...
UPDATE APPLICATION_ROLE
SET old_id = id,
	id = "STATE_INTERVIEWER",
	application_role_scope_id = "STATE"
...
UPDATE APPLICATION_ROLE
SET old_id = id,
	id = "STATE_PRIMARY_SUPERVISOR",
	application_role_scope_id = "STATE"
WHERE id = "SUPERVISOR"
;

UPDATE APPLICATION_FORM_ACTION_OPTIONAL INNER JOIN APPLICATION_ROLE
	ON APPLICATION_FORM_ACTION_OPTIONAL.application_role_id = APPLICATION_ROLE.id
	SET APPLICATION_FORM_ACTION_OPTIONAL.application_role_id = APPLICATION_ROLE.old_id
;
...
VALUES ("PROJECT_PRIMARY_SUPERVISOR", 1, 0, "PROJECT"),
	...
	("STATE_SECONDARY_SUPERVISOR", 1, 0, "STATE"),
;
...
INSERT INTO APPLICATION_FORM_USER_ROLE (application_form_id, registered_user_id, 
	application_role_id, raises_update_flag)
	SELECT APPLICATION_FORM.id, SUPERVISOR.registered_user_id, "STATE_SECONDARY_SUPERVISOR",
		MAX(APPLICATION_FORM_USER_ROLE.raises_update_flag)
...
INSERT IGNORE INTO APPLICATION_FORM_USER_ROLE (application_form_id, registered_user_id, 
	application_role_id, raises_update_flag)
	SELECT APPLICATION_FORM.id, SUPERVISION_CONFIRMATION_COMMENT.supervisor_id, 
		"STATE_PRIMARY_SUPERVISOR", MAX(APPLICATION_FORM_USER_ROLE.raises_update_flag)
...
INSERT IGNORE INTO APPLICATION_FORM_USER_ROLE (application_form_id, registered_user_id, 
	application_role_id, raises_update_flag)
	SELECT APPLICATION_FORM.id, SUPERVISION_CONFIRMATION_COMMENT.secondary_supervisor_id, 
		"STATE_SECONDARY_SUPERVISOR", MAX(APPLICATION_FORM_USER_ROLE.raises_update_flag)
	FROM APPLICATION_FORM INNER JOIN COMMENT
		ON APPLICATION_FORM.id = COMMENT.application_form_id
	INNER JOIN SUPERVISION_CONFIRMATION_COMMENT
		ON COMMENT.id = SUPERVISION_CONFIRMATION_COMMENT.id
...
INSERT IGNORE INTO APPLICATION_FORM_USER_ROLE (application_form_id, registered_user_id, 
	application_role_id, raises_update_flag)
	SELECT APPLICATION_FORM.id, OFFER_RECOMMENDED_COMMENT.supervisor_id, 
		"STATE_PRIMARY_SUPERVISOR", MAX(APPLICATION_FORM_USER_ROLE.raises_update_flag)
	FROM APPLICATION_FORM INNER JOIN COMMENT
		ON APPLICATION_FORM.id = COMMENT.application_form_id
...
INSERT IGNORE INTO APPLICATION_FORM_USER_ROLE (application_form_id, registered_user_id, 
	application_role_id, raises_update_flag)
	SELECT APPLICATION_FORM.id, OFFER_RECOMMENDED_COMMENT.secondary_supervisor_id, 
		"STATE_SECONDARY_SUPERVISOR", MAX(APPLICATION_FORM_USER_ROLE.raises_update_flag)
	FROM APPLICATION_FORM INNER JOIN COMMENT
		ON APPLICATION_FORM.id = COMMENT.application_form_id
	INNER JOIN OFFER_RECOMMENDED_COMMENT
...
INSERT INTO APPLICATION_FORM_ACTION_OPTIONAL
	...
	WHERE APPLICATION_ROLE.id IN ("PROJECT_PRIMARY_SUPERVISOR", 
		"PROJECT_PRIMARY_SUPERVISOR", "STATE_SECONDARY_SUPERVISOR")
...
CREATE TABLE INSTITUTION_USER_ROLE (
	...
	FOREIGN KEY (registered_user_id) REFERENCES REGISTERED_USER (id),
	FOREIGN KEY (application_role_id) REFERENCES APPLICATION_ROLE (id)) ENGINE = INNODB
	SELECT 5243, registered_user_id, application_role_id
	FROM USER_ROLE_LINK
