...
public class PrismApplicationReserved extends PrismWorkflowState {
    ...
    protected void setStateActions() {
        ...
        stateActions.add(new PrismStateAction() //
	        .withAction(PrismAction.APPLICATION_RESERVE) //
	        ...
	        .withNotification(PrismNotificationDefinition.SYSTEM_APPLICATION_TASK_REQUEST) //
	            ...
	            .withNotifications(Arrays.asList( //
	            	new PrismStateActionNotification() //
	            		.withRole(PrismRole.APPLICATION_CREATOR) //
	            		.withDefinition(PrismNotificationDefinition.APPLICATION_RESERVE_NOTIFICATION), 
	                new PrismStateActionNotification() //
	                    .withRole(PrismRole.INSTITUTION_ADMINISTRATOR) //
	                    .withDefinition(PrismNotificationDefinition.SYSTEM_APPLICATION_UPDATE_NOTIFICATION), //
	                new PrismStateActionNotification() //
	            ...
	            .withTransitions(Arrays.asList( //
	                new PrismStateTransition() //
	                    .withTransitionState(PrismState.APPLICATION_RESERVED_WAITING) //
