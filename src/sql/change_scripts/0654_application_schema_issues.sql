...
INSERT INTO STATE_TRANSITION (state_action_id, state_transition_type_id, transition_state_id, state_transition_evaluation_id, transition_action_id)
	SELECT STATE_ACTION.id, "ONE_COMPLETED", "APPLICATION_WITHDRAWN_COMPLETED", NULL, "SYSTEM_VIEW_APPLICATION_LIST"
	...
	WHERE STATE.parent_state_id = "APPLICATION_UNSUBMITTED"
		...
		UNION
	SELECT STATE_ACTION.id, "ONE_COMPLETED", TRANSITION_STATE.id, "APPLICATION_PROCESSING_COMPLETED_OUTCOME", "SYSTEM_VIEW_APPLICATION_LIST"
	FROM STATE_ACTION INNER JOIN STATE
		ON STATE_ACTION.state_id = STATE.id
	...
	WHERE STATE.parent_state_id IN ("APPLICATION_VALIDATION", "APPLICATION_REVIEW", "APPLICATION_INTERVIEW", "APPLICATION_APPROVAL")
		...
		UNION
	SELECT STATE_ACTION.id, "ONE_COMPLETED", STATE.id, "APPLICATION_PROCESSING_COMPLETED_OUTCOME", "SYSTEM_VIEW_APPLICATION_LIST"
	FROM STATE_ACTION INNER JOIN STATE
...
INSERT INTO STATE_TRANSITION (state_action_id, state_transition_type_id, transition_state_id, state_transition_evaluation_id)
	...
	WHERE STATE.parent_state_id = "APPLICATION_UNSUBMITTED"
		...
		UNION
	SELECT STATE_ACTION.id, "PROPAGATION", TRANSITION_STATE.id, "APPLICATION_PROCESSING_COMPLETED_OUTCOME"
	FROM STATE_ACTION INNER JOIN STATE
		ON STATE_ACTION.state_id = STATE.id
	INNER JOIN STATE AS TRANSITION_STATE
	WHERE STATE.parent_state_id IN ("APPLICATION_VALIDATION", "APPLICATION_REVIEW", "APPLICATION_INTERVIEW", "APPLICATION_APPROVAL")
		...
		UNION
	SELECT STATE_ACTION.id, "PROPAGATION", STATE.id, "APPLICATION_PROCESSING_COMPLETED_OUTCOME"
	FROM STATE_ACTION INNER JOIN STATE
	WHERE STATE_ACTION.state_id IN ("APPLICATION_APPROVED", "APPLICATION_REJECTED")
		AND STATE_ACTION.action_id = "APPLICATION_ESCALATE"
...
INSERT INTO STATE_TRANSITION (state_action_id, state_transition_type_id, transition_state_id, transition_action_id)
	SELECT id, "ONE_COMPLETED", state_id, "SYSTEM_VIEW_APPLICATION_LIST"
	FROM STATE_ACTION
...
INSERT INTO STATE_TRANSITION (state_action_id, state_transition_type_id, transition_state_id, state_transition_evaluation_id, transition_action_id)
	SELECT id, "ONE_COMPLETED", state_id, "APPLICATION_COMPLETED_OUTCOME", "SYSTEM_VIEW_APPLICATION_LIST"
	FROM STATE_ACTION
	WHERE action_id = "APPLICATION_COMPLETE"
		UNION
	SELECT id, "ONE_COMPLETED", "APPLICATION_VALIDATION", "APPLICATION_COMPLETED_OUTCOME", "SYSTEM_VIEW_APPLICATION_LIST"
	FROM STATE_ACTION
	WHERE action_id = "APPLICATION_COMPLETE"
;
...
INSERT INTO STATE_TRANSITION (state_action_id, state_transition_type_id, transition_state_id, state_transition_evaluation_id, transition_action_id)
	SELECT STATE_ACTION.id, "ONE_COMPLETED", STATE.id, "APPLICATION_ELIGIBILITY_ASSESSED_OUTCOME", "SYSTEM_VIEW_APPLICATION_LIST"
	FROM STATE_ACTION INNER JOIN STATE
...
INSERT INTO STATE_TRANSITION (state_action_id, state_transition_type_id, transition_state_id, transition_action_id)
	SELECT id, "ONE_COMPLETED", "APPLICATION_VALIDATION_PENDING_COMPLETION", "SYSTEM_VIEW_APPLICATION_LIST"
	FROM STATE_ACTION
...
INSERT INTO STATE_TRANSITION (state_action_id, state_transition_type_id, transition_state_id, state_transition_evaluation_id, display_order, transition_action_id)
	SELECT id, "ONE_COMPLETED", "APPLICATION_REVIEW", "APPLICATION_STAGE_COMPLETED_OUTCOME", 0, "APPLICATION_ASSIGN_REVIEWERS"
	FROM STATE_ACTION
	WHERE action_id IN ("APPLICATION_COMPLETE_VALIDATION_STAGE", "APPLICATION_COMPLETE_REVIEW_STAGE", 
		...
		UNION
	SELECT id, "ONE_COMPLETED", "APPLICATION_INTERVIEW", "APPLICATION_STAGE_COMPLETED_OUTCOME", 1, "APPLICATION_ASSIGN_INTERVIEWERS"
	FROM STATE_ACTION
	WHERE action_id IN ("APPLICATION_COMPLETE_VALIDATION_STAGE", "APPLICATION_COMPLETE_REVIEW_STAGE", 
		"APPLICATION_COMPLETE_INTERVIEW_STAGE", "APPLICATION_COMPLETE_APPROVAL_STAGE")
		UNION
	SELECT id, "ONE_COMPLETED", "APPLICATION_APPROVAL", "APPLICATION_STAGE_COMPLETED_OUTCOME", 2, "APPLICATION_ASSIGN_SUPERVISORS"
	FROM STATE_ACTION
	WHERE action_id IN ("APPLICATION_COMPLETE_VALIDATION_STAGE", "APPLICATION_COMPLETE_REVIEW_STAGE", 
		"APPLICATION_COMPLETE_INTERVIEW_STAGE", "APPLICATION_COMPLETE_APPROVAL_STAGE")
		UNION
	SELECT id, "ONE_COMPLETED", "APPLICATION_APPROVED", "APPLICATION_STAGE_COMPLETED_OUTCOME", 3, "APPLICATION_CONFIRM_OFFER_RECOMMENDATION"
	FROM STATE_ACTION
	WHERE action_id IN ("APPLICATION_COMPLETE_VALIDATION_STAGE", "APPLICATION_COMPLETE_REVIEW_STAGE", 
		"APPLICATION_COMPLETE_INTERVIEW_STAGE", "APPLICATION_COMPLETE_APPROVAL_STAGE")
		UNION
	SELECT id, "ONE_COMPLETED", "APPLICATION_REJECTED", "APPLICATION_STAGE_COMPLETED_OUTCOME", 4, "APPLICATION_CONFIRM_REJECTION"
	FROM STATE_ACTION
	WHERE action_id IN ("APPLICATION_COMPLETE_VALIDATION_STAGE", "APPLICATION_COMPLETE_REVIEW_STAGE", 
		"APPLICATION_COMPLETE_INTERVIEW_STAGE", "APPLICATION_COMPLETE_APPROVAL_STAGE")
;
...
INSERT INTO ROLE_TRANSITION_EXCLUSION (role_transition_id, role_id)
	...
	INNER JOIN STATE_ACTION
		ON STATE_TRANSITION.state_action_id = STATE_ACTION.id
	WHERE STATE_ACTION.action_id IN ("APPLICATION_COMPLETE_VALIDATION_STAGE", "APPLICATION_COMPLETE_REVIEW_STAGE", "APPLICATION_COMPLETE_INTERVIEW_STAGE", "APPLICATION_COMPLETE_APPROVAL_STAGE")
		AND STATE_TRANSITION.transition_state_id IN ("APPLICATION_REVIEW", "APPLICATION_INTERVIEW", "APPLICATION_APPROVAL")
...
INSERT INTO STATE_TRANSITION (state_action_id, state_transition_type_id, transition_state_id, state_transition_evaluation_id, display_order, transition_action_id)
	SELECT id, "ONE_COMPLETED", "APPLICATION_INTERVIEW", "APPLICATION_STAGE_COMPLETED_OUTCOME", 0, "APPLICATION_ASSIGN_INTERVIEWERS"
	FROM STATE_ACTION
	WHERE action_id = "APPLICATION_MOVE_TO_DIFFERENT_STAGE"
		AND state_id = "APPLICATION_REVIEW"
		UNION
	SELECT id, "ONE_COMPLETED", "APPLICATION_APPROVAL", "APPLICATION_STAGE_COMPLETED_OUTCOME", 1, "APPLICATION_ASSIGN_SUPERVISORS"
	FROM STATE_ACTION
	WHERE action_id = "APPLICATION_MOVE_TO_DIFFERENT_STAGE"
		AND state_id = "APPLICATION_REVIEW"
		UNION		
	SELECT id, "ONE_COMPLETED", "APPLICATION_APPROVED", "APPLICATION_STAGE_COMPLETED_OUTCOME", 2, "APPLICATION_CONFIRM_OFFER_RECOMMENDATION"
	FROM STATE_ACTION
	WHERE action_id = "APPLICATION_MOVE_TO_DIFFERENT_STAGE"
		AND state_id = "APPLICATION_REVIEW"
		UNION
	SELECT id, "ONE_COMPLETED", "APPLICATION_REJECTED", "APPLICATION_STAGE_COMPLETED_OUTCOME", 3, "APPLICATION_CONFIRM_REJECTION"
	FROM STATE_ACTION
	WHERE action_id = "APPLICATION_MOVE_TO_DIFFERENT_STAGE"
		AND state_id = "APPLICATION_REVIEW"
		UNION
...
INSERT INTO STATE_TRANSITION (state_action_id, state_transition_type_id, transition_state_id, transition_action_id)
	SELECT id, "ONE_COMPLETED", "APPLICATION_REVIEW_PENDING_FEEDBACK", "SYSTEM_VIEW_APPLICATION_LIST"
	FROM STATE_ACTION
...
INSERT INTO STATE_TRANSITION (state_action_id, state_transition_type_id, transition_state_id, processing_order, transition_action_id)
	SELECT id, "ONE_COMPLETED", state_id, 0, "SYSTEM_VIEW_APPLICATION_LIST"
	FROM STATE_ACTION
	WHERE action_id = "APPLICATION_PROVIDE_REVIEW"
		AND state_id = "APPLICATION_REVIEW_PENDING_FEEDBACK"
		UNION
	SELECT id, "ALL_COMPLETED", "APPLICATION_REVIEW_PENDING_COMPLETION", 1, NULL
	FROM STATE_ACTION
	WHERE action_id = "APPLICATION_PROVIDE_REVIEW"
		AND state_id = "APPLICATION_REVIEW_PENDING_FEEDBACK"
		UNION
	SELECT id, "ONE_COMPLETED", state_id, NULL, "SYSTEM_VIEW_APPLICATION_LIST"
	FROM STATE_ACTION
	WHERE action_id = "APPLICATION_PROVIDE_REVIEW"
...
INSERT INTO STATE_TRANSITION (state_action_id, state_transition_type_id, transition_state_id, state_transition_evaluation_id, transition_action_id)
	SELECT STATE_ACTION.id, "ONE_COMPLETED", STATE.id, "APPLICATION_INTERVIEW_SCHEDULED_OUTCOME", "APPLICATION_PROVIDE_INTERVIEW_AVAILABILITY"
	FROM STATE_ACTION INNER JOIN STATE
	WHERE STATE_ACTION.action_id = "APPLICATION_ASSIGN_INTERVIEWERS"
		AND STATE.id = "APPLICATION_INTERVIEW_PENDING_AVAILABILITY"
		UNION
	SELECT STATE_ACTION.id, "ONE_COMPLETED", STATE.id, "APPLICATION_INTERVIEW_SCHEDULED_OUTCOME", "SYSTEM_VIEW_APPLICATION_LIST"
	FROM STATE_ACTION INNER JOIN STATE
	WHERE STATE_ACTION.action_id = "APPLICATION_ASSIGN_INTERVIEWERS"
...
INSERT INTO STATE_TRANSITION (state_action_id, state_transition_type_id, transition_state_id, processing_order, transition_action_id)
	...
	WHERE action_id = "APPLICATION_PROVIDE_INTERVIEW_AVAILABILITY"
		...
		UNION
	SELECT id, "ALL_COMPLETED", "APPLICATION_INTERVIEW_PENDING_SCHEDULING", 1, NULL
	FROM STATE_ACTION
	WHERE action_id = "APPLICATION_PROVIDE_INTERVIEW_AVAILABILITY"
		AND state_id = "APPLICATION_INTERVIEW_PENDING_AVAILABILITY"
		UNION
...
INSERT INTO STATE_TRANSITION (state_action_id, state_transition_type_id, transition_state_id, transition_action_id)
	SELECT id, "ONE_COMPLETED", "APPLICATION_INTERVIEW_PENDING_SCHEDULING", "SYSTEM_VIEW_APPLICATION_LIST"
	FROM STATE_ACTION
...
INSERT INTO STATE_TRANSITION (state_action_id, state_transition_type_id, transition_state_id, processing_order, transition_action_id)
	...
	WHERE action_id = "APPLICATION_PROVIDE_INTERVIEW_FEEDBACK"
		...
		UNION
	SELECT id, "ALL_COMPLETED", "APPLICATION_INTERVIEW_PENDING_COMPLETION", 1, NULL
	FROM STATE_ACTION
	WHERE action_id = "APPLICATION_PROVIDE_INTERVIEW_FEEDBACK"
		AND state_id = "APPLICATION_INTERVIEW_PENDING_FEEDBACK"
		UNION
...
INSERT INTO STATE_TRANSITION (state_action_id, state_transition_type_id, transition_state_id, transition_action_id)
	SELECT id, "ONE_COMPLETED", "APPLICATION_APPROVAL_PENDING_FEEDBACK", "SYSTEM_VIEW_APPLICATION_LIST"
	FROM STATE_ACTION
...
INSERT INTO STATE_TRANSITION (state_action_id, state_transition_type_id, transition_state_id, processing_order, transition_action_id)
	...
	WHERE action_id = "APPLICATION_CONFIRM_SUPERVISION"
		...
		UNION
	SELECT id, "ALL_COMPLETED", "APPLICATION_APPROVAL_PENDING_COMPLETION", 1, NULL
	FROM STATE_ACTION
	WHERE action_id = "APPLICATION_CONFIRM_SUPERVISION"
		AND state_id = "APPLICATION_APPROVAL_PENDING_FEEDBACK"
		UNION
...
INSERT INTO STATE_TRANSITION (state_action_id, state_transition_type_id, transition_state_id, state_transition_evaluation_id, transition_action_id)
	SELECT id, "ONE_COMPLETED", "APPLICATION_APPROVED_PENDING_EXPORT", "APPLICATION_PROCESSING_COMPLETED_OUTCOME", "SYSTEM_VIEW_APPLICATION_LIST"
	FROM STATE_ACTION
	WHERE action_id = "APPLICATION_CONFIRM_OFFER_RECOMMENDATION"
		UNION
	SELECT id, "ONE_COMPLETED", "APPLICATION_APPROVED_COMPLETED", "APPLICATION_PROCESSING_COMPLETED_OUTCOME", "SYSTEM_VIEW_APPLICATION_LIST"
	FROM STATE_ACTION
	WHERE action_id = "APPLICATION_CONFIRM_OFFER_RECOMMENDATION"
;
...
INSERT INTO STATE_TRANSITION (state_action_id, state_transition_type_id, transition_state_id, state_transition_evaluation_id, transition_action_id)
	SELECT id, "ONE_COMPLETED", "APPLICATION_REJECTED_PENDING_EXPORT", "APPLICATION_PROCESSING_COMPLETED_OUTCOME", "SYSTEM_VIEW_APPLICATION_LIST"
	FROM STATE_ACTION
	WHERE action_id = "APPLICATION_CONFIRM_REJECTION"
		UNION
	SELECT id, "ONE_COMPLETED", "APPLICATION_REJECTED_COMPLETED", "APPLICATION_PROCESSING_COMPLETED_OUTCOME", "SYSTEM_VIEW_APPLICATION_LIST"
	FROM STATE_ACTION
	WHERE action_id = "APPLICATION_CONFIRM_REJECTION"
;
...
INSERT INTO STATE_TRANSITION (state_action_id, state_transition_type_id, transition_state_id, state_transition_evaluation_id)
	SELECT id, "DUE_DATE_EXPIRY", "APPLICATION_APPROVED_COMPLETED", "APPLICATION_EXPORTED_OUTCOME"
	FROM STATE_ACTION
	WHERE state_id = "APPLICATION_APPROVED_PENDING_EXPORT"
		AND action_id = "APPLICATION_EXPORT"
		UNION
	SELECT id, "DUE_DATE_EXPIRY", "APPLICATION_APPROVED_PENDING_CORRECTION", "APPLICATION_EXPORTED_OUTCOME"
	FROM STATE_ACTION
	WHERE state_id = "APPLICATION_APPROVED_PENDING_EXPORT"
		AND action_id = "APPLICATION_EXPORT"
;
...
INSERT INTO STATE_TRANSITION (state_action_id, state_transition_type_id, transition_state_id, transition_action_id)
	SELECT id, "ONE_COMPLETED", "APPLICATION_APPROVED_PENDING_EXPORT", "SYSTEM_VIEW_APPLICATION_LIST"
	FROM STATE_ACTION
...
INSERT INTO STATE_TRANSITION (state_action_id, state_transition_type_id, transition_state_id, state_transition_evaluation_id)
	SELECT id, "DUE_DATE_EXPIRY", "APPLICATION_REJECTED_COMPLETED", "APPLICATION_EXPORTED_OUTCOME"
	FROM STATE_ACTION
	WHERE state_id = "APPLICATION_REJECTED_PENDING_EXPORT"
		AND action_id = "APPLICATION_EXPORT"
		UNION
	SELECT id, "DUE_DATE_EXPIRY", "APPLICATION_REJECTED_PENDING_CORRECTION", "APPLICATION_EXPORTED_OUTCOME"
	FROM STATE_ACTION
	WHERE state_id = "APPLICATION_REJECTED_PENDING_EXPORT"
		AND action_id = "APPLICATION_EXPORT"
;
...
INSERT INTO STATE_TRANSITION (state_action_id, state_transition_type_id, transition_state_id, transition_action_id)
	SELECT id, "ONE_COMPLETED", "APPLICATION_REJECTED_PENDING_EXPORT", "SYSTEM_VIEW_APPLICATION_LIST"
	FROM STATE_ACTION
...
INSERT INTO STATE_TRANSITION (state_action_id, state_transition_type_id, transition_state_id, state_transition_evaluation_id)
	SELECT id, "DUE_DATE_EXPIRY", "APPLICATION_WITHDRAWN_COMPLETED", "APPLICATION_EXPORTED_OUTCOME"
	FROM STATE_ACTION
	WHERE state_id = "APPLICATION_WITHDRAWN"
		AND action_id = "APPLICATION_EXPORT"
		UNION
	SELECT id, "DUE_DATE_EXPIRY", "APPLICATION_WITHDRAWN_PENDING_CORRECTION", "APPLICATION_EXPORTED_OUTCOME"
	FROM STATE_ACTION
	WHERE state_id = "APPLICATION_WITHDRAWN"
		AND action_id = "APPLICATION_EXPORT"
;
...
INSERT INTO STATE_TRANSITION (state_action_id, state_transition_type_id, transition_state_id, transition_action_id)
	SELECT id, "ONE_COMPLETED", "APPLICATION_WITHDRAWN", "SYSTEM_VIEW_APPLICATION_LIST"
	FROM STATE_ACTION
...
INSERT INTO STATE_TRANSITION (state_action_id, state_transition_type_id, transition_state_id, state_transition_evaluation_id, transition_action_id)
	SELECT id, "ONE_COMPLETED", "PROGRAM_APPROVAL", "PROGRAM_CREATED_OUTCOME", "SYSTEM_VIEW_PROGRAM_LIST"
	FROM STATE_ACTION
	WHERE action_id = "INSTITUTION_CREATE_PROGRAM"
		UNION
	SELECT id, "ONE_COMPLETED", "PROGRAM_APPROVED", "PROGRAM_CREATED_OUTCOME", "SYSTEM_VIEW_PROGRAM_LIST"
	FROM STATE_ACTION
	WHERE action_id = "INSTITUTION_CREATE_PROGRAM"	
;

INSERT INTO ROLE_TRANSITION (state_transition_id, role_id, role_transition_type_id, transition_role_id, restrict_to_invoker)
	SELECT STATE_TRANSITION.id, "INSTITUTION_PROGRAM_CREATOR", "BRANCH", "PROGRAM_ADMINISTRATOR", 1
	FROM STATE_TRANSITION INNER JOIN STATE_ACTION
		ON STATE_TRANSITION.state_action_id = STATE_ACTION.id
	WHERE STATE_ACTION.action_id = "INSTITUTION_CREATE_PROGRAM"
		AND STATE_TRANSITION.transition_state_id = "PROGRAM_APPROVED"
		UNION
	SELECT STATE_TRANSITION.id, "SYSTEM_PROGRAM_CREATOR", "BRANCH", "PROGRAM_ADMINISTRATOR", 1
	FROM STATE_TRANSITION INNER JOIN STATE_ACTION
		ON STATE_TRANSITION.state_action_id = STATE_ACTION.id
	WHERE STATE_ACTION.action_id = "INSTITUTION_CREATE_PROGRAM"
		AND STATE_TRANSITION.transition_state_id = "PROGRAM_APPROVAL"
;

/* Approve program */

INSERT INTO STATE_TRANSITION (state_action_id, state_transition_type_id, transition_state_id, state_transition_evaluation_id, transition_action_id)
	SELECT id, "ONE_COMPLETED", "PROGRAM_APPROVAL", "PROGRAM_APPROVED_OUTCOME", "SYSTEM_VIEW_PROGRAM_LIST"
	FROM STATE_ACTION
	WHERE state_id = "PROGRAM_APPROVAL"
		AND action_id = "PROGRAM_COMPLETE_APPROVAL_STAGE"
		UNION
	SELECT id, "ONE_COMPLETED", "PROGRAM_APPROVAL_PENDING_CORRECTION", "PROGRAM_APPROVED_OUTCOME", "SYSTEM_VIEW_PROGRAM_LIST"
	FROM STATE_ACTION
	WHERE state_id = "PROGRAM_APPROVAL"
		AND action_id = "PROGRAM_COMPLETE_APPROVAL_STAGE"
		UNION
	SELECT id, "ONE_COMPLETED", "PROGRAM_APPROVED", "PROGRAM_APPROVED_OUTCOME", "SYSTEM_VIEW_PROGRAM_LIST"
	FROM STATE_ACTION
	WHERE state_id = "PROGRAM_APPROVAL"
		AND action_id = "PROGRAM_COMPLETE_APPROVAL_STAGE"
		UNION
	SELECT id, "ONE_COMPLETED", "PROGRAM_REJECTED", "PROGRAM_APPROVED_OUTCOME", "SYSTEM_VIEW_PROGRAM_LIST"
	FROM STATE_ACTION
	WHERE state_id = "PROGRAM_APPROVAL"
		AND action_id = "PROGRAM_COMPLETE_APPROVAL_STAGE"
;
...
INSERT INTO STATE_TRANSITION (state_action_id, state_transition_type_id, transition_state_id, transition_action_id)
	SELECT id, "ONE_COMPLETED", "PROGRAM_APPROVAL", "SYSTEM_VIEW_PROGRAM_LIST"
	FROM STATE_ACTION
...
INSERT INTO STATE_TRANSITION (state_action_id, state_transition_type_id, transition_state_id, transition_action_id)
	SELECT id, "ONE_COMPLETED", "PROGRAM_WITHDRAWN", "SYSTEM_VIEW_PROGRAM_LIST"
	FROM STATE_ACTION
...
INSERT INTO STATE_TRANSITION (state_action_id, state_transition_type_id, transition_state_id, state_transition_evaluation_id)
	SELECT id, "ONE_COMPLETED", "PROGRAM_APPROVAL", "PROGRAM_CONFIGURED_OUTCOME"
	FROM STATE_ACTION
	WHERE state_id = "PROGRAM_APPROVED"
		AND action_id = "PROGRAM_CONFIGURE"
		UNION
	SELECT id, "ONE_COMPLETED", state_id, "PROGRAM_CONFIGURED_OUTCOME"
	FROM STATE_ACTION
	WHERE state_id = "PROGRAM_APPROVED"
		AND action_id = "PROGRAM_CONFIGURE"
		UNION
	SELECT id, "ONE_COMPLETED", "PROGRAM_DEACTIVATED", "PROGRAM_CONFIGURED_OUTCOME"
	FROM STATE_ACTION
	WHERE state_id = "PROGRAM_APPROVED"
		AND action_id = "PROGRAM_CONFIGURE"
		UNION
	SELECT id, "ONE_COMPLETED", "PROGRAM_DISABLED", "PROGRAM_CONFIGURED_OUTCOME"
	FROM STATE_ACTION
	WHERE state_id = "PROGRAM_APPROVED"
		AND action_id = "PROGRAM_CONFIGURE"
		UNION
	...
	WHERE state_id = "PROGRAM_DEACTIVATED"
		AND action_id = "PROGRAM_CONFIGURE"
		UNION
	SELECT id, "ONE_COMPLETED", "PROGRAM_APPROVED", "PROGRAM_CONFIGURED_OUTCOME"
	FROM STATE_ACTION
	WHERE state_id = "PROGRAM_DEACTIVATED"
		AND action_id = "PROGRAM_CONFIGURE"
		UNION
...
INSERT INTO STATE_TRANSITION (state_action_id, state_transition_type_id, transition_state_id, transition_action_id)
	SELECT id, "ONE_COMPLETED", "APPLICATION_UNSUBMITTED", "APPLICATION_COMPLETE"
	FROM STATE_ACTION
	WHERE action_id = "PROGRAM_CREATE_APPLICATION"
;

INSERT INTO ROLE_TRANSITION (state_transition_id, role_id, role_transition_type_id, transition_role_id, restrict_to_invoker)
	SELECT STATE_TRANSITION.id, "PROGRAM_APPLICATION_CREATOR", "UPDATE", "APPLICATION_CREATOR", 1
	FROM STATE_TRANSITION INNER JOIN STATE_ACTION
		ON STATE_TRANSITION.state_action_id = STATE_ACTION.id
	WHERE STATE_ACTION.action_id = "PROGRAM_CREATE_APPLICATION"
		UNION
	SELECT STATE_TRANSITION.id, "SYSTEM_APPLICATION_CREATOR", "BRANCH", "APPLICATION_CREATOR", 1
	FROM STATE_TRANSITION INNER JOIN STATE_ACTION
		ON STATE_TRANSITION.state_action_id = STATE_ACTION.id
	WHERE STATE_ACTION.action_id = "PROGRAM_CREATE_APPLICATION"
;
...
INSERT INTO ROLE_TRANSITION_EXCLUSION (role_transition_id, role_id)
	...
	WHERE STATE_ACTION.action_id = "PROGRAM_CREATE_APPLICATION"
		...
		AND ROLE.id NOT LIKE "%_CREATOR"
;

/* Program expired */

INSERT INTO STATE_TRANSITION (state_action_id, state_transition_type_id, transition_state_id, state_transition_evaluation_id)
	SELECT id, "DUE_DATE_EXPIRY", "PROGRAM_DISABLED_PENDING_REACTIVATION", "PROGRAM_EXPIRED_OUTCOME"
	FROM STATE_ACTION
	WHERE state_id IN ("PROGRAM_APPROVED", "PROGRAM_DEACTIVATED")
		AND action_id = "PROGRAM_ESCALATE"
		UNION
	SELECT id, "DUE_DATE_EXPIRY", "PROGRAM_DISABLED_PENDING_IMPORT_REACTIVATION", "PROGRAM_EXPIRED_OUTCOME"
	FROM STATE_ACTION
	WHERE state_id IN ("PROGRAM_APPROVED", "PROGRAM_DEACTIVATED")
		AND action_id = "PROGRAM_ESCALATE"
;
...
INSERT INTO ROLE_TRANSITION (state_transition_id, role_id, role_transition_type_id)
	SELECT STATE_TRANSITION.id, "PROGRAM_APPLICATION_CREATOR", "REMOVE"
	FROM STATE_TRANSITION INNER JOIN STATE_ACTION
		ON STATE_TRANSITION.state_action_id = STATE_ACTION.id
...
INSERT INTO STATE_TRANSITION (state_action_id, state_transition_type_id, transition_state_id, state_transition_evaluation_id)
	SELECT id, "PROPAGATION", "PROGRAM_APPROVED", "PROGRAM_REACTIVATED_OUTCOME"
	FROM STATE_ACTION
	WHERE action_id = "PROGRAM_REACTIVATE"
		UNION
	SELECT id, "PROPAGATION", "PROGRAM_DEACTIVATED", "PROGRAM_REACTIVATED_OUTCOME"
	FROM STATE_ACTION
	WHERE action_id = "PROGRAM_REACTIVATE"
;
...
INSERT INTO STATE_TRANSITION (state_action_id, state_transition_type_id, transition_state_id, transition_action_id)
	SELECT id, "ONE_COMPLETED", "PROJECT_APPROVED", "SYSTEM_VIEW_PROGRAM_LIST"
	FROM STATE_ACTION
...
INSERT INTO ROLE_TRANSITION (state_transition_id, role_id, role_transition_type_id, transition_role_id, minimum_permitted, maximum_permitted, restrict_to_invoker)
	SELECT STATE_TRANSITION.id, ROLE.id, "BRANCH", "PROJECT_ADMINISTRATOR", 1, 1, 1
	FROM STATE_TRANSITION INNER JOIN STATE_ACTION
		ON STATE_TRANSITION.state_action_id = STATE_ACTION.id
	INNER JOIN ROLE
	WHERE STATE_ACTION.action_id = "PROGRAM_CREATE_PROJECT"
		AND ROLE.id IN ("SYSTEM_ADMINISTRATOR", "INSTITUTION_ADMINISTRATOR", "PROGRAM_ADMINISTRATOR", 
			"PROGRAM_VIEWER", "PROGRAM_APPROVER", "PROGRAM_PROJECT_CREATOR")
		UNION
...
INSERT INTO STATE_TRANSITION (state_action_id, state_transition_type_id, transition_state_id, state_transition_evaluation_id)
	SELECT id, "ONE_COMPLETED", state_id, "PROJECT_CONFIGURED_OUTCOME"
	FROM STATE_ACTION
	WHERE state_id = "PROJECT_APPROVED"
		AND action_id = "PROJECT_CONFIGURE"
		UNION
	SELECT id, "ONE_COMPLETED", "PROJECT_DEACTIVATED", "PROJECT_CONFIGURED_OUTCOME"
	FROM STATE_ACTION
	WHERE state_id = "PROJECT_APPROVED"
		AND action_id = "PROJECT_CONFIGURE"
		UNION
	SELECT id, "ONE_COMPLETED", "PROJECT_DISABLED", "PROJECT_CONFIGURED_OUTCOME"
	FROM STATE_ACTION
	WHERE state_id = "PROJECT_APPROVED"
		AND action_id = "PROJECT_CONFIGURE"
		UNION
	SELECT id, "ONE_COMPLETED", "PROJECT_APPROVED", "PROJECT_CONFIGURED_OUTCOME"
	FROM STATE_ACTION
...
INSERT INTO ROLE_TRANSITION (state_transition_id, role_id, role_transition_type_id, transition_role_id, restrict_to_invoker)
	SELECT STATE_TRANSITION.id, "PROJECT_APPLICATION_CREATOR", "UPDATE", "APPLICATION_CREATOR", 1
	FROM STATE_TRANSITION INNER JOIN STATE_ACTION
		ON STATE_TRANSITION.state_action_id = STATE_ACTION.id
	...
	WHERE STATE_ACTION.action_id = "PROJECT_CREATE_APPLICATION"
		UNION
	SELECT STATE_TRANSITION.id, "PROJECT_PRIMARY_SUPERVISOR", "BRANCH", "APPLICATION_SUGGESTED_SUPERVISOR", NULL
	FROM STATE_TRANSITION INNER JOIN STATE_ACTION
		ON STATE_TRANSITION.state_action_id = STATE_ACTION.id
	WHERE STATE_ACTION.action_id = "PROJECT_CREATE_APPLICATION"
		UNION
	SELECT STATE_TRANSITION.id, "PROJECT_SECONDARY_SUPERVISOR", "BRANCH", "APPLICATION_SUGGESTED_SUPERVISOR", NULL
	FROM STATE_TRANSITION INNER JOIN STATE_ACTION
		ON STATE_TRANSITION.state_action_id = STATE_ACTION.id
	WHERE STATE_ACTION.action_id = "PROJECT_CREATE_APPLICATION"
;
...
INSERT INTO ROLE_TRANSITION (state_transition_id, role_id, role_transition_type_id)
	SELECT STATE_TRANSITION.id, "PROJECT_APPLICATION_CREATOR", "REMOVE"
	FROM STATE_TRANSITION INNER JOIN STATE_ACTION
		ON STATE_TRANSITION.state_action_id = STATE_ACTION.id
...
INSERT INTO STATE_TRANSITION (state_action_id, state_transition_type_id, transition_state_id, state_transition_evaluation_id)
	SELECT id, "PROPAGATION", "PROJECT_APPROVED", "PROJECT_REACTIVATED_OUTCOME"
	FROM STATE_ACTION
	WHERE state_id = "PROJECT_DISABLED_PENDING_PROGRAM_REACTIVATION"
		AND action_id = "PROJECT_REACTIVATE"
		UNION
	SELECT id, "PROPAGATION", "PROJECT_DEACTIVATED", "PROJECT_REACTIVATED_OUTCOME"
	FROM STATE_ACTION
	WHERE state_id = "PROJECT_DISABLED_PENDING_PROGRAM_REACTIVATION"
		AND action_id = "PROJECT_REACTIVATE"
		UNION
	SELECT id, "PROPAGATION", "PROJECT_DISABLED_PENDING_REACTIVATION", "PROJECT_REACTIVATED_OUTCOME"
	FROM STATE_ACTION
	WHERE state_id = "PROJECT_DISABLED_PENDING_PROGRAM_REACTIVATION"
		AND action_id = "PROJECT_REACTIVATE"
;
...
CREATE TABLE STATE_TRANSITION_PROPAGATION (
	...
	WHERE STATE_TRANSITION.transition_state_id IN ("PROGRAM_APPROVED", "PROGRAM_DEACTIVATED")
		...
		AND PROPAGATED_STATE_TRANSITION.state_transition_evaluation_id = "PROJECT_REACTIVATED_OUTCOME"
		UNION
	SELECT NULL AS id, STATE_TRANSITION.id AS state_transition_id, 
		PROPAGATED_STATE_TRANSITION.id AS propagated_state_transition_id
	FROM STATE_TRANSITION INNER JOIN STATE_TRANSITION AS PROPAGATED_STATE_TRANSITION
