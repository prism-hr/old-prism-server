...
import com.zuehlke.pgadmissions.referencedata.jaxb.OpportunityTypes.OpportunityType;

@Component
public class ImportedOpportunityTypeExtractor implements ImportedEntityExtractor {
    ...
    public List<String> extract(Institution institution, PrismImportedEntity prismImportedEntity, List<Object> definitions) throws Exception {
        ...
        for (Object definition : definitions) {
            OpportunityType opportunityType = (OpportunityType) definition;
            ...
            cells.add(prepareStringForSqlInsert(opportunityType.getCode()));
            cells.add(prepareStringForSqlInsert(opportunityType.getName()));
