...
INSERT INTO ROLE_TRANSITION (state_transition_id, role_id, role_transition_type_id, transition_role_id, minimum_permitted, maximum_permitted, processing_order)
	SELECT STATE_TRANSITION.id, "APPLICATION_REFEREE", "UPDATE", "APPLICATION_VIEWER_REFEREE", NULL, NULL, NULL
	FROM STATE_TRANSITION INNER JOIN STATE_ACTION
		ON STATE_TRANSITION.state_action_id = STATE_ACTION.id
	WHERE STATE_ACTION.action_id = "APPLICATION_CONFIRM_OFFER_RECOMMENDATION"
		UNION
	SELECT STATE_TRANSITION.id, ROLE.id, "CREATE", NULL, 1, 1, 0
	FROM STATE_TRANSITION INNER JOIN STATE_ACTION
		ON STATE_TRANSITION.state_action_id = STATE_ACTION.id
	INNER JOIN ROLE
	WHERE STATE_ACTION.action_id = "APPLICATION_CONFIRM_OFFER_RECOMMENDATION"
		AND ROLE.id IN ("APPLICATION_PRIMARY_SUPERVISOR", "APPLICATION_SECONDARY_SUPERVISOR")
		UNION
	SELECT STATE_TRANSITION.id, ROLE.id, "UPDATE", "APPLICATION_VIEWER_RECRUITER", NULL, NULL, 1
	FROM STATE_TRANSITION INNER JOIN STATE_ACTION
		ON STATE_TRANSITION.state_action_id = STATE_ACTION.id
	INNER JOIN ROLE
	WHERE STATE_ACTION.action_id = "APPLICATION_CONFIRM_OFFER_RECOMMENDATION"
...
INSERT INTO STATE_TRANSITION (state_action_id, state_transition_type_id, transition_state_id, state_transition_evaluation_id, do_post_comment)
	...
	WHERE state_id = "APPLICATION_APPROVED_PENDING_EXPORT"
		...
		UNION
	SELECT id, "DUE_DATE_EXPIRY", "APPLICATION_APPROVED_PENDING_EXPORT", "APPLICATION_EXPORTED_OUTCOME", 1
	FROM STATE_ACTION
	WHERE state_id = "APPLICATION_APPROVED_PENDING_EXPORT"
		AND action_id = "APPLICATION_EXPORT"
		UNION
...
INSERT INTO STATE_TRANSITION (state_action_id, state_transition_type_id, transition_state_id, state_transition_evaluation_id, do_post_comment)
	...
	WHERE state_id = "APPLICATION_REJECTED_PENDING_EXPORT"
		AND action_id = "APPLICATION_EXPORT"
		UNION
	SELECT id, "DUE_DATE_EXPIRY", "APPLICATION_REJECTED_PENDING_EXPORT", "APPLICATION_EXPORTED_OUTCOME", 1
	FROM STATE_ACTION
	WHERE state_id = "APPLICATION_REJECTED_PENDING_EXPORT"
		AND action_id = "APPLICATION_EXPORT"
		UNION
...
INSERT INTO STATE_TRANSITION (state_action_id, state_transition_type_id, transition_state_id, state_transition_evaluation_id, do_post_comment)
	...
	WHERE state_id = "APPLICATION_WITHDRAWN"
		AND action_id = "APPLICATION_EXPORT"
		UNION
	SELECT id, "DUE_DATE_EXPIRY", "APPLICATION_WITHDRAWN", "APPLICATION_EXPORTED_OUTCOME", 1
	FROM STATE_ACTION
	WHERE state_id = "APPLICATION_WITHDRAWN"
		AND action_id = "APPLICATION_EXPORT"
		UNION
...
INSERT INTO STATE_TRANSITION (state_action_id, state_transition_type_id, transition_state_id, transition_action_id, do_post_comment)
	SELECT id, "PROPAGATION", "PROGRAM_APPROVED", "INSTITUTION_IMPORT_PROGRAM", 1
	FROM STATE_ACTION
...
INSERT INTO STATE_TRANSITION (state_action_id, state_transition_type_id, transition_state_id, state_transition_evaluation_id, do_post_comment)
	...
	FROM STATE_ACTION INNER JOIN STATE
	WHERE STATE_ACTION.action_id = "PROGRAM_CONCLUDE"
		AND STATE_ACTION.state_id = "PROGRAM_APPROVED"
		AND STATE.id IN ("PROGRAM_APPROVED", "PROGRAM_DEACTIVATED", "PROGRAM_DISABLED_COMPLETED")
		UNION
	SELECT STATE_ACTION.id, "PROPAGATION", STATE.id, "APPLICATION_RECRUITMENT_OUTCOME", 1
	FROM STATE_ACTION INNER JOIN STATE
	WHERE STATE_ACTION.action_id = "PROGRAM_CONCLUDE"
...
INSERT INTO STATE_TRANSITION (state_action_id, state_transition_type_id, transition_state_id, state_transition_evaluation_id, do_post_comment)
	...
	FROM STATE_ACTION
	WHERE action_id = "PROGRAM_RESTORE"
		UNION
...
INSERT INTO STATE_TRANSITION (state_action_id, state_transition_type_id, transition_state_id, state_transition_evaluation_id, do_post_comment)
	SELECT STATE_ACTION.id, "PROPAGATION", STATE.id, "APPLICATION_RECRUITMENT_OUTCOME", 1
	FROM STATE_ACTION INNER JOIN STATE
	WHERE STATE_ACTION.action_id = "PROJECT_CONCLUDE"
		AND STATE_ACTION.state_id = "PROJECT_APPROVED"
		AND STATE.id IN ("PROJECT_APPROVED", "PROJECT_DEACTIVATED", "PROJECT_DISABLED_COMPLETED")
		UNION
	SELECT STATE_ACTION.id, "PROPAGATION", STATE.id, "APPLICATION_RECRUITMENT_OUTCOME", 1
	FROM STATE_ACTION INNER JOIN STATE
	WHERE STATE_ACTION.action_id = "PROJECT_CONCLUDE"
...
INSERT INTO STATE_TRANSITION_PROPAGATION (state_transition_id, propagated_state_transition_id)
	...
	WHERE STATE_ACTION.action_id = "APPLICATION_CONFIRM_OFFER_RECOMMENDATION"
		AND PROPAGATED_STATE_ACTION.action_id IN ("PROGRAM_CONCLUDE", "PROJECT_CONCLUDE")
;
...
INSERT INTO STATE_TRANSITION_PROPAGATION (state_transition_id, propagated_state_transition_id)
	...
	INNER JOIN STATE_ACTION AS PROPAGATED_STATE_ACTION
		ON PROPAGATED_STATE_TRANSITION.state_action_id = PROPAGATED_STATE_ACTION.id
	WHERE STATE_ACTION.action_id = "PROGRAM_RESTORE"
		AND PROPAGATED_STATE_ACTION.action_id = "PROJECT_RESTORE"
;
