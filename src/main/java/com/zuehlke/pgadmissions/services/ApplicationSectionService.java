...
public class ApplicationSectionService {
    ...
    public ApplicationQualification updateQualification(Integer applicationId, Integer qualificationId, ApplicationQualificationDTO qualificationDTO)
        ...
        if (importedInstitutionDTO.getId() == null) {
            ...
            importedInstitution = new ImportedInstitution().withInstitution(institution).withDomicile(domicile).withEnabled(true)
                    .withCode("TEMPORARY_CODE").withName(importedInstitutionDTO.getName());
            ...
            importedInstitution = importedEntityService.getById(ImportedInstitution.class, institution, importedInstitutionDTO
                    .getId());
        }
