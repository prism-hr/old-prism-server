...
INSERT INTO ROLE_TRANSITION (state_transition_id, role_id, role_transition_type_id, transition_role_id, processing_order)
	...
	WHERE STATE_ACTION.action_id = "APPLICATION_COMPLETE"
		UNION
	SELECT STATE_TRANSITION.id, "APPLICATION_SUGGESTED_SUPERVISOR", "CREATE_ALL", NULL, 0
	FROM STATE_TRANSITION INNER JOIN STATE_ACTION
		ON STATE_TRANSITION.state_action_id = STATE_ACTION.id
	WHERE STATE_ACTION.action_id = "APPLICATION_COMPLETE"
		UNION
	SELECT STATE_TRANSITION.id, "APPLICATION_SUGGESTED_SUPERVISOR", "APPEND_ALL", "APPLICATION_VIEWER_RECRUITER", 1
	FROM STATE_TRANSITION INNER JOIN STATE_ACTION
		ON STATE_TRANSITION.state_action_id = STATE_ACTION.id
	WHERE STATE_ACTION.action_id = "APPLICATION_COMPLETE"
		UNION
	SELECT STATE_TRANSITION.id, "APPLICATION_SUGGESTED_SUPERVISOR", "REMOVE_ALL", NULL, NULL
	FROM STATE_TRANSITION INNER JOIN STATE_ACTION
		ON STATE_TRANSITION.state_action_id = STATE_ACTION.id
	WHERE STATE_ACTION.action_id = "APPLICATION_COMPLETE"
;
...
INSERT INTO ROLE_TRANSITION (state_transition_id, role_id, role_transition_type_id, transition_role_id, processing_order)
	SELECT STATE_TRANSITION.id, "APPLICATION_ADMINISTRATOR", "CREATE_ONE", NULL, NULL
	FROM STATE_TRANSITION INNER JOIN STATE_ACTION
		ON STATE_TRANSITION.state_action_id = STATE_ACTION.id
	...
	WHERE STATE_ACTION.action_id IN ("APPLICATION_COMPLETE_REVIEW_STAGE", "APPLICATION_COMPLETE_INTERVIEW_STAGE", "APPLICATION_COMPLETE_APPROVAL_STAGE")
		AND STATE_TRANSITION.transition_state_id IN ("APPLICATION_REVIEW", "APPLICATION_INTERVIEW", "APPLICATION_APPROVAL")
		UNION
	SELECT STATE_TRANSITION.id, "APPLICATION_ADMINISTRATOR", "REMOVE_ALL", NULL, NULL
	FROM STATE_TRANSITION INNER JOIN STATE_ACTION
		ON STATE_TRANSITION.state_action_id = STATE_ACTION.id
	WHERE STATE_ACTION.action_id IN ("APPLICATION_COMPLETE_REVIEW_STAGE", "APPLICATION_COMPLETE_INTERVIEW_STAGE", "APPLICATION_COMPLETE_APPROVAL_STAGE")
	...
	WHERE STATE_ACTION.action_id = "APPLICATION_COMPLETE_REVIEW_STAGE"
		UNION
	SELECT STATE_TRANSITION.id, "APPLICATION_INTERVIEWER", "REMOVE_ALL", NULL, NULL
	FROM STATE_TRANSITION INNER JOIN STATE_ACTION
		ON STATE_TRANSITION.state_action_id = STATE_ACTION.id
	WHERE STATE_ACTION.action_id = "APPLICATION_COMPLETE_INTERVIEW_STAGE"
		UNION
	SELECT STATE_TRANSITION.id, "APPLICATION_INTERVIEWEE", "REMOVE_ALL", NULL, NULL
	FROM STATE_TRANSITION INNER JOIN STATE_ACTION
		ON STATE_TRANSITION.state_action_id = STATE_ACTION.id
	WHERE STATE_ACTION.action_id = "APPLICATION_COMPLETE_INTERVIEW_STAGE"
...
INSERT INTO ROLE_TRANSITION (state_transition_id, role_id, role_transition_type_id, transition_role_id, processing_order)
	...
	WHERE STATE_ACTION.action_id = "APPLICATION_ASSIGN_SUPERVISORS"
		AND ROLE.id IN ("APPLICATION_PRIMARY_SUPERVISOR", "APPLICATION_SECONDARY_SUPERVISOR")
		UNION
	SELECT STATE_TRANSITION.id, ROLE.id, "APPEND_ALL", "APPLICATION_VIEWER_RECRUITER", 1
	FROM STATE_TRANSITION INNER JOIN STATE_ACTION
		ON STATE_TRANSITION.state_action_id = STATE_ACTION.id
	INNER JOIN ROLE
	WHERE STATE_ACTION.action_id = "APPLICATION_ASSIGN_SUPERVISORS"
