...
public class TimeZoneUtils {
    ...
    private TimeZoneUtils() {
        ...
        timeZoneDefinitions = Lists.newArrayListWithCapacity(timeZones.size());
        for (TimeZoneWithDisplayNames timeZone : timeZones) {
            timeZoneDefinitions.add(new TimeZoneDefinition(timeZone.getTimeZone().getID(), timeZone.getDisplayName()));
        }
    }
    ...
    public static final class TimeZoneDefinition {
        private String id;
