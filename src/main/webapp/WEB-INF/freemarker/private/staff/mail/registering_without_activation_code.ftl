            ...
            <tr>
                ...
                <td width="500">
                    ...
                    <p>
                        ...
                        Our records indicated that you have been registered to use UCL Prism. 
                        We will have sent you a confirmation message with the subject "${subject?html}". 
                        Please follow the instructions to register with UCL Prism.
                        </font>
                    </p>
                    
                    <p>
                        <font face="Arial, Helvetica, sans-serif" size="2">Register to start using UCL Prism.</font>
                    </p>
                    
                    <p>
                        <a style="text-decoration:none;" href="${host}/pgadmissions/register?activationCode=${user.activationCode}" title="Register">
