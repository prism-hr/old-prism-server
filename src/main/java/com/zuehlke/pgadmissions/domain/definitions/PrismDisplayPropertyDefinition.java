...
public enum PrismDisplayPropertyDefinition implements PrismConfigurationCategorizable<PrismDisplayPropertyCategory> {
    ...
    SYSTEM_ADVERTISE_MY_INSTITUTION_HINT(SYSTEM_ADVERTISE_SECTION, "???"),
    SYSTEM_ADVERTISE_INSTITUTION_OTHER_HINT(SYSTEM_ADVERTISE_SECTION, "I will enter my organization"),
