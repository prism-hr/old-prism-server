...
public class ApplicationController {
    ...
    public void savePersonalDetail(@PathVariable Integer applicationId, @Valid @RequestBody ProfilePersonalDetailDTO personalDetailDTO) throws Exception {
    ...
    public void saveAddress(@PathVariable Integer applicationId, @Valid @RequestBody ProfileAddressDTO addressDTO) throws Exception {
    ...
    public Map<String, Object> createReferee(@PathVariable Integer applicationId, @Valid @RequestBody ProfileRefereeDTO refereeDTO) throws Exception {
    ...
    public void saveDocument(@PathVariable Integer applicationId, @Valid @RequestBody ProfileDocumentDTO documentDTO) throws Exception {
    ...
    public void saveAdditionalInformation(@PathVariable Integer applicationId, @Valid @RequestBody ProfileAdditionalInformationDTO additionalInformationDTO) throws Exception {
