...
public class ScoringDefinitionParserTest {
    ...
    public void shouldValidateSingleText() throws Exception {
        ...
        CustomQuestions scoreDefinition = parser.parseScoringDefinition(xmlContent);
    ...
    public void shouldInvalidateSingleTextWithoutLabel() throws Exception {
        ...
        try {
            ...
            Assert.assertEquals("cvc-complex-type.2.4.a: Invalid content was found starting with element 'required'. One of '{label}' is expected.", e
                    .getLinkedException().getLocalizedMessage());
        }
    }
    ...
    public void shouldInvalidateSingleTextWithoutRequiredField() throws Exception {
        ...
        try {
            ...
            Assert.assertEquals("cvc-complex-type.2.4.b: The content of element 'question' is not complete. One of '{required}' is expected.", e
                    .getLinkedException().getLocalizedMessage());
        }
    }
