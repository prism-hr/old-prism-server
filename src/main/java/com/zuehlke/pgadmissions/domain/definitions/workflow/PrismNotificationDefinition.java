...
public enum PrismNotificationDefinition {
    ...
    APPLICATION_COMPLETE_NOTIFICATION(INDIVIDUAL, UPDATE, APPLICATION, APPLICATION_COMPLETE_NOTIFICATION_LABEL, APPLICATION_COMPLETE_NOTIFICATION_TOOLTIP,
            Lists.newArrayList(INSTITUTION_GLOBAL, APPLICATION_GLOBAL, COMMENT_GLOBAL, TEMPLATE_GLOBAL)), //
    ...
    APPLICATION_PROVIDE_INTERVIEW_AVAILABILITY_NOTIFICATION(INDIVIDUAL, UPDATE, APPLICATION, APPLICATION_PROVIDE_INTERVIEW_AVAILABILITY_NOTIFICATION_LABEL,
            APPLICATION_PROVIDE_INTERVIEW_AVAILABILITY_NOTIFICATION_TOOLTIP, Lists.newArrayList(INSTITUTION_GLOBAL, APPLICATION_GLOBAL, COMMENT_GLOBAL,
                    TEMPLATE_GLOBAL)), //
    ...
    PROJECT_COMPLETE_APPROVAL_STAGE_NOTIFICATION(INDIVIDUAL, UPDATE, PROJECT, PROJECT_COMPLETE_APPROVAL_STAGE_NOTIFICATION_LABEL,
            PROJECT_COMPLETE_APPROVAL_STAGE_NOTIFICATION_TOOLTIP, Lists.newArrayList(INSTITUTION_GLOBAL, PROGRAM_GLOBAL, PROJECT_GLOBAL, COMMENT_GLOBAL,
    ...
    PROGRAM_COMPLETE_APPROVAL_STAGE_NOTIFICATION(INDIVIDUAL, UPDATE, PROGRAM, PROGRAM_COMPLETE_APPROVAL_STAGE_NOTIFICATION_LABEL,
            PROGRAM_COMPLETE_APPROVAL_STAGE_NOTIFICATION_TOOLTIP, Lists.newArrayList(INSTITUTION_GLOBAL, PROGRAM_GLOBAL, COMMENT_GLOBAL, COMMENT_TRANSITION,
                    TEMPLATE_GLOBAL)), //
    ...
    INSTITUTION_COMPLETE_APPROVAL_STAGE_NOTIFICATION(INDIVIDUAL, UPDATE, INSTITUTION, INSTITUTION_COMPLETE_APPROVAL_STAGE_NOTIFICATION_LABEL,
            INSTITUTION_COMPLETE_APPROVAL_STAGE_NOTIFICATION_TOOLTIP, Lists.newArrayList(INSTITUTION_GLOBAL, COMMENT_GLOBAL, COMMENT_TRANSITION,
                    TEMPLATE_GLOBAL)), //
    ...
    INSTITUTION_STARTUP_NOTIFICATION(INDIVIDUAL, UPDATE, INSTITUTION, INSTITUTION_IMPORT_ERROR_NOTIFICATION_LABEL,
            INSTITUTION_IMPORT_ERROR_NOTIFICATION_TOOLTIP, Lists.newArrayList(INSTITUTION_GLOBAL, COMMENT_GLOBAL, TEMPLATE_GLOBAL)), //
    INSTITUTION_IMPORT_ERROR_NOTIFICATION(INDIVIDUAL, UPDATE, INSTITUTION, INSTITUTION_STARTUP_NOTIFICATION_LABEL, INSTITUTION_STARTUP_NOTIFICATION_TOOLTIP,
            Lists.newArrayList(INSTITUTION_GLOBAL, INSTITUTION_APPROVED, COMMENT_GLOBAL, TEMPLATE_GLOBAL)), //
