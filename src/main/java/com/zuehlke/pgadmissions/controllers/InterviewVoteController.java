...
public class InterviewVoteController {
    ...
    public ApplicationForm getApplicationForm(@RequestParam String applicationId) {
        ...
        actionsProvider.validateAction(application, getCurrentUser(), ApplicationFormAction.PROVIDE_INTERVIEW_AVAILABILITY);
        return application;
    }
    ...
    public InterviewParticipant getInterviewParticipant(@RequestParam String applicationId) {
        ...
        InterviewParticipant participant = applicationForm.getLatestInterview().getParticipant(getCurrentUser());
        return participant;
    }
    ...
    public String getInterviewVotePage(ModelMap modelMap, @ModelAttribute ApplicationForm applicationForm) {
    ...
    public String submitInterviewVotes(@Valid @ModelAttribute InterviewParticipant currentParticipant, BindingResult bindingResult,
            @RequestParam(required = false) String comment, ModelMap modelMap, @ModelAttribute ApplicationForm applicationForm) {
