...
public enum PrismDisplayPropertyDefinition implements PrismConfigurationCategorizable<PrismDisplayPropertyCategory> {
    ...
    INSTITUTION_FORM_BUSINESS_YEAR_START_MONTH_LABEL(INSTITUTION_ADVERT_DETAILS, "Business Year Start Month"),
    INSTITUTION_FORM_BUSINESS_YEAR_START_MONTH_HINT(INSTITUTION_ADVERT_DETAILS, "???"),
