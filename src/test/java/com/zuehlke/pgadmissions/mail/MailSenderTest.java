...
public class MailSenderTest {
    ...
    public void shouldResolveSubjectWithoutArguments() {
        ...
        expect(emailTemplateServiceMock.getSubjectForTemplate(isA(EmailTemplateName.class)))
        .andReturn("Subject without arguments");
        
        replay(emailTemplateServiceMock);
        String result = service.resolveSubject(EmailTemplateName.REGISTRATION_CONFIRMATION, (Object[])null);
    ...
    public void shouldResolveSubjectWithOneArgument() {
        ...
        replay(emailTemplateServiceMock);
        String result = service.resolveSubject(EmailTemplateName.REGISTRATION_CONFIRMATION, new Object[] {"Beppe"});
        verify(emailTemplateServiceMock);
    ...
    public void shouldResolveSubjectWithTwoArguments() {
        ...
        replay(emailTemplateServiceMock);
        String result = service.resolveSubject(EmailTemplateName.REGISTRATION_CONFIRMATION, new Object[] {"Beppe", "\"Gran Maestro\""});
        verify(emailTemplateServiceMock);
    ...
    public void shouldResolveSubjectWithTwoStringArgumentsAndOneNumeric() {
        ...
        replay(emailTemplateServiceMock);
        String result = service.resolveSubject(EmailTemplateName.REGISTRATION_CONFIRMATION, new Object[] {"Beppe", new Integer(3), "\"Gran Maestro\""});
        verify(emailTemplateServiceMock);
    ...
    public void shouldResolveSubjectWithTwoStringArgumentsAndOneNumericWithcustomOrder() {
        ...
        replay(emailTemplateServiceMock);
        String result = service.resolveSubject(EmailTemplateName.REGISTRATION_CONFIRMATION, new Object[] {"\"Gran Maestro\"",  "Beppe", new Integer(3)});
        verify(emailTemplateServiceMock);
        assertEquals("Dear Beppe, you have been reminded 3 times that you have been assigned the tole of \"Gran Maestro\"", result);
    }
