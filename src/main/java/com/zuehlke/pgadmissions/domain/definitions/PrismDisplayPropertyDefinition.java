...
public enum PrismDisplayPropertyDefinition implements PrismConfigurationCategorizable<PrismDisplayPropertyCategory> {
    ...
    SYSTEM_OPPORTUNITY_TYPE_PAID_TOC(SYSTEM_OPPORTUNITY_TYPE, "In order to advertise an opportunity of this type we need you to confirm that: (a) you are happy to pay the successful applicant a minimum of the national minimum wage, or; (b) that you are committed to rewarding the successul applicant in some other fair way for their effort, for example through granting of shares in a company. Please check to confirm. Alternatively, you can offer the opportunity as volunteering or on course placement."),
    SYSTEM_OPPORTUNITY_TYPE_OPTIONAL_TOC(SYSTEM_OPPORTUNITY_TYPE, "By offering an opportunity of this type you are confirming that the successful applicant will work with you as a required component of their course of study. While we recommend that you pay the successful applicant the national minimum wage, or reward them in some other fair way, you are not legally required to do so."),
