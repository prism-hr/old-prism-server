...
public class ApplicationFormDAOTest extends AutomaticRollbackTestCase {
	...
	public void shouldReturnOwnApplicationsAndRefereeingApplicationsIfApplicant() {
		...
		Referee referee = new RefereeBuilder().user(applicant).email("email3@test.com").firstname("bob").lastname("smith").addressCountry(country)
				.addressLocation("london").jobEmployer("zuhlke").jobTitle("se").messenger("skypeAddress").phoneNumber("hallihallo").toReferee();
	...
	public void shouldReturnAppsOfWhichApplicationAdministrator() {
		...
		ApplicationForm applicationForm = new ApplicationFormBuilder().program(otherProgram).applicant(user).status(ApplicationFormStatus.REVIEW)
				.toApplicationForm();
	...
	public void shouldNotReturnUbnsubmittedAppsOfWhichApplicationAdministrator() {
		...
		ApplicationForm applicationForm = new ApplicationFormBuilder().program(otherProgram).applicant(user).status(ApplicationFormStatus.UNSUBMITTED)
				.toApplicationForm();
	...
	public void shouldNotReturnAppsOfWhichReviewerNotInReviewState() {
		...
		ApplicationForm applicationForm = new ApplicationFormBuilder().program(otherProgram).applicant(user).status(ApplicationFormStatus.INTERVIEW)
				.toApplicationForm();
	...
	public void shouldReturnAppsSubmittedToUsersProgramsAndAppsOfWhichReviewerIfAdminAndReviewer() {
		...
		ApplicationForm applicationFormOne = new ApplicationFormBuilder().program(otherProgram).applicant(user).status(ApplicationFormStatus.REVIEW)
				.toApplicationForm();
	...
	public void shouldReturnAppsOfWhichSupervisorOfLatestApprovalRound() {
		...
		ApplicationForm applicationFormTwo = new ApplicationFormBuilder().program(otherProgram).applicant(user).status(ApplicationFormStatus.APPROVED)
				.toApplicationForm();
		...
		ApprovalRound approvalRoundOne = new ApprovalRoundBuilder().supervisors(supervisorOne).application(applicationFormOne).toApprovalRound();
		ApprovalRound approvalRoundTwo = new ApprovalRoundBuilder().supervisors(supervisorTwo).application(applicationFormTwo).toApprovalRound();
	...
	public void shouldNotReturnAppsOfWhichSupervisorOfLatestApprovalRoundNotInApprovalStage() {
		...
		ApplicationForm applicationForm = new ApplicationFormBuilder().program(otherProgram).applicant(user).status(ApplicationFormStatus.REJECTED)
				.toApplicationForm();
	...
	public void shouldReturnAppsSubmittedToUsersProgramsAndAppsOfWhichInterviewerIsAdminAndInterviewer() {
		...
		ApplicationForm applicationFormOne = new ApplicationFormBuilder().program(otherProgram).applicant(user).status(ApplicationFormStatus.INTERVIEW)
				.toApplicationForm();
	...
	public void shouldNotReturnApplicationsInProgramForApproverInNotInApproval() {
		...
		ApplicationForm applicationForm = new ApplicationFormBuilder().program(program).applicant(user).status(ApplicationFormStatus.INTERVIEW)
				.toApplicationForm();
