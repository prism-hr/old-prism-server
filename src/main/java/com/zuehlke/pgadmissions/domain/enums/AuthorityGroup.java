...
public enum AuthorityGroup {
    ...
    INTERNAL_PROJECT_AUTHORITIES(Arrays.asList(Authority.PROJECT_ADMINISTRATOR)),
    ...
    ADMINISTRATOR_AUTHORITIES(Arrays.asList(Authority.PROGRAM_ADMINISTRATOR, Authority.PROJECT_ADMINISTRATOR, Authority.APPLICATION_ADMINISTRATOR, Authority.SYSTEM_ADMINISTRATOR)),
