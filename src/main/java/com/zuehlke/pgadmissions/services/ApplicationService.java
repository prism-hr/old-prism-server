...
public class ApplicationService {
    ...
    public void executeExportAction(Integer applicationId, SubmitAdmissionsApplicationRequest exportRequest, String exportId, String exportUserId,
        ...
        String exportRequestContent;
        if (exportRequest == null) {
            exportRequestContent = null;
        } else {
            Marshaller marshaller = JAXBContext.newInstance(SubmitAdmissionsApplicationRequest.class).createMarshaller();
            marshaller.setProperty(Marshaller.JAXB_FORMATTED_OUTPUT, true);
            StringWriter writer = new StringWriter();
            marshaller.marshal(exportRequest, writer);
            exportRequestContent = writer.toString();
        }
        
        Comment comment = new Comment().withUser(exportInstitution.getUser()).withAction(exportAction).withDeclinedResponse(false)
                .withExportRequest(exportRequest == null ? null : exportRequestContent).withExportReference(exportId)
