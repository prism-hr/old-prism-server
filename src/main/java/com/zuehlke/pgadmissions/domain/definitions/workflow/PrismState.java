...
public enum PrismState {
    ...
    APPLICATION_VALIDATION(PrismStateGroup.APPLICATION_VALIDATION, null, APPLICATION, PrismApplicationValidation.class), APPLICATION_VALIDATION_PENDING_COMPLETION(
            PrismStateGroup.APPLICATION_VALIDATION, APPLICATION_ESCALATE_DURATION, APPLICATION, PrismApplicationValidationPendingCompletion.class), //
    ...
    APPLICATION_INTERVIEW_PENDING_INTERVIEW(PrismStateGroup.APPLICATION_INTERVIEW, null, APPLICATION, PrismApplicationInterviewPendingInterview.class), //
