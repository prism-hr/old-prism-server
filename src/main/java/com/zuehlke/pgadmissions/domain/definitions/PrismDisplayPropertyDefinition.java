...
public enum PrismDisplayPropertyDefinition implements PrismConfigurationCategorizable<PrismDisplayPropertyCategory> {
    ...
    APPLICATION_FUNDING_SPONSOR_HINT(
            APPLICATION_FUNDING,
            "The name of the sponsor of the award. Sponsors may typically include public research funders such as government research councils/sponsors, industrial sponsors, or academic prize awarding bodies."),
