...
<body>
    <table width="600" border="0" cellspacing="0" cellpadding="0">
		...
		<p>
					<font face="Arial, Helvetica, sans-serif" size="2">
						Your request has now been reviewed by our staff and (we are happy to inform you that","unfortunately, the outcome is that") the application has been ("successful","unsuccessful on this occasion").
					</font>
				</p>
				<p>
					<font face="Arial, Helvetica, sans-serif" size="2">
