...
public class FileController {
    ...
    public Map<String, Object> uploadDocument(@RequestParam(value = "file-data") Part uploadStream) throws Exception {
    ...
    public Map<String, Object> uploadImage(@RequestParam(value = "file-data") Part uploadStream, @RequestParam Integer entityId, @RequestParam PrismImageCategory imageCategory) throws Exception {
