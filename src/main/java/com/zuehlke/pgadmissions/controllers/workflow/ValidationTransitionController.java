...
public class ValidationTransitionController extends StateTransitionController {
	...
	public String addComment(@RequestParam String applicationId, @Valid @ModelAttribute("comment") ValidationComment validationComment, BindingResult result, ModelMap modelMap) {
		if (result.hasErrors()) {
