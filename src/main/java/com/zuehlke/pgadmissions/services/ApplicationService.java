...
public class ApplicationService {
    ...
    public ApplicationStartDateRepresentation getStartDateRepresentation(Integer applicationId, PrismStudyOption studyOptionId) {
        ...
        AdvertStudyOption programStudyOption = programService.getEnabledAdvertStudyOption(application.getProgram(), studyOption);
    ...
    public LocalDate getLatestStartDate(Integer studyOptionId) {
        ...
        LocalDate closeDate = studyOption.getApplicationCloseDate().plusMonths(
                studyOption.getAdvert().getProgramType().getDefaultStartBuffer());
    ...
    public List<ApplicationReferenceDTO> getApplicationExportReferees(Application application) throws Exception {
        ...
        WorkflowPropertyConfiguration configuration = (WorkflowPropertyConfiguration) //
        customizationService.getConfigurationWithOrWithoutVersion(WORKFLOW_PROPERTY, application, application.getLocale(), application.getProgramType(),
                APPLICATION_ASSIGN_REFEREE, application.getWorkflowPropertyConfigurationVersion());
    ...
    public List<WorkflowPropertyConfigurationRepresentation> getWorkflowPropertyConfigurations(Application application) throws Exception {
        ...
        customizationService.getConfigurationRepresentationsWithOrWithoutVersion(WORKFLOW_PROPERTY, application, application.getLocale(),
                application.getProgramType(), application.getWorkflowPropertyConfigurationVersion());
    ...
    private LocalDate getRecommendedStartDate(Application application, AdvertStudyOption studyOption, LocalDate baseline) {
        ...
        PrismProgramType programType = application.getProgram().getImportedProgramType().getPrismProgramType();
