...
INSERT INTO STATE_ACTION (state_id, action_id, raises_urgent_flag, notification_template_id, precedence)
	...
	SELECT "APPLICATION_VALIDATION", "APPLICATION_WITHDRAW", 0, NULL, NULL
		UNION
	SELECT "APPLICATION_VALIDATION", "APPLICATION_ESCALATE", 0, NULL, NULL
;
...
INSERT INTO STATE_ACTION (state_id, action_id, raises_urgent_flag, notification_template_id, precedence)
	...
	SELECT "APPLICATION_VALIDATION_PENDING_COMPLETION", "APPLICATION_WITHDRAW", 0, NULL, NULL
		UNION
	SELECT "APPLICATION_VALIDATION_PENDING_COMPLETION", "APPLICATION_ESCALATE", 0, NULL, NULL
;
...
INSERT INTO STATE_ACTION (state_id, action_id, raises_urgent_flag, notification_template_id, precedence)
	...
	SELECT "APPLICATION_REVIEW", "APPLICATION_VIEW_AS_REFEREE", 0, NULL, 0
		UNION
	SELECT "APPLICATION_REVIEW", "APPLICATION_ESCALATE", 0, NULL, NULL
;
...
INSERT INTO STATE_ACTION (state_id, action_id, raises_urgent_flag, notification_template_id, precedence)
	...
	SELECT "APPLICATION_REVIEW_PENDING_COMPLETION", "APPLICATION_WITHDRAW", 0, NULL, NULL
		UNION
	SELECT "APPLICATION_REVIEW_PENDING_COMPLETION", "APPLICATION_ESCALATE", 0, NULL, NULL
;
...
INSERT INTO STATE_ACTION (state_id, action_id, raises_urgent_flag, notification_template_id, precedence)
	...
	SELECT "APPLICATION_INTERVIEW", "APPLICATION_WITHDRAW", 0, NULL, NULL
		UNION
	SELECT "APPLICATION_INTERVIEW", "APPLICATION_ESCALATE", 0, NULL, NULL
;
...
INSERT INTO STATE_ACTION (state_id, action_id, raises_urgent_flag, notification_template_id, precedence)
	...
	SELECT "APPLICATION_INTERVIEW_PENDING_SCHEDULING", "APPLICATION_WITHDRAW", 0, NULL, NULL
		UNION
	SELECT "APPLICATION_INTERVIEW_PENDING_SCHEDULING", "APPLICATION_ESCALATE", 0, NULL, NULL
;
...
INSERT INTO STATE_ACTION (state_id, action_id, raises_urgent_flag, notification_template_id, precedence)
	...
	SELECT "APPLICATION_INTERVIEW_PENDING_COMPLETION", "APPLICATION_WITHDRAW", 0, NULL, NULL
		UNION
	SELECT "APPLICATION_INTERVIEW_PENDING_COMPLETION", "APPLICATION_ESCALATE", 0, NULL, NULL	
;
...
INSERT INTO STATE_ACTION (state_id, action_id, raises_urgent_flag, notification_template_id, precedence)
	...
	SELECT "APPLICATION_APPROVAL", "APPLICATION_EDIT_AS_ADMINISTRATOR", 0, NULL, 2
		UNION
	SELECT "APPLICATION_APPROVAL", "APPLICATION_ESCALATE", 0, NULL, NULL
;
...
INSERT INTO STATE_ACTION (state_id, action_id, raises_urgent_flag, notification_template_id, precedence)
	...
	SELECT "APPLICATION_APPROVAL_PENDING_COMPLETION", "APPLICATION_WITHDRAW", 0, NULL, NULL
		UNION
	SELECT "APPLICATION_APPROVAL_PENDING_COMPLETION", "APPLICATION_ESCALATE", 0, NULL, NULL
;
...
INSERT INTO STATE_ACTION (state_id, action_id, raises_urgent_flag, notification_template_id, precedence)
	...
	SELECT "APPLICATION_APPROVED", "APPLICATION_WITHDRAW", 0, NULL, NULL
		UNION
	SELECT "APPLICATION_APPROVED", "APPLICATION_ESCALATE", 0, NULL, NULL
;

INSERT INTO STATE_ACTION (state_id, action_id, raises_urgent_flag, notification_template_id, precedence)
	SELECT "APPLICATION_APPROVED_PENDING_EXPORT", "APPLICATION_VIEW_AS_REFEREE", 0, NULL, 0
		UNION
	SELECT "APPLICATION_APPROVED_PENDING_EXPORT", "APPLICATION_COMMENT", 0, NULL, NULL
		UNION
	SELECT "APPLICATION_APPROVED_PENDING_EXPORT", "APPLICATION_EMAIL_CREATOR", 0, NULL, NULL
		UNION
	SELECT "APPLICATION_APPROVED_PENDING_EXPORT", "APPLICATION_VIEW_AS_CREATOR", 0, NULL, 2
		UNION
	SELECT "APPLICATION_APPROVED_PENDING_EXPORT", "APPLICATION_VIEW_AS_RECRUITER", 0, NULL, 1
		UNION
	SELECT "APPLICATION_APPROVED_PENDING_EXPORT", "APPLICATION_EXPORT", 0, NULL, NULL
;
...
INSERT INTO STATE_ACTION (state_id, action_id, raises_urgent_flag, notification_template_id, precedence)
	SELECT "APPLICATION_APPROVED_COMPLETED", "APPLICATION_VIEW_AS_REFEREE", 0, NULL, 0
		UNION
	SELECT "APPLICATION_APPROVED_COMPLETED", "APPLICATION_COMMENT", 0, NULL, NULL
		UNION
	SELECT "APPLICATION_APPROVED_COMPLETED", "APPLICATION_EMAIL_CREATOR", 0, NULL, NULL
		UNION
	SELECT "APPLICATION_APPROVED_COMPLETED", "APPLICATION_VIEW_AS_CREATOR", 0, NULL, 2
		UNION
	SELECT "APPLICATION_APPROVED_COMPLETED", "APPLICATION_VIEW_AS_RECRUITER", 0, NULL, 1
;
...
INSERT INTO STATE_ACTION (state_id, action_id, raises_urgent_flag, notification_template_id, precedence)
	...
	SELECT "APPLICATION_REJECTED", "APPLICATION_WITHDRAW", 0, NULL, NULL
		UNION
	SELECT "APPLICATION_REJECTED", "APPLICATION_ESCALATE", 0, NULL, NULL
;

INSERT INTO STATE_ACTION (state_id, action_id, raises_urgent_flag, notification_template_id, precedence)
	SELECT "APPLICATION_REJECTED_PENDING_EXPORT", "APPLICATION_VIEW_AS_REFEREE", 0, NULL, 0
		UNION
	SELECT "APPLICATION_REJECTED_PENDING_EXPORT", "APPLICATION_COMMENT", 0, NULL, NULL
		UNION
	SELECT "APPLICATION_REJECTED_PENDING_EXPORT", "APPLICATION_EMAIL_CREATOR", 0, NULL, NULL
		UNION
	SELECT "APPLICATION_REJECTED_PENDING_EXPORT", "APPLICATION_VIEW_AS_CREATOR", 0, NULL, 2
		UNION
	SELECT "APPLICATION_REJECTED_PENDING_EXPORT", "APPLICATION_VIEW_AS_RECRUITER", 0, NULL, 1
		UNION
	SELECT "APPLICATION_REJECTED_PENDING_EXPORT", "APPLICATION_EXPORT", 0, NULL, NULL
;
...
INSERT INTO STATE_ACTION (state_id, action_id, raises_urgent_flag, notification_template_id, precedence)
	SELECT "APPLICATION_REJECTED_COMPLETED", "APPLICATION_VIEW_AS_REFEREE", 0, NULL, 0
		UNION
	SELECT "APPLICATION_REJECTED_COMPLETED", "APPLICATION_COMMENT", 0, NULL, NULL
		UNION
	SELECT "APPLICATION_REJECTED_COMPLETED", "APPLICATION_EMAIL_CREATOR", 0, NULL, NULL
		UNION
	SELECT "APPLICATION_REJECTED_COMPLETED", "APPLICATION_VIEW_AS_CREATOR", 0, NULL, 2
		UNION
	SELECT "APPLICATION_REJECTED_COMPLETED", "APPLICATION_VIEW_AS_RECRUITER", 0, NULL, 1
;

INSERT INTO STATE_ACTION (state_id, action_id, raises_urgent_flag, notification_template_id, precedence)
	SELECT "APPLICATION_WITHDRAWN_PENDING_EXPORT", "APPLICATION_VIEW_AS_REFEREE", 0, NULL, 0
		UNION
	SELECT "APPLICATION_WITHDRAWN_PENDING_EXPORT", "APPLICATION_COMMENT", 0, NULL, NULL
		UNION
	SELECT "APPLICATION_WITHDRAWN_PENDING_EXPORT", "APPLICATION_EMAIL_CREATOR", 0, NULL, NULL
		UNION
	SELECT "APPLICATION_WITHDRAWN_PENDING_EXPORT", "APPLICATION_VIEW_AS_CREATOR", 0, NULL, 2
		UNION
	SELECT "APPLICATION_WITHDRAWN_PENDING_EXPORT", "APPLICATION_VIEW_AS_RECRUITER", 0, NULL, 1
		UNION
	SELECT "APPLICATION_WITHDRAWN_PENDING_EXPORT", "APPLICATION_EXPORT", 0, NULL, NULL
;
...
INSERT INTO STATE_ACTION (state_id, action_id, raises_urgent_flag, notification_template_id, precedence)
	SELECT "APPLICATION_WITHDRAWN_COMPLETED", "APPLICATION_VIEW_AS_REFEREE", 0, NULL, 0
		UNION
	SELECT "APPLICATION_WITHDRAWN_COMPLETED", "APPLICATION_COMMENT", 0, NULL, NULL
		UNION
	SELECT "APPLICATION_WITHDRAWN_COMPLETED", "APPLICATION_EMAIL_CREATOR", 0, NULL, NULL
		UNION
	SELECT "APPLICATION_WITHDRAWN_COMPLETED", "APPLICATION_VIEW_AS_CREATOR", 0, NULL, 2
		UNION
	SELECT "APPLICATION_WITHDRAWN_COMPLETED", "APPLICATION_VIEW_AS_RECRUITER", 0, NULL, 1
;
...
INSERT INTO STATE_ACTION (state_id, action_id, raises_urgent_flag, notification_template_id)
	SELECT "PROJECT_APPROVED", "PROJECT_CREATE_APPLICATION", 0, NULL
		UNION
	SELECT "PROJECT_APPROVED", "PROJECT_CLOSE", 0, NULL
		UNION
...
INSERT INTO STATE_ACTION (state_id, action_id, raises_urgent_flag, notification_template_id)
	SELECT "PROJECT_DEACTIVATED", "PROJECT_CREATE_APPLICATION", 0, NULL
		UNION
	SELECT "PROJECT_DEACTIVATED", "PROJECT_CLOSE", 0, NULL
		UNION
...
INSERT INTO STATE_ACTION (state_id, action_id, raises_urgent_flag, notification_template_id)
	SELECT "PROJECT_DISABLED_PENDING_COMPLETION", "PROJECT_CREATE_APPLICATION", 0, NULL
		UNION
	SELECT "PROJECT_DISABLED_PENDING_COMPLETION", "PROJECT_CLOSE", 0, NULL
		UNION
	SELECT "PROJECT_DISABLED_PENDING_COMPLETION", "PROJECT_ESCALATE", 0, NULL
		UNION
	SELECT "PROJECT_DISABLED_PENDING_COMPLETION", "PROJECT_VIEW", 0, NULL
;
...
INSERT INTO STATE_ACTION (state_id, action_id, raises_urgent_flag, notification_template_id)
	SELECT "PROJECT_DISABLED_PENDING_REACTIVATION", "PROJECT_CREATE_APPLICATION", 0, NULL
		UNION
	SELECT "PROJECT_DISABLED_PENDING_REACTIVATION", "PROJECT_CLOSE", 0, NULL
		UNION
...
INSERT INTO STATE_ACTION (state_id, action_id, raises_urgent_flag, notification_template_id)
	SELECT "PROJECT_DISABLED_PENDING_PROGRAM_REACTIVATION", "PROJECT_CREATE_APPLICATION", 0, NULL
		UNION
	SELECT "PROJECT_DISABLED_PENDING_PROGRAM_REACTIVATION", "PROJECT_CLOSE", 0, NULL
		UNION
	...
	SELECT "PROJECT_DISABLED_PENDING_PROGRAM_REACTIVATION", "PROJECT_REACTIVATE", 0, NULL
		UNION
	SELECT "PROJECT_DISABLED_PENDING_PROGRAM_REACTIVATION", "PROJECT_VIEW", 0, NULL
;

/* Project terminated */

INSERT INTO STATE_ACTION (state_id, action_id, raises_urgent_flag, notification_template_id)
	SELECT "PROJECT_DISABLED_COMPLETED", "PROJECT_VIEW", 0, NULL
;

/* Custom program created */

INSERT INTO STATE_ACTION (state_id, action_id, raises_urgent_flag, notification_template_id, precedence)
	SELECT "PROGRAM_APPROVAL", "PROGRAM_COMPLETE_APPROVAL_STAGE", 1, "PROGRAM_TASK_REQUEST", 1
		UNION
	SELECT "PROGRAM_APPROVAL", "PROGRAM_EMAIL_CREATOR", 0, NULL, NULL
		UNION
	SELECT "PROGRAM_APPROVAL", "PROGRAM_VIEW", 0, NULL, 0
;

/* Custom program pending correction */

INSERT INTO STATE_ACTION (state_id, action_id, raises_urgent_flag, notification_template_id, precedence)
	SELECT "PROGRAM_APPROVAL_PENDING_CORRECTION", "PROGRAM_COMPLETE_APPROVAL_STAGE", 0, NULL, 1
		UNION
	SELECT "PROGRAM_APPROVAL_PENDING_CORRECTION", "PROGRAM_EMAIL_CREATOR", 0, NULL, NULL
		UNION
	SELECT "PROGRAM_APPROVAL_PENDING_CORRECTION", "PROGRAM_EDIT", 1, "PROGRAM_TASK_REQUEST", 0
		UNION
...
INSERT INTO STATE_ACTION (state_id, action_id, raises_urgent_flag, notification_template_id)
	SELECT "PROGRAM_APPROVED", "PROGRAM_CREATE_APPLICATION", 0, NULL
		UNION
	SELECT "PROGRAM_APPROVED", "PROGRAM_CLOSE", 0, NULL
		UNION
...
INSERT INTO STATE_ACTION (state_id, action_id, raises_urgent_flag, notification_template_id)
	SELECT "PROGRAM_DEACTIVATED", "PROGRAM_CREATE_APPLICATION", 0, NULL
		UNION
	SELECT "PROGRAM_DEACTIVATED", "PROGRAM_CLOSE", 0, NULL
		UNION
...
INSERT INTO STATE_ACTION (state_id, action_id, raises_urgent_flag, notification_template_id)
	SELECT "PROGRAM_DISABLED", "PROGRAM_CREATE_APPLICATION", 0, NULL
		UNION
	SELECT "PROGRAM_DISABLED", "PROGRAM_CLOSE", 0, NULL
		UNION
	SELECT "PROGRAM_DISABLED", "PROGRAM_ESCALATE", 0, NULL
		UNION
	SELECT "PROGRAM_DISABLED", "PROGRAM_VIEW", 0, NULL
;
...
INSERT INTO STATE_ACTION (state_id, action_id, raises_urgent_flag, notification_template_id)
	SELECT "PROGRAM_DISABLED_PENDING_REACTIVATION", "PROGRAM_CREATE_APPLICATION", 0, NULL
		UNION
	SELECT "PROGRAM_DISABLED_PENDING_REACTIVATION", "PROGRAM_CLOSE", 0, NULL
		UNION
...
INSERT INTO STATE_ACTION (state_id, action_id, raises_urgent_flag, notification_template_id)
	SELECT "PROGRAM_DISABLED_PENDING_IMPORT_REACTIVATION", "PROGRAM_CREATE_APPLICATION", 0, NULL
		UNION
	SELECT "PROGRAM_DISABLED_PENDING_IMPORT_REACTIVATION", "PROGRAM_CLOSE", 0, NULL
		UNION
	...
	SELECT "PROGRAM_DISABLED_PENDING_IMPORT_REACTIVATION", "PROGRAM_REACTIVATE", 0, NULL
		UNION
	SELECT "PROGRAM_DISABLED_PENDING_IMPORT_REACTIVATION", "PROGRAM_VIEW", 0, NULL
;

/* Program terminated */

INSERT INTO STATE_ACTION (state_id, action_id, raises_urgent_flag, notification_template_id)
	SELECT "PROGRAM_DISABLED_COMPLETED", "PROGRAM_VIEW", 0, NULL
;

/* Program withdrawn */

INSERT INTO STATE_ACTION (state_id, action_id, raises_urgent_flag, notification_template_id)
	SELECT "PROGRAM_WITHDRAWN", "PROGRAM_VIEW", 0, NULL
;
