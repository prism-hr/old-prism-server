...
<head>
    ...
    <style>
        .header{background:#f5f5f5}.footer .wrapper{background:#53abd6}.footer .wrapper td{vertical-align:middle}.header-logo img{max-height:40px}img.logo{max-height:40px;float:left}.prism{vertical-align:middle}.opportunity{max-height:20px;float:left}table.columns .text-pad{padding-left:10px;padding-right:10px}table.columns .left-text-pad{padding-left:10px}table.columns .right-text-pad{padding-right:10px}@media only screen and (max-width:600px){table[class=body] .right-text-pad{padding-left:10px!important}table[class=body] .left-text-pad{padding-right:10px!important}}
    </style>
</head>
<body>
<table class="body">
                                    ...
                                    <tr>
                                        <td class="wrapper last">
                                            <table class="twelve columns">
                                                <tr>
                                                    <td class="twelve sub-columns header-logo">
                                                        <img alt="Prism" title="Prism" src="${LOGO_URL}"/>
                                                    </td>
                            ...
                            <table class="row footer">
                                <tr>
                                    <td class="wrapper">
                                        <table class="twelve columns">
                                            <tr>
                                                <td class="one left-text-pad"><img alt="Prism" title="Prism"
                                                                                   src="${IMAGES_PATH}/prism-logo.png"
                                                                                   class="logo"/></td>
                                                <td class="nine left-text-pad"><img alt="The Opportunity Portal"
                                                                                    title="The Opportunity Portal"
                                                                                    src="${IMAGES_PATH}/opportunity.gif"
                                                                                    class="opportunity"/></td>
                                                <td class="two prism"><img alt="Prism" title="Prism"
                                                                           src="${IMAGES_PATH}/prism_white.png"/></td>
                                                <td class="expander"></td>
                                            </tr>
                                        </table>
                                    </td>
