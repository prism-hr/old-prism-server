<h3 class="answer <#if comment.qualifiedForPhd??>${comment.qualifiedForPhd?string?lower_case}>">
	<span></span> Is the applicant qualified for PhD entry to UCL?
</h3>

<h3 class="answer <#if comment.englishCompentencyOk??>${comment.englishCompentencyOk?string?lower_case}>">
	<span></span> Does the applicant meeting the minimum required standard of English Language competence?
</h3>

<h3 class="answer <#if comment.homeOrOverseas??>${comment.homeOrOverseas?string?lower_case}>">
