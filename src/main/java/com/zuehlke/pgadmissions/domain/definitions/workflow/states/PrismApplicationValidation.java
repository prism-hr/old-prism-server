...
import static com.zuehlke.pgadmissions.domain.definitions.workflow.PrismRole.PrismRoleGroup.APPLICATION_PARENT_VIEWER_GROUP;
...
import static com.zuehlke.pgadmissions.domain.definitions.workflow.PrismState.PrismStateTransitionGroup.APPLICATION_WITHDRAW_SUBMITTED_TRANSITION;
...
public class PrismApplicationValidation extends PrismWorkflowState {
	...
	protected void setStateActions() {
		...
		stateActions.add(applicationViewEditValidation()); //
	...
	public static PrismStateAction applicationViewEditValidation() {
		return new PrismStateAction() //
	...
	public static PrismStateAction applicationWithdrawValidation() {
		return new PrismStateAction() //
		        ...
		        .withTransitions(APPLICATION_WITHDRAW_SUBMITTED_TRANSITION.withRoleTransitions( //
		                Lists.newArrayList(new PrismRoleTransition() //
