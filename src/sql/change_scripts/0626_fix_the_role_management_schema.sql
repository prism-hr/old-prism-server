...
ALTER TABLE ACTION
	ADD COLUMN action_closure_id VARCHAR(50),
	ADD INDEX (action_closure_id),
	ADD FOREIGN KEY (action_closure_id) REFERENCES ACTION_CLOSURE (id)
;

UPDATE ACTION
SET action_closure_id = "APPLICATION"
WHERE id IN ("CONFIRM_ELIGIBILITY", "PROVIDE_REFERENCE")
;

UPDATE ACTION
SET action_closure_id = "STATE"
WHERE id IN ("COMPLETE_VALIDATION_STAGE", "COMPLETE_REVIEW_STAGE", "COMPLETE_INTERVIEW_STAGE", 
	"COMPLETE_APPROVAL_STAGE", "MOVE_TO_DIFFERENT_STAGE", "RETRACT_INTERVIEW_AVAILABILITY", 
	"ASSIGN_INTERVIEWERS", "ASSIGN_REVIEWERS", "ASSIGN_SUPERVISORS", "CONFIRM_INTERVIEW_ARRANGEMENTS",
	"CONFIRM_OFFER_RECOMMENDATION", "CONFIRM_PRIMARY_SUPERVISION", "CONFIRM_REJECTION",
	"PROVIDE_INTERVIEW_FEEDBACK", "PROVIDE_REVIEW")
;

UPDATE ACTION
SET action_closure_id = "SUB_STATE"
WHERE id = "PROVIDE_INTERVIEW_AVAILABILITY"
;
