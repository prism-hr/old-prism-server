<header>
	...
	<nav>
		<ul>
			...
			<#if (user?? && (user.isInRole('SUPERADMINISTRATOR') || user.isInRole('ADMINISTRATOR'))) || (model.user?? && (model.user.isInRole('SUPERADMINISTRATOR') || model.user.isInRole('ADMINISTRATOR')))>
