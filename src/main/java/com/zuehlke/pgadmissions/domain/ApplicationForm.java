...
public class ApplicationForm implements Comparable<ApplicationForm>,
		FormSectionObject, FieldHandled, Serializable {
	...
	public void setSuppressStateChangeNotifications(
			Boolean suppressStateChangeNotifications) {
	...
	public boolean isModifiable() {
		if (status == ApplicationFormStatus.REJECTED
	...
	public void setEmploymentPositions(
			List<EmploymentPosition> employmentPositions) {
	...
	public PersonalDetails getPersonalDetails() {
		if (fieldHandler != null
			...
			return (PersonalDetails) fieldHandler.readObject(this, "personalDetails", personalDetails);
		}
	...
	public void setPersonalDetails(PersonalDetails personalDetails) {
		if (fieldHandler != null) {
			fieldHandler.writeObject(this, "personalDetails", this.personalDetails, personalDetails);
		}
		this.personalDetails = personalDetails;
	}

	public ProgrammeDetails getProgrammeDetails() {
		if (fieldHandler != null && programmeDetails == null) {
			return (ProgrammeDetails) fieldHandler.readObject(this, "programmeDetails", programmeDetails);
		}
	...
	public void setProgrammeDetails(ProgrammeDetails programmeDetails) {
		if (fieldHandler != null) {
			fieldHandler.writeObject(this, "programmeDetails", this.programmeDetails, programmeDetails);
		}
		this.programmeDetails = programmeDetails;
	}

	public AdditionalInformation getAdditionalInformation() {
		if (fieldHandler != null && additionalInformation == null) {
			return (AdditionalInformation) fieldHandler.readObject(this, "additionalInformation", additionalInformation);
		}
	...
	public void setAdditionalInformation(AdditionalInformation additionalInformation) {
		if (fieldHandler != null) {
			fieldHandler.writeObject(this, "additionalInformation", this.additionalInformation, additionalInformation);
		}
	...
	public List<Comment> getVisibleComments(RegisteredUser user) {
		...
		if (user.isInRole(Authority.APPLICANT)) {
			for (Comment comment : applicationComments) {
				if (comment instanceof InterviewVoteComment
		...
		if (user.isRefereeOfApplicationForm(this)
				&& !user.hasStaffRightsOnApplicationForm(this)) {
			for (Comment comment : applicationComments) {
				if (comment instanceof ReferenceComment
						&& ((ReferenceComment) comment).getReferee().getUser()
	...
	public boolean shouldOpenFirstSection() {
		return isNull(programmeDetails, personalDetails, currentAddress,
				contactAddress, personalStatement, cv, additionalInformation)
				&& isEmpty(fundings, referees, employmentPositions,
						qualifications);
	}
	...
	public boolean addNotificationRecord(NotificationRecord record) {
		for (NotificationRecord existingRecord : notificationRecords) {
			if (existingRecord.getNotificationType() == record
					.getNotificationType()) {
	...
	public String getProgramAndProjectTitle() {
		...
		return String
				.format(format, getProgram().getTitle(), getProjectTitle());
	}
