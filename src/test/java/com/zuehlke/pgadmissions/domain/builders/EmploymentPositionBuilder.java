...
public class EmploymentPositionBuilder {
    ...
    private Domicile employerDomicile;
    ...
    public EmploymentPositionBuilder domicile(Domicile employerDomicile) {
        this.employerDomicile = employerDomicile;
        return this;
    }
    ...
    public EmploymentPosition toEmploymentPosition() {
        ...
        Address employerAdress = new AddressBuilder().address1(employerAdress1).address2(employerAdress2).address3(employerAdress3).address4(employerAdress4)
                        .address5(employerAdress5).domicile(employerDomicile).build();
