...
public class SupervisorNotificationTaskTest {
	...
	@Test
	public void shouldGetSupervisorsAndSendNotifications() throws UnsupportedEncodingException {
		...
		EasyMock.expect(supervisorDAOMock.getSupervisorsDueNotification()).andReturn(supervisorList);
		
		transactionOne.commit();

		mailServiceMock.sendSupervisorNotification(supervisorOne);
		supervisorDAOMock.save(supervisorOne);
		transactionTwo.commit();

		mailServiceMock.sendSupervisorNotification(supervisorTwo);
