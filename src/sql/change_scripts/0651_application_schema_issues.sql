...
INSERT INTO NOTIFICATION_TEMPLATE (id, notification_type_id)
VALUES ("APPLICATION_TERMINATE_NOTIFICATION", "INDIVIDUAL")
;

INSERT INTO NOTIFICATION_TEMPLATE_VERSION (notification_template_id, subject, content)
	SELECT "APPLICATION_TERMINATE_NOTIFICATION", subject, content
	FROM NOTIFICATION_TEMPLATE_VERSION INNER JOIN NOTIFICATION_TEMPLATE
		ON NOTIFICATION_TEMPLATE.notification_template_version_id = NOTIFICATION_TEMPLATE_VERSION.id
	WHERE NOTIFICATION_TEMPLATE.id = "APPLICATION_CONFIRM_REJECTION_NOTIFICATION"
;

UPDATE NOTIFICATION_TEMPLATE
SET notification_template_version_id = LAST_INSERT_ID()
WHERE id = "APPLICATION_TERMINATE_NOTIFICATION"
;
...
INSERT INTO STATE_ACTION_NOTIFICATION
	...
	WHERE action_id = "APPLICATION_CONFIRM_REJECTION"
		UNION
	SELECT NULL, id, "APPLICATION_CREATOR", "APPLICATION_TERMINATE_NOTIFICATION"
	FROM STATE_ACTION
...
INSERT INTO STATE_ACTION_NOTIFICATION
	...
	SELECT NULL, STATE_ACTION.id, ROLE.id, "PROGRAM_UPDATE_NOTIFICATION"
	FROM STATE_ACTION INNER JOIN ROLE
	WHERE STATE_ACTION.action_id = "PROGRAM_ESCALATE"
		AND STATE_ACTION.state_id LIKE "PROGRAM_DISABLED%"
		AND STATE_ACTION.state_id != "PROGRAM_DISABLED_COMPLETED"
		AND ROLE.id IN ("SYSTEM_ADMINISTRATOR", "INSTITUTION_ADMINISTRATOR", "PROGRAM_ADMINISTRATOR")
		UNION
	SELECT NULL, STATE_ACTION.id, ROLE.id, "PROGRAM_UPDATE_NOTIFICATION"
	FROM STATE_ACTION INNER JOIN ROLE
...
INSERT INTO STATE_ACTION_NOTIFICATION
	...
	SELECT NULL, STATE_ACTION.id, ROLE.id, "PROJECT_UPDATE_NOTIFICATION"
	FROM STATE_ACTION INNER JOIN ROLE
	WHERE STATE_ACTION.action_id = "PROJECT_ESCALATE"
		AND STATE_ACTION.state_id LIKE "PROJECT_DISABLED%"
		AND STATE_ACTION.state_id != "PROJECT_DISABLED_COMPLETED"
		AND ROLE.id IN ("SYSTEM_ADMINISTRATOR", "INSTITUTION_ADMINISTRATOR", 
			"PROGRAM_ADMINISTRATOR", "PROJECT_ADMINISTRATOR")
		UNION
	SELECT NULL, STATE_ACTION.id, ROLE.id, "PROJECT_UPDATE_NOTIFICATION"
	FROM STATE_ACTION INNER JOIN ROLE
	WHERE STATE_ACTION.action_id = "PROJECT_TERMINATE"
		AND ROLE.id IN ("SYSTEM_ADMINISTRATOR", "INSTITUTION_ADMINISTRATOR", 
			"PROGRAM_ADMINISTRATOR", "PROJECT_ADMINISTRATOR")
		UNION
	SELECT NULL, STATE_ACTION.id, ROLE.id, "PROJECT_UPDATE_NOTIFICATION"
	FROM STATE_ACTION INNER JOIN ROLE
	WHERE STATE_ACTION.action_id = "PROJECT_RESTORE"
		AND ROLE.id IN ("SYSTEM_ADMINISTRATOR", "INSTITUTION_ADMINISTRATOR", 
			"PROGRAM_ADMINISTRATOR", "PROJECT_ADMINISTRATOR")
;
