...
public enum PrismDisplayPropertyDefinition implements PrismConfigurationCategorizable<PrismDisplayPropertyCategory> {
	...
	SYSTEM_RESOURCE_CONFIGURATION_PROGRAM_TYPE_HINT(
	...
	SYSTEM_RESOURCE_CONFIGURATION_LOCALE_HINT(
	        SYSTEM_HTML_RESOURCE_CONFIGURATION,
	        "The language and culture that you wish to define configuration for. To improve experience for your uers you may wish to provide custom configurations for the locales that you support."),
	...
	SYSTEM_TRANSLATIONS_CONFIGURATION_HEADER(SYSTEM_HTML_TRANSLATIONS_CONFIGURATION, "Translations: {{title}}"),
