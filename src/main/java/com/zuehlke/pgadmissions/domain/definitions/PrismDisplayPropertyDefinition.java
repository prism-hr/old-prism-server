...
public enum PrismDisplayPropertyDefinition implements PrismConfigurationCategorizable<PrismDisplayPropertyCategory> {
    ...
    SYSTEM_RESOURCE_TARGETS_INCOMPLETE(SYSTEM_RESOURCE_SECTION,
            "Tell us which organizations you want to target with your advert, so that we can find the best candidates for you"),
    ...
    SYSTEM_RESOURCE_COMPETENCES_INCOMPLETE(SYSTEM_RESOURCE_SECTION,
            "Tell us what kind of people you want to target with your advert, so that we can find the best mix of skills and capabilities for your organization"),
    ...
    SYSTEM_RESOURCE_TARGETS_COMPETENCES_HINT(PrismDisplayPropertyCategory.SYSTEM_RESOURCE_TARGETS,
            "Specify the competences that you are looking for in your applicants."),
    ...
    SYSTEM_RESOURCE_TARGETS_SUBJECT_AREAS_HINT(PrismDisplayPropertyCategory.SYSTEM_RESOURCE_TARGETS,
