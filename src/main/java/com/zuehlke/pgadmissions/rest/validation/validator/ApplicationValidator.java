...
public class ApplicationValidator extends LocalValidatorFactoryBean implements Validator {
    ...
    private void validateStartDate(Application application, ApplicationProgramDetail programDetail, Errors errors) {
        if (programDetail != null) {
            ...
            AdvertStudyOption studyOption = programService.getEnabledAdvertStudyOption(program, programDetail.getStudyOption());

            if (studyOption == null) {
                List<AdvertStudyOption> otherStudyOptions = programService.getAdvertEnabledProgramStudyOptions(program);
