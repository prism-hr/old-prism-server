	    ...
	    <div>
	        ...
	        <ul>
	            <#list metadata.relatedInstitutions.resources as relatedInstitution>
	                <li><a href="${metadata.applicationUrl}/#!/?institution=${relatedInstitution.id?c}">${relatedInstitution.name}</a></li>
	            </#list>
	        </ul>
	    </div>
	    <#else>
		        ...
		        <div>
		            ...
		            <ul>
		                <#list metadata.relatedPrograms.resources as relatedProgram>
		                    <li><a href="${metadata.applicationUrl}/#!/?program=${relatedProgram.id?c}">${relatedProgram.name}</a></li>
		                </#list>
		            </ul>
		        </div>
	        </#if>
		        ...
		        <div>
		            ...
		            <ul>
		                <#list metadata.relatedProjects.resources as relatedProject>
		                    <li><a href="${metadata.applicationUrl}/#!/?project=${relatedProject.id?c}">${relatedProject.name}</a></li>
		                </#list>
		            </ul>
		        </div>
	        </#if>
