...
public class ApplicationFormValidatorTest {
	...
	public void setup() throws ParseException {
		...
		applicationForm = new ApplicationFormBuilder().program(program).programmeDetails(programmeDetails)
				.personalDetails(new PersonalDetailsBuilder().id(1).toPersonalDetails()).currentAddress(new Address()).contactAddress(new Address())
				.referees(new Referee(), new Referee(), new Referee()).personalStatement(new Document()).toApplicationForm();
	}
