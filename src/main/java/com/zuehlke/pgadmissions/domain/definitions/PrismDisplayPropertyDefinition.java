...
public enum PrismDisplayPropertyDefinition implements PrismConfigurationCategorizable<PrismDisplayPropertyCategory> {
    ...
    SYSTEM_ACTION_APPLICATION_COMPLETE_STAGE(SYSTEM_ACTION, "Complete Stage / Start New Stage"),
    ...
    SYSTEM_ADVERTISE_BUTTON_CREATE_PROGRAM(SYSTEM_ADVERTISE_SECTION, "Create Program"),
    SYSTEM_ADVERTISE_BUTTON_CREATE_PROJECT(SYSTEM_ADVERTISE_SECTION, "Create Project"),
