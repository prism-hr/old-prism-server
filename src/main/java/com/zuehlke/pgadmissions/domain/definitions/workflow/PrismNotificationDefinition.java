...
public enum PrismNotificationDefinition {
    ...
    PROJECT_SPONSOR_NOTIFICATION(INDIVIDUAL, UPDATE, PROJECT, //
            Lists.newArrayList(INSTITUTION_GLOBAL, PROGRAM_GLOBAL, PROJECT_GLOBAL, COMMENT_GLOBAL, TEMPLATE_GLOBAL)), //
    ...
    PROGRAM_SPONSOR_NOTIFICATION(INDIVIDUAL, UPDATE, PROGRAM, //
            Lists.newArrayList(INSTITUTION_GLOBAL, PROGRAM_GLOBAL, COMMENT_GLOBAL, TEMPLATE_GLOBAL)), //
    ...
    INSTITUTION_SPONSOR_NOTIFICATION(INDIVIDUAL, UPDATE, INSTITUTION, //
            Lists.newArrayList(INSTITUTION_GLOBAL, COMMENT_GLOBAL, TEMPLATE_GLOBAL)), //
