...
public class SubmitApplicationFormController {
    ...
    public String submitApplication(@Valid ApplicationForm application, BindingResult result, HttpServletRequest request) {
        ...
        applicationService.submitApplication(application, request);
    ...
    public ApplicationForm getApplicationForm(@RequestParam String applicationId) {
        return applicationService.getSecuredApplication(applicationId, ApplicationFormAction.COMPLETE_APPLICATION);
    }
