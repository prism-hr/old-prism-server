...
public enum PrismRoleGroup {
    ...
    PROJECT_ENDORSER_GROUP(INSTITUTION_ADMINISTRATOR, DEPARTMENT_ADMINISTRATOR, PROGRAM_ADMINISTRATOR, PROJECT_ADMINISTRATOR, PROJECT_APPROVER, PROJECT_VIEWER), //
    PROJECT_STAFF_GROUP(PROJECT_ADMINISTRATOR, PROJECT_APPROVER, PROJECT_VIEWER), //
