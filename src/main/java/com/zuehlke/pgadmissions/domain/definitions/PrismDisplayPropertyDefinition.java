...
public enum PrismDisplayPropertyDefinition implements PrismConfigurationCategorizable<PrismDisplayPropertyCategory> {
    ...
    SYSTEM_ACTION_INSTITUTION_PROVIDE_SPONSORSHIP(SYSTEM_ACTION, "Provide Sponsorship"),
    ...
    SYSTEM_ACTION_PROGRAM_PROVIDE_SPONSORSHIP(SYSTEM_ACTION, "Provide Sponsorship"),
    ...
    SYSTEM_ACTION_PROJECT_PROVIDE_SPONSORSHIP(SYSTEM_ACTION, "Provide Sponsorship"),
    ...
    SYSTEM_RESOURCE_PARENT_ALLOW_NEW(SYSTEM_ADVERTISE_SECTION, "Allow New"),
    SYSTEM_RESOURCE_PARENT_ALLOW_PARTNERS_CREATE(SYSTEM_ADVERTISE_SECTION, "Allow partners to create"),
