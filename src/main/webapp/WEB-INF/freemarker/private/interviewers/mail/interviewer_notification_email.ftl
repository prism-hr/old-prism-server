			...
			<tr>
		  	...
		  	<tr>
		    	...
		    	<td width="500">
			      	...
			      	<p>
			      		<font face="Arial, Helvetica, sans-serif" size="2">The interview will take place at ${interviewer.interview.interviewDueDate?datetime("hh:mm a")} on ${interviewer.interview.interviewDueDate?datetime("dd/MM/yyyy")}.</font>
			      	</p>
			      	<p>
