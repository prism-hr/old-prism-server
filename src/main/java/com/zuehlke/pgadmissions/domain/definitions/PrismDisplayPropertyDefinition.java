...
public enum PrismDisplayPropertyDefinition implements PrismConfigurationCategorizable<PrismDisplayPropertyCategory> {
    ...
    SYSTEM_REGISTER_TARGET_INSTITUTION(SYSTEM_GLOBAL, "Target this Institution"),
    SYSTEM_REGISTER_TARGET_DEPARTMENT(SYSTEM_GLOBAL, "Target this Department"),
    ...
    SYSTEM_RESOURCE_UNIVERSITIES_TARGETS_HEADER(SYSTEM_RESOURCE_SECTION, "Target Universities"),
