...
UPDATE STATE_TRANSITION_EVALUATION
SET id = "PROGRAM_EVALUATED_OUTCOME"
...
UPDATE STATE_TRANSITION
SET state_transition_evaluation_id = "PROGRAM_EVALUATED_OUTCOME"
WHERE state_transition_evaluation_id = "PROGRAM_CREATED_OUTCOME"
;
