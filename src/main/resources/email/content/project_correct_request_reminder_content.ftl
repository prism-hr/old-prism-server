...
<p>
    This is a reminder that your request to create a new ${TEMPLATE_SYSTEM_TITLE} Project ${PROJECT_CODE} has been reviewed.
</p>
...
<p>
	We will continue to remind you about this until you action our request or withdraw your Project.
</p>
