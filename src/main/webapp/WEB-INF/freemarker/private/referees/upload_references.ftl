		    	...
		    	<article id="content" role="main">
		      		...
		      		<div class="content-box">
		      			<div class="content-box-inner">
			        		...
			        		<p>You can view ${model.referee.application.applicant.firstName}'s application <a href="<@spring.url '/application?view=view&id=${model.referee.application.id?string("######")}' />" target="_blank">here</a></p>
