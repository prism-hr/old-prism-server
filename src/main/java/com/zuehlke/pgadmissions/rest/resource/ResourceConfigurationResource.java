...
public class ResourceConfigurationResource {
    ...
    public List<DisplayPropertyConfigurationRepresentation> getDisplayPropertyConfigurations(
        ...
        List<WorkflowConfigurationRepresentation> translations = customizationService.getConfigurationRepresentationsTranslationMode(configurationType,
                resource, scope, locale, programType, category);
        return sparsifyDisplayPropertyConfigurations(category, translations);
    }
    ...
    public List<WorkflowConfigurationRepresentation> getConfigurations(
        ...
        Resource resource = entityService.getById(resourceDescriptor.getType(), resourceId);
        return customizationService.getConfigurationRepresentations(configurationType, resource, locale, programType, scope);
    }
    ...
    public Integer getWorkflowPropertyConfigurationVersion(@ModelAttribute PrismConfiguration configurationType,
            ...
            @RequestParam(required = false) PrismLocale locale, @RequestParam(required = false) PrismProgramType programType) throws Exception {
        Resource resource = entityService.getById(resourceDescriptor.getType(), resourceId);
        return customizationService.getActiveConfigurationVersion(configurationType, resource, locale, programType, scope);
    }
