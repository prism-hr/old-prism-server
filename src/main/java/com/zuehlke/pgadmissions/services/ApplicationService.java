...
public class ApplicationService {
	...
	public <T extends Resource> List<Application> getUserAdministratorApplications(User user, HashMultimap<PrismScope, T> userAdministratorResources) {
		return userAdministratorResources.isEmpty() ? Lists.<Application> newArrayList() : applicationDAO.getUserAdministratorApplications(user,
		        userAdministratorResources);
	}
