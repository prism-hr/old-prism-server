...
public enum PrismDisplayPropertyDefinition implements PrismConfigurationCategorizable<PrismDisplayPropertyCategory> {
    ...
    SYSTEM_RESOURCE_PARENT_ACCEPT_DEPARTMENT(SYSTEM_ADVERTISE_SECTION, "Accept new Divisions"),
    SYSTEM_RESOURCE_PARENT_ACCEPT_PROGRAM(SYSTEM_ADVERTISE_SECTION, "Accept new Programs"),
    SYSTEM_RESOURCE_PARENT_ACCEPT_PROJECT(SYSTEM_ADVERTISE_SECTION, "Accept new Positions"),
