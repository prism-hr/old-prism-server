...
VALUES ("APPLICATION_ESCALATE", "APPLICATION_ESCALATE", 0),
	...
	("PROGRAM_CONCLUDE", "PROGRAM_CONCLUDE", 0),
	("PROJECT_CONCLUDE", "PROJECT_CONCLUDE", 0),
	("APPLICATION_TERMINATE", "APPLICATION_TERMINATE", 0),
	("PROJECT_TERMINATE", "PROJECT_TERMINATE", 0),
	("PROJECT_SUSPEND", "PROJECT_SUSPEND", 0),
	("SYSTEM_CREATE_INSTITUTION", "SYSTEM_CREATE_INSTITUTION", 0)
;
...
INSERT INTO STATE_ACTION (state_id, action_id, raises_urgent_flag)
	SELECT "PROJECT_APPROVED", "PROJECT_CREATE_APPLICATION", 0
		UNION
	SELECT "PROJECT_APPROVED", "PROJECT_CONCLUDE", 0
		UNION
...
INSERT INTO STATE_ACTION (state_id, action_id, raises_urgent_flag)
	SELECT "PROJECT_DEACTIVATED", "PROJECT_CONCLUDE", 0
		UNION
...
INSERT INTO STATE_ACTION (state_id, action_id, raises_urgent_flag)
	SELECT "PROJECT_DISABLED_PENDING_COMPLETION", "PROJECT_CONCLUDE", 0
		UNION
...
INSERT INTO STATE_ACTION (state_id, action_id, raises_urgent_flag, notification_template_id)
	SELECT "PROJECT_DISABLED_PENDING_REACTIVATION", "PROJECT_CONCLUDE", 0, NULL
		UNION
...
INSERT INTO STATE_ACTION (state_id, action_id, raises_urgent_flag)
	SELECT "PROJECT_DISABLED_PENDING_PROGRAM_REACTIVATION", "PROJECT_CONCLUDE", 0
		UNION
...
INSERT INTO STATE_ACTION (state_id, action_id, raises_urgent_flag)
	SELECT "PROGRAM_APPROVED", "PROGRAM_CREATE_APPLICATION", 0
		UNION
	SELECT "PROGRAM_APPROVED", "PROGRAM_CONCLUDE", 0
		UNION
...
INSERT INTO STATE_ACTION (state_id, action_id, raises_urgent_flag)
	SELECT "PROGRAM_DEACTIVATED", "PROGRAM_CONCLUDE", 0
		UNION
...
INSERT INTO STATE_ACTION (state_id, action_id, raises_urgent_flag)
	SELECT "PROGRAM_DISABLED", "PROGRAM_CONCLUDE", 0
		UNION
...
INSERT INTO STATE_ACTION (state_id, action_id, raises_urgent_flag, notification_template_id)
	SELECT "PROGRAM_DISABLED_PENDING_REACTIVATION", "PROGRAM_CONCLUDE", 0, NULL
		UNION
...
INSERT INTO STATE_ACTION (state_id, action_id, raises_urgent_flag)
	SELECT "PROGRAM_DISABLED_PENDING_IMPORT_REACTIVATION", "PROGRAM_CONCLUDE", 0
		UNION
...
INSERT INTO STATE_ACTION (state_id, action_id, raises_urgent_flag)
	SELECT "SYSTEM_APPROVED", "SYSTEM_CONFIGURE", 0
		UNION
	SELECT "SYSTEM_APPROVED", "SYSTEM_CREATE_INSTITUTION", 0
;
