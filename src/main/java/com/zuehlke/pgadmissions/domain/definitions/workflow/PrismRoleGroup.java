...
public enum PrismRoleGroup {
    ...
    PROJECT_VIEWER_GROUP(PROJECT_APPROVER, PROJECT_VIEWER), //
    ...
    PROGRAM_VIEWER_GROUP(PROGRAM_APPROVER, PROGRAM_VIEWER), //
    ...
    PARTNERSHIP_MANAGER_GROUP(INSTITUTION_ADMINISTRATOR, INSTITUTION_APPROVER, DEPARTMENT_ADMINISTRATOR, DEPARTMENT_APPROVER);
