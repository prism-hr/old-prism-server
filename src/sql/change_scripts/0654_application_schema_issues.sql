CREATE TABLE STATE_TRANSITION_EVALUATION (
	...
	SELECT "APPLICATION_COMPLETED_OUTCOME"
		UNION
	SELECT "APPLICATION_ACCEPTED_OUTCOME"
;
...
INSERT INTO ROLE_TRANSITION (state_transition_id, role_id, role_transition_type_id, minimum_required, maximum_required, restrict_to_invoker)
...
INSERT INTO STATE_TRANSITION (state_action_id, state_transition_type_id, transition_state_id, state_transition_evaluation_id, do_post_comment)
	SELECT id, "PROPAGATION", "PROGRAM_DEACTIVATED", "APPLICATION_ACCEPTED_OUTCOME", 1
	FROM STATE_ACTION
	WHERE action_id = "PROGRAM_CLOSE"
		AND state_id NOT LIKE "%DISABLED%"
		UNION
	SELECT id, "PROPAGATION", "PROGRAM_DISABLED_COMPLETED", NULL, 1
	FROM STATE_ACTION
	WHERE action_id = "PROGRAM_CLOSE"
		AND state_id LIKE "%DISABLED%"
;
...
INSERT INTO ROLE_TRANSITION (state_transition_id, role_id, role_transition_type_id, transition_role_id, minimum_required, maximum_required, restrict_to_invoker)
	SELECT STATE_TRANSITION.id, "APPLICATION_CREATOR", "CREATE", 1, 1, 1
	FROM STATE_TRANSITION INNER JOIN STATE_ACTION
		ON STATE_TRANSITION.state_action_id = STATE_ACTION.id
...
INSERT INTO STATE_TRANSITION (state_action_id, state_transition_type_id, transition_state_id, state_transition_evaluation_id, do_post_comment)
	SELECT id, "PROPAGATION", "PROJECT_DEACTIVATED", "APPLICATION_ACCEPTED_OUTCOME", 1
	FROM STATE_ACTION
	WHERE action_id = "PROJECT_CLOSE"
		AND state_id NOT LIKE "%DISABLED%"
		UNION
	SELECT id, "PROPAGATION", "PROJECT_DISABLED_COMPLETED", NULL, 1
	FROM STATE_ACTION
	WHERE action_id = "PROJECT_CLOSE"
		AND state_id LIKE "%DISABLED%"
;
...
CREATE TABLE STATE_TRANSITION_PROPAGATION (
	...
	INNER JOIN STATE_ACTION
		ON STATE_TRANSITION.state_action_id = STATE_ACTION.id
	INNER JOIN STATE_ACTION AS PROPAGATED_STATE_TRANSITION
		ON PROPAGATED_STATE_TRANSITION.state_action_id = STATE_ACTION.id
	WHERE STATE_ACTION.action_id = "APPLICATION_CONFIRM_OFFER_RECOMMENDATION"
		AND PROPAGATED_STATE_ACTION.action_id IN ("PROGRAM_CLOSE", "PROJECT_CLOSE")
		UNION
	SELECT NULL AS id, STATE_TRANSITION.id AS state_transition_id, 
		PROPAGATED_STATE_TRANSITION.id AS propagated_state_transition_id
	FROM STATE_TRANSITION INNER JOIN STATE_TRANSITION AS PROPAGATED_STATE_TRANSITION
	...
	INNER JOIN STATE_ACTION AS PROPAGATED_STATE_TRANSITION
		ON PROPAGATED_STATE_TRANSITION.state_action_id = STATE_ACTION.id
	WHERE STATE_ACTION.action_id IN ("PROJECT_CLOSE", "PROGRAM_CLOSE")
		AND PROPAGATED_STATE_ACTION.action_id IN ("APPLICATION_ESCALATE")
		AND PROPAGATED_STATE_TRANSITION.state_transition_type_id = "PROPAGATION" 
;
