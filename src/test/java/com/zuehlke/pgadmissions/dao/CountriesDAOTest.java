...
public class CountriesDAOTest extends AutomaticRollbackTestCase{
	...
	public void shouldGetAllCountriesInAlhphabeticalOrder() {
		...
		Country country1 = new CountryBuilder().enabled(true).name("ZZZZZZ").toCountry();		
		Country country2 = new CountryBuilder().enabled(true).name("AAAAAAAA").toCountry();
	...
	public void shouldGetCountryById(){
		...
		Country country1 = new CountryBuilder().enabled(true).name("ZZZZZZ").toCountry();
		Country country2 = new CountryBuilder().enabled(true).name("mmmmmm").toCountry();
