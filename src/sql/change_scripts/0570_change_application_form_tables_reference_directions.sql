...
-- programme details
ALTER TABLE APPLICATION_FORM
 ADD COLUMN programme_details_id INT(10) UNSIGNED
;
...
SET APPLICATION_FORM.programme_details_id = APPLICATION_FORM_PROGRAMME_DETAIL.id
;

ALTER TABLE APPLICATION_FORM_PROGRAMME_DETAIL
 DROP FOREIGN KEY application_form_programme_details_fk,
 DROP COLUMN application_form_id
;

ALTER TABLE APPLICATION_FORM
 ADD INDEX (programme_details_id),
 ADD CONSTRAINT application_form_programme_details_fk FOREIGN KEY (programme_details_id) REFERENCES APPLICATION_FORM_PROGRAMME_DETAIL (id)
;
