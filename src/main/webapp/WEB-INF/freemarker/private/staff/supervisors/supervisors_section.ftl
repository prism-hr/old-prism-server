...
<section class="form-rows"  id="approvalsection">
    ...
    <div>
		...
		<div class=
			...
			Assign Supervisors. You must nominate a primary and secondary supervisor and provide a description of the project and your recommended offer to the applicant.
		</div>
