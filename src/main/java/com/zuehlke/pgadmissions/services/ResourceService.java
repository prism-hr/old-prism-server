...
public class ResourceService {
    ...
    public ActionOutcomeDTO createResource(User user, Action action, Object resourceDTO, String referrer, Integer workflowPropertyConfigurationVersion) throws Exception {
