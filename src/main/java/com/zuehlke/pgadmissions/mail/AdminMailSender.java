...
public class AdminMailSender extends StateChangeMailSender {
    ...
    public AdminMailSender(MimeMessagePreparatorFactory mimeMessagePreparatorFactory, JavaMailSender mailSender, MessageSource msgSource,
            ConfigurationService personService, EmailTemplateService emailTemplateService) {
    ...
    @Override
    public void sendMailsForApplication(ApplicationForm form, String messageCode, EmailTemplateName templateName, String templateContent,
    ...
    public void sendApproverApprovalReminder(ApplicationForm form, String messageCode, EmailTemplateName templateName, String templateContent,
    ...
    private void internalSend(ApplicationForm applicationForm, String messageCode, EmailTemplateName templateName, String templateContent,
            Map<String, Object> model) {
    ...
    void internalSend(ApplicationForm form, List<RegisteredUser> recipients, String messageCode, EmailTemplateName templateName, String templateContent,
            Map<String, Object> model, boolean ccIfApplicationAdmin) {
        RegisteredUser applicationAdmin = form.getApplicationAdministrator();
        ApplicationFormStatus previousStage = form.getOutcomeOfStage();

        String subject = resolveMessage(messageCode, form, previousStage);
        if (applicationAdmin == null || !applicationAdmin.isEnabled() || !ccIfApplicationAdmin) {
    ...
    private void delegateToMailSender(InternetAddress toAddress, InternetAddress[] ccAddresses, String subject, EmailTemplateName templateName,
            String templateContent, Map<String, Object> model) {
        MimeMessagePreparator msgPreparator = mimeMessagePreparatorFactory.getMimeMessagePreparator(toAddress, ccAddresses, subject, templateName,
                templateContent, model, null);
