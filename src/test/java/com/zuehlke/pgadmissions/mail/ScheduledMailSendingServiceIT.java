...
public class ScheduledMailSendingServiceIT {
    ...
    public void setup() {
        ...
        template.execute(new TransactionCallbackWithoutResult() {
            ...
            protected void doInTransactionWithoutResult(TransactionStatus status) {
                ...
                EmailTemplate mailTemplate = new EmailTemplateBuilder()
                    .subject("whatever")
                    .name(EmailTemplateName.REFEREE_REMINDER)
                    .content("whatever content")
                    .active(true)
                    .build();
                
                RegisteredUser refereeUser1 = new RegisteredUserBuilder()
                     .email("amanda@mail.com")
                     .firstName("Amanda")
                     .lastName("Frijelloce")
                     .build();
                RegisteredUser refereeUser2 = new RegisteredUserBuilder()
                    .email("nina@mail.com")
                    .firstName("Nina")
                    .lastName("Sinalefe")
                    .build();
                RegisteredUser refereeUser3 = new RegisteredUserBuilder()
                    .email("gina@mail.com")
                    .firstName("Gina")
                    .lastName("Round")
                    .build();
                RegisteredUser programAdmin = new RegisteredUserBuilder()
                    .email("jeppetto@mail.com")
                    .build();
                ...
                Program program = new ProgramBuilder()
                    .administrators(programAdmin)
                    .title("ProgramTitle")
                    .build();
                
                ApplicationForm application1 = new ApplicationFormBuilder()
                    .applicant(applicant)
                    .program(program)
                    .applicationNumber("sampelNumber")
                    .status(ApplicationFormStatus.INTERVIEW)
                    .build();
                
                application2 = new ApplicationFormBuilder()
                .applicant(applicant)
                .program(program)
                .applicationNumber("sampelNumber")
                .status(ApplicationFormStatus.INTERVIEW)
                ...
                referee1 = new RefereeBuilder()
                    .declined(false)
                    .application(application1)
                    .user(refereeUser1)
                    .reference(new ReferenceCommentBuilder().build())
                    .lastNotified(lastNotified.toDate())
                    .build();
                referee2 = new RefereeBuilder()
                    .declined(false)
                ...
                saveObjects(interval, mailTemplate, refereeUser1, refereeUser2, refereeUser3,
                        programAdmin, applicant, program, application1, application2, referee1, referee2, referee3);
    ...
    class CustomMailSender extends MailSender {
        ...
        CustomMailSender() {
            this(service.getMailSender().javaMailSender, "false", "pgadmissions.jenkins@zuhlke.com"," uclprism@gmail.com",
                    service.getMailSender().getEmailTemplateService(), service.getMailSender().getFreemarkerConfig());
        }

        public CustomMailSender(JavaMailSender javaMailSender, String production, String emailAddressFrom,
                String emailAddressTo, EmailTemplateService emailTemplateService, FreeMarkerConfig freemarkerConfig) {
