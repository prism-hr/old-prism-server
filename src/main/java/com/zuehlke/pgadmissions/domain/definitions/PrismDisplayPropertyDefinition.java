...
public enum PrismDisplayPropertyDefinition implements PrismConfigurationCategorizable<PrismDisplayPropertyCategory> {
    ...
    SYSTEM_STATE_GROUP_PROJECT_APPROVAL_PARTNER_INSTITUTION(SYSTEM_STATE_GROUP, "Partner Institution Initialization"),
    ...
    SYSTEM_STATE_GROUP_PROGRAM_APPROVAL_PARTNER_INSTITUTION(SYSTEM_STATE_GROUP, "Partner Institution Initialization"),
    ...
    SYSTEM_ADVERTISE_AS_PARTNER_INSTITUTION_LABEL(SYSTEM_ADVERTISE_SECTION, "Advertise as Partner Organization"),
    SYSTEM_ADVERTISE_AS_PARTNER_INSTITUTION_HINT(SYSTEM_ADVERTISE_SECTION, "Check this box if you want to advertise as a partner organization"),
