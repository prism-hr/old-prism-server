...
public class CommentDTO {
    ...
    private AdvertApplicableDTO program;

    private AdvertApplicableDTO project;
    ...
    public AdvertApplicableDTO getProgram() {
        return program;
    }

    public void setProgram(AdvertApplicableDTO program) {
        this.program = program;
    }

    public AdvertApplicableDTO getProject() {
        return project;
    }

    public void setProject(AdvertApplicableDTO project) {
    ...
    public AdvertDTO fetchResourceDTO() {
        return (AdvertDTO) PrismReflectionUtils.getProperty(this, action.getScope().getLowerCamelName());
    }
