...
public enum PrismDisplayPropertyDefinition implements PrismConfigurationCategorizable<PrismDisplayPropertyCategory> {
    ...
    SYSTEM_ADVERT_DOMAIN_PRECLINICAL_MEDICINE(SYSTEM_ADVERT_DOMAIN, "Prelinical Medicine"), //
    ...
    SYSTEM_ADVERT_DOMAIN_OPTHALMICS(SYSTEM_ADVERT_DOMAIN, "Opthalmics"), //
    ...
    SYSTEM_DISPLAY_CATEGORY_SYSTEM_PROGRAM_TYPE(SYSTEM_DISPLAY_PROPERTY_CATEGORY, "Program Type"),
    ...
    SYSTEM_DISPLAY_CATEGORY_SYSTEM_HTML_TRANSLATIONS_CONFIGURATION(SYSTEM_DISPLAY_PROPERTY_CATEGORY, "Translations Configuration"),
