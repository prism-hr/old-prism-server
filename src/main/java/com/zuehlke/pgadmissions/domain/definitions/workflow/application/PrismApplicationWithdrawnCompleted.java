...
import static com.zuehlke.pgadmissions.domain.definitions.workflow.PrismStateTransitionGroup.APPLICATION_WITHDRAWN_PURGED_TRANSITION;
...
public class PrismApplicationWithdrawnCompleted extends PrismWorkflowState {
	...
	protected void setStateActions() {
		...
		stateActions.add(applicationPurge(APPLICATION_WITHDRAWN_PURGED_TRANSITION)); //
