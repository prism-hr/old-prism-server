    ...
    <form>
				...
				<#if errorCode?? && errorCode=="true">
			 	...
			 	<#else>
				 	<div id="emp-info-bar-div" class="section-info-bar">
						<div class="row">
							<span id="emp-info-bar-span" class="info-text">
								<@spring.message 'employmentDetails.sectionInfo'/> 
							</span>
						</div>
					</div>	
        ...
        <div class="row-group">
            ...
            <div class="row">
	            ...
	            <div class="row">
	            	<div class="field">
	                	<a id="addPosisionButton" class="button blue">Submit</a>
	                </div>
	            </div>
           		</#if>
			</div>
	       ...
	       <div class="row-group terms-box">
			...
			<div class="buttons">
				<#if !applicationForm.isDecided() && !applicationForm.isWithdrawn()>
            		<a class="button" type="button" id="positionCancelButton" name="positionCancelButton">Clear</a>
