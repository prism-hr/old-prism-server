		    	...
		    	<td width="500">
			      	...
			      	<p>
			      		<#if !previousStage?? || (previousStage.displayValue() = "Validation")>
			      		  <font face="Arial, Helvetica, sans-serif" size="2">We are pleased to inform you that your application has been advanced to academic assessment. We aim to be back in contact with the outcome of this assessment by close of business on ${application.dueDate?string("dd MMMM yyyy")}.</font>
			            <#else>
			      		  <font face="Arial, Helvetica, sans-serif" size="2">In order to obtain further feedback on your application it has been advanced to a second stage of academic assessment. We aim to be back in contact with the outcome of this assessment by close of business on ${application.dueDate?string("dd MMMM yyyy")}.</font>
			            </#if>
			      	</p>
			      	<p>
