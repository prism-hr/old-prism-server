...
public class QualificationTypeDAOTest extends AutomaticRollbackTestCase {
    ...
    public void shouldGetNationalityByIdOnlyEnabled() {
        ...
        QualificationType dom1 = new QualificationTypeBuilder().enabled(false).name("AAAAA").code("AA").toQualificationTitle();
        QualificationType dom2 = new QualificationTypeBuilder().enabled(true).name("BBBBB").code("BB").toQualificationTitle();
