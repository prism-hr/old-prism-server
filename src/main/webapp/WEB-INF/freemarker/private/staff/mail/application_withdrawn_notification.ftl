			...
			<tr>
		  	...
		  	<tr>
		    	...
		    	<td width="500">
			      	...
			      	<p>
			      		<font face="Arial, Helvetica, sans-serif" size="2">${applicant.firstName} ${applicant.lastName} has withdrawn Application ${application.applicationNumber} for UCL 
			        ...
			        <p>
			          <!-- Button -->
						<a style="text-decoration:none;" href="${host}/pgadmissions/application?view=view&applicationId=${application.applicationNumber}&activationCode=${user.activationCode}" title="View Application">
