...
INSERT INTO STATE_TRANSITION (state_action_id, state_transition_type_id, transition_state_id, state_transition_evaluation_id)
	...
	WHERE STATE.parent_state_id = "APPLICATION_UNSUBMITTED"
		...
		UNION
	SELECT STATE_ACTION.id, "ONE_COMPLETED", TRANSITION_STATE.id, "APPLICATION_PROCESSED_OUTCOME"
	FROM STATE_ACTION INNER JOIN STATE
		ON STATE_ACTION.state_id = STATE.id
	...
	WHERE STATE.parent_state_id IN ("APPLICATION_VALIDATION", "APPLICATION_REVIEW", "APPLICATION_INTERVIEW", "APPLICATION_APPROVAL")
		...
		UNION
	SELECT STATE_ACTION.id, "ONE_COMPLETED", STATE.id, "APPLICATION_PROCESSED_OUTCOME"
	FROM STATE_ACTION INNER JOIN STATE
...
INSERT INTO STATE_TRANSITION (state_action_id, state_transition_type_id, transition_state_id, state_transition_evaluation_id)
	...
	WHERE STATE.parent_state_id = "APPLICATION_UNSUBMITTED"
		...
		UNION
	SELECT STATE_ACTION.id, "PROPAGATION", TRANSITION_STATE.id, "APPLICATION_PROCESSED_OUTCOME"
	FROM STATE_ACTION INNER JOIN STATE
		ON STATE_ACTION.state_id = STATE.id
	INNER JOIN STATE AS TRANSITION_STATE
	WHERE STATE.parent_state_id IN ("APPLICATION_VALIDATION", "APPLICATION_REVIEW", "APPLICATION_INTERVIEW", "APPLICATION_APPROVAL")
		...
		UNION
	SELECT STATE_ACTION.id, "PROPAGATION", STATE.id, "APPLICATION_PROCESSED_OUTCOME"
	FROM STATE_ACTION INNER JOIN STATE
	WHERE STATE_ACTION.state_id IN ("APPLICATION_APPROVED", "APPLICATION_REJECTED")
		AND STATE_ACTION.action_id = "APPLICATION_ESCALATE"
...
INSERT INTO STATE_TRANSITION (state_action_id, state_transition_type_id, transition_state_id, state_transition_evaluation_id, display_order)
	SELECT id, "ONE_COMPLETED", "APPLICATION_REVIEW", "APPLICATION_PROGRESSED_OUTCOME", 0
	FROM STATE_ACTION
	WHERE action_id IN ("APPLICATION_COMPLETE_VALIDATION_STAGE", "APPLICATION_COMPLETE_REVIEW_STAGE", 
		...
		UNION
	SELECT id, "ONE_COMPLETED", "APPLICATION_INTERVIEW", "APPLICATION_PROGRESSED_OUTCOME", 1
	FROM STATE_ACTION
	WHERE action_id IN ("APPLICATION_COMPLETE_VALIDATION_STAGE", "APPLICATION_COMPLETE_REVIEW_STAGE", 
		"APPLICATION_COMPLETE_INTERVIEW_STAGE", "APPLICATION_COMPLETE_APPROVAL_STAGE")
		UNION
	SELECT id, "ONE_COMPLETED", "APPLICATION_APPROVAL", "APPLICATION_PROGRESSED_OUTCOME", 2
	FROM STATE_ACTION
	WHERE action_id IN ("APPLICATION_COMPLETE_VALIDATION_STAGE", "APPLICATION_COMPLETE_REVIEW_STAGE", 
		"APPLICATION_COMPLETE_INTERVIEW_STAGE", "APPLICATION_COMPLETE_APPROVAL_STAGE")
		UNION
	SELECT id, "ONE_COMPLETED", "APPLICATION_APPROVED", "APPLICATION_PROGRESSED_OUTCOME", 3
	FROM STATE_ACTION
	WHERE action_id IN ("APPLICATION_COMPLETE_VALIDATION_STAGE", "APPLICATION_COMPLETE_REVIEW_STAGE", 
		"APPLICATION_COMPLETE_INTERVIEW_STAGE", "APPLICATION_COMPLETE_APPROVAL_STAGE")
		UNION
	SELECT id, "ONE_COMPLETED", "APPLICATION_REJECTED", "APPLICATION_PROGRESSED_OUTCOME", 4
	FROM STATE_ACTION
	WHERE action_id IN ("APPLICATION_COMPLETE_VALIDATION_STAGE", "APPLICATION_COMPLETE_REVIEW_STAGE", 
		"APPLICATION_COMPLETE_INTERVIEW_STAGE", "APPLICATION_COMPLETE_APPROVAL_STAGE")
;
...
INSERT INTO STATE_TRANSITION (state_action_id, state_transition_type_id, transition_state_id, state_transition_evaluation_id, display_order)
	SELECT id, "ONE_COMPLETED", "APPLICATION_INTERVIEW", "APPLICATION_PROGRESSED_OUTCOME", 0
	FROM STATE_ACTION
	WHERE action_id = "APPLICATION_MOVE_TO_DIFFERENT_STAGE"
		AND state_id = "APPLICATION_REVIEW"
		UNION
	SELECT id, "ONE_COMPLETED", "APPLICATION_APPROVAL", "APPLICATION_PROGRESSED_OUTCOME", 1
	FROM STATE_ACTION
	WHERE action_id = "APPLICATION_MOVE_TO_DIFFERENT_STAGE"
		AND state_id = "APPLICATION_REVIEW"
		UNION		
	SELECT id, "ONE_COMPLETED", "APPLICATION_APPROVED", "APPLICATION_PROGRESSED_OUTCOME", 2
	FROM STATE_ACTION
	WHERE action_id = "APPLICATION_MOVE_TO_DIFFERENT_STAGE"
		AND state_id = "APPLICATION_REVIEW"
		UNION
	SELECT id, "ONE_COMPLETED", "APPLICATION_REJECTED", "APPLICATION_PROGRESSED_OUTCOME", 3
	FROM STATE_ACTION
	WHERE action_id = "APPLICATION_MOVE_TO_DIFFERENT_STAGE"
		AND state_id = "APPLICATION_REVIEW"
		UNION
...
INSERT INTO STATE_TRANSITION (state_action_id, state_transition_type_id, transition_state_id, state_transition_evaluation_id)
	SELECT id, "ONE_COMPLETED", "APPLICATION_APPROVED_PENDING_EXPORT", "APPLICATION_PROCESSED_OUTCOME"
	FROM STATE_ACTION
	WHERE action_id = "APPLICATION_CONFIRM_OFFER_RECOMMENDATION"
		UNION
	SELECT id, "ONE_COMPLETED", "APPLICATION_APPROVED_COMPLETED", "APPLICATION_PROCESSED_OUTCOME"
	FROM STATE_ACTION
	WHERE action_id = "APPLICATION_CONFIRM_OFFER_RECOMMENDATION"
;
...
INSERT INTO STATE_TRANSITION (state_action_id, state_transition_type_id, transition_state_id, state_transition_evaluation_id)
	SELECT id, "ONE_COMPLETED", "APPLICATION_REJECTED_PENDING_EXPORT", "APPLICATION_PROCESSED_OUTCOME"
	FROM STATE_ACTION
	WHERE action_id = "APPLICATION_CONFIRM_REJECTION"
		UNION
	SELECT id, "ONE_COMPLETED", "APPLICATION_REJECTED_COMPLETED", "APPLICATION_PROCESSED_OUTCOME"
	FROM STATE_ACTION
	WHERE action_id = "APPLICATION_CONFIRM_REJECTION"
;
...
INSERT INTO STATE_TRANSITION (state_action_id, state_transition_type_id, transition_state_id, state_transition_evaluation_id)
	SELECT id, "PROPAGATION", "PROGRAM_APPROVED", "PROGRAM_REJOINED_OUTCOME"
	FROM STATE_ACTION
	WHERE action_id = "PROGRAM_REACTIVATE"
		UNION
	SELECT id, "PROPAGATION", "PROGRAM_DEACTIVATED", "PROGRAM_REJOINED_OUTCOME"
	FROM STATE_ACTION
	WHERE action_id = "PROGRAM_REACTIVATE"
;
...
INSERT INTO STATE_TRANSITION (state_action_id, state_transition_type_id, transition_state_id, state_transition_evaluation_id)
	SELECT id, "PROPAGATION", "PROJECT_APPROVED", "PROJECT_REJOINED_OUTCOME"
	FROM STATE_ACTION
	WHERE state_id = "PROJECT_DISABLED_PENDING_PROGRAM_REACTIVATION"
		AND action_id = "PROJECT_REACTIVATE"
		UNION
	SELECT id, "PROPAGATION", "PROJECT_DEACTIVATED", "PROJECT_REJOINED_OUTCOME"
	FROM STATE_ACTION
	WHERE state_id = "PROJECT_DISABLED_PENDING_PROGRAM_REACTIVATION"
		AND action_id = "PROJECT_REACTIVATE"
		UNION
	SELECT id, "PROPAGATION", "PROJECT_DISABLED_PENDING_REACTIVATION", "PROJECT_REJOINED_OUTCOME"
	FROM STATE_ACTION
	WHERE state_id = "PROJECT_DISABLED_PENDING_PROGRAM_REACTIVATION"
		AND action_id = "PROJECT_REACTIVATE"
;
...
CREATE TABLE STATE_TRANSITION_PROPAGATION (
	...
	WHERE STATE_TRANSITION.transition_state_id IN ("PROGRAM_APPROVED", "PROGRAM_DEACTIVATED")
		...
		AND PROPAGATED_STATE_TRANSITION.state_transition_evaluation_id = "PROJECT_REJOINED_OUTCOME"
		UNION
	SELECT NULL AS id, STATE_TRANSITION.id AS state_transition_id, 
		PROPAGATED_STATE_TRANSITION.id AS propagated_state_transition_id
	FROM STATE_TRANSITION INNER JOIN STATE_TRANSITION AS PROPAGATED_STATE_TRANSITION
