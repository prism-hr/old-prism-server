...
public class EthnicitesImporter implements Importer {
	...
	private static final Logger log = Logger.getLogger(EthnicitesImporter.class);
	...
	private List<EthnicityAdapter> createAdapter(Ethnicities ethnicities) {
		...
		for (com.zuehlke.pgadmissions.referencedata.jaxb.Ethnicities.Ethnicity ethnicity : ethnicities.getEthnicity()) {
