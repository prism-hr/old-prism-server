...
public enum PrismRole implements PrismLocalizableDefinition {
    ...
    PROJECT_ENQUIRER(RECRUITER, false, PROJECT), //
    ...
    PROGRAM_ENQUIRER(RECRUITER, false, PROGRAM), //
    ...
    DEPARTMENT_ENQUIRER(RECRUITER, false, DEPARTMENT), //
    ...
    INSTITUTION_ENQUIRER(RECRUITER, false, INSTITUTION), //
