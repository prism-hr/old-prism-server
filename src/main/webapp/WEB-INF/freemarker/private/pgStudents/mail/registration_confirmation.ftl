			...
			<tr>
		  	...
		  	<tr>
		    	...
		    	<td width="500">
			      	...
			      	<p>
			      		<font face="Arial, Helvetica, sans-serif" size="2">Thank you for your registration for UCL Prism. To login and <#if user.isInRole('APPLICANT')>complete your application<#elseif !user.directToUrl??>continue<#elseif user.directToUrl == 'ADD_REFERENCE'>complete your reference<#elseif ser.directToUrl == 'ADD_REVIEW'>complete your review<#elseif ser.directToUrl == 'VIEW_APPLIATION_PRIOR_TO_INTERVIEW'>view the application<#elseif ser.directToUrl == 'VIEW_APPLIATION_AS_SUPERVISOR'>view the application</#if> please confirm your registration. You will be asked to login.</font>
			      	</p>
