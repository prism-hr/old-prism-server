...
import static com.zuehlke.pgadmissions.domain.definitions.PrismDisplayPropertyDefinition.APPLICATION_RESERVE_DURATION_LABEL;
import static com.zuehlke.pgadmissions.domain.definitions.PrismDisplayPropertyDefinition.APPLICATION_RESERVE_DURATION_TOOLTIP;
...
public enum PrismStateDurationDefinition implements PrismConfigurationLocalizable {
	...
	APPLICATION_CONFIRM_SUPERVISION_DURATION(3, false, APPLICATION, APPLICATION_CONFIRM_SUPERVISION_DURATION_LABEL,
	        APPLICATION_CONFIRM_SUPERVISION_DURATION_TOOLTIP), //
	...
	APPLICATION_RESERVE_DURATION(84, true, APPLICATION, APPLICATION_RESERVE_DURATION_LABEL, APPLICATION_RESERVE_DURATION_TOOLTIP), //
	APPLICATION_PURGE_DURATION(364, false, APPLICATION, APPLICATION_PURGE_DURATION_LABEL, APPLICATION_PURGE_DURATION_TOOLTIP), //
