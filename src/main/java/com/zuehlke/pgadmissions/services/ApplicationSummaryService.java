...
public class ApplicationSummaryService {
	...
	private void addApplicationProperties(final ApplicationForm form,
		...
		ApplicationActionsDefinition actionsDefinition = applicationsService
				.getActionsDefinition(userService.getCurrentUser(), form);
		result.put("requiresAttention", BooleanUtils
				.toStringTrueFalse(actionsDefinition.isRequiresAttention()));
	}
