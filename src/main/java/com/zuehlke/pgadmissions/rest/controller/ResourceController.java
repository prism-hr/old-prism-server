...
public class ResourceController {
    ...
    @PreAuthorize("isAuthenticated()")
    public UserRepresentationSimple addUser(
            @PathVariable Integer resourceId, @ModelAttribute ResourceDescriptor resourceDescriptor, @RequestBody ResourceUserRolesRepresentation userRolesRepresentation) {
        Resource resource = resourceService.getById(resourceDescriptor.getType(), resourceId);
