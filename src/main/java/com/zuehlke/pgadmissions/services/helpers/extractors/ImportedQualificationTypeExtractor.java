...
@Component
public class ImportedQualificationTypeExtractor implements ImportedEntityExtractor {
    ...
    public List<String> extract(Institution institution, PrismImportedEntity prismImportedEntity, List<Object> definitions) throws Exception {
        ...
        for (Object definition : definitions) {
            Qualification qualification = (Qualification) definition;
            ...
            cells.add(prepareStringForSqlInsert(qualification.getCode()));
            cells.add(prepareStringForSqlInsert(qualification.getName()));
