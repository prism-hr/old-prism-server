...
<h2 id="referee-H2" class="empty open"> <span class="left"></span><span class="right"></span><span class="status"></span> References<em>*</em> </h2>
  ...
  <form>
    ...
    <div class="row-group"> 
      ...
      <div class="row">
        ...
        <#if referee.editable && (applicationForm.referees?size &lt; 3 || referee.id??) > "plain-label"
        <#else>
    ...
    <div class="row-group"> 
      ...
      <!-- Address body -->
       ...
       <h3 class=
        <#if referee.editable && (applicationForm.referees?size &lt; 3 || referee.id??) > "group-heading-label"
          <#else>
      ...
      <label for="ref_address_location1" class=
        ...
        <div class="field"> 
        <input type="text" class="max" id="ref_address_location1" name="ref_address_location1" value="${(referee.addressLocation.address1?html)!}"
      ...
      <label for="ref_address_location5" class=
        ...
        <div class="field"> 
        	<input type="text" class="full" id="ref_address_location5" name="ref_address_location5" value="${(referee.addressLocation.address5?html)!}"
          <#if !referee.editable || !(applicationForm.referees?size &lt; 3 || referee.id??) >
          readonly="readonly" disabled="disabled"
          </#if>
          /> 
      ...
      <!-- Country -->
      <div class="row"> 
      <#if referee.editable && (applicationForm.referees?size &lt; 3 || referee.id??) > <span class="plain-label">Country<em>*</em></span> <span class="hint" data-desc="<@spring.message 'referee.country'/>"></span>
        <div class="field">
        ...
        <#else> <span class="plain-label grey-label">Country</span> <span class="hint"></span>
        <div class="field">
    ...
    <div class="row-group"> 
      ...
      <div class="row"> <span class="plain-label">Email<em>*</em></span> <span class="hint" data-desc="<@spring.message 'referee.email'/>"></span>
        <div class="field">
      ...
      <div class="row"> <span class="plain-label grey-label">Email</span> <span class="hint"></span>
        <div class="field">
      ...
      <!-- Telephone -->
      <div class="row"> <#if referee.editable && (applicationForm.referees?size &lt; 3 || referee.id??) > <span class="plain-label">Telephone<em>*</em></span> <span class="hint" data-desc="<@spring.message 'referee.telephone'/>"></span>
        <div class="field">
        ...
        <#else> <span class="plain-label grey-label">Telephone</span> <span class="hint"></span>
        <div class="field">
      ...
      <!-- Skype address -->
      <div class="row"> <#if referee.editable && (applicationForm.referees?size &lt; 3 || referee.id??) > <span class="plain-label">Skype Name</span> <span class="hint" data-desc="<@spring.message 'referee.skype'/>"></span>
        <div class="field">
