			...
			<tr>
		  	...
		  	<tr>
		    	...
		    	<td width="500">
			      	...
			      	<p>
			      		<font face="Arial, Helvetica, sans-serif" size="2">An admissions officer will now make a preliminary assessment of your suitability. We aim to be back in contact with the outcome of this assessment by close of business on ${application.dueDate?datetime("dd/MM/yyyy")}.
			      	</p>
			      	<p>
