...
public class AdvertService {
    ...
    public void updateFinancialDetail(Advert advert, AdvertFinancialDetailDTO payDTO) {
        if (payDTO == null) {
            ...
            pay.setPaymentOption(payDTO.getPaymentOption());
    ...
    public void updateApplicationOptions(PrismScope resourceScope, Integer resourceId, ResourceSettingsDTO applicationOptionsDTO) {
        ResourceParent resource = (ResourceParent) resourceService.getById(resourceScope, resourceId);
        Advert advert = resource.getAdvert();
