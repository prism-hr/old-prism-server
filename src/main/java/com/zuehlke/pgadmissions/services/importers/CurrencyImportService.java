...
public class CurrencyImportService {
    ...
    private static final Logger log = LoggerFactory.getLogger(CurrencyImportService.class);
    ...
    public void importEntities() throws DataImportException {
        CurrencyImportService thisBean = applicationContext.getBean(CurrencyImportService.class);
