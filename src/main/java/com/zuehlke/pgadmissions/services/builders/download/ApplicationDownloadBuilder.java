...
import static com.zuehlke.pgadmissions.domain.definitions.PrismDisplayProperty.APPLICATION_ADDITIONAL_INFORMATION_CONVICTION;
import static com.zuehlke.pgadmissions.domain.definitions.PrismDisplayProperty.APPLICATION_ADDITIONAL_INFORMATION_HEADER;
import static com.zuehlke.pgadmissions.domain.definitions.PrismDisplayProperty.APPLICATION_ADDRESS_CONTACT;
import static com.zuehlke.pgadmissions.domain.definitions.PrismDisplayProperty.APPLICATION_ADDRESS_CURRENT;
...
import static com.zuehlke.pgadmissions.domain.definitions.PrismDisplayProperty.APPLICATION_EMPLOYMENT_POSITION_IS_CURRENT;
import static com.zuehlke.pgadmissions.domain.definitions.PrismDisplayProperty.APPLICATION_EMPLOYMENT_POSITION_REMIT;
import static com.zuehlke.pgadmissions.domain.definitions.PrismDisplayProperty.APPLICATION_EMPLOYMENT_POSITION_SUBHEADER;
import static com.zuehlke.pgadmissions.domain.definitions.PrismDisplayProperty.APPLICATION_END_DATE;
import static com.zuehlke.pgadmissions.domain.definitions.PrismDisplayProperty.APPLICATION_FUNDING_APPENDIX;
import static com.zuehlke.pgadmissions.domain.definitions.PrismDisplayProperty.APPLICATION_FUNDING_DESCRIPTION;
import static com.zuehlke.pgadmissions.domain.definitions.PrismDisplayProperty.APPLICATION_FUNDING_HEADER;
import static com.zuehlke.pgadmissions.domain.definitions.PrismDisplayProperty.APPLICATION_FUNDING_SUBHEADER;
import static com.zuehlke.pgadmissions.domain.definitions.PrismDisplayProperty.APPLICATION_FUNDING_TYPE;
import static com.zuehlke.pgadmissions.domain.definitions.PrismDisplayProperty.APPLICATION_FUNDING_VALUE;
import static com.zuehlke.pgadmissions.domain.definitions.PrismDisplayProperty.APPLICATION_HEADER;
import static com.zuehlke.pgadmissions.domain.definitions.PrismDisplayProperty.APPLICATION_LANGUAGE_QUALIFICATION_APPENDIX;
import static com.zuehlke.pgadmissions.domain.definitions.PrismDisplayProperty.APPLICATION_LANGUAGE_QUALIFICATION_EXAM_DATE;
import static com.zuehlke.pgadmissions.domain.definitions.PrismDisplayProperty.APPLICATION_LANGUAGE_QUALIFICATION_HEADER;
import static com.zuehlke.pgadmissions.domain.definitions.PrismDisplayProperty.APPLICATION_LANGUAGE_QUALIFICATION_LISTENING_SCORE;
import static com.zuehlke.pgadmissions.domain.definitions.PrismDisplayProperty.APPLICATION_LANGUAGE_QUALIFICATION_OVERALL_SCORE;
import static com.zuehlke.pgadmissions.domain.definitions.PrismDisplayProperty.APPLICATION_LANGUAGE_QUALIFICATION_READING_SCORE;
import static com.zuehlke.pgadmissions.domain.definitions.PrismDisplayProperty.APPLICATION_LANGUAGE_QUALIFICATION_SPEAKING_SCORE;
import static com.zuehlke.pgadmissions.domain.definitions.PrismDisplayProperty.APPLICATION_LANGUAGE_QUALIFICATION_WRITING_SCORE;
import static com.zuehlke.pgadmissions.domain.definitions.PrismDisplayProperty.APPLICATION_PASSPORT_EXPIRY_DATE;
import static com.zuehlke.pgadmissions.domain.definitions.PrismDisplayProperty.APPLICATION_PASSPORT_HEADER;
import static com.zuehlke.pgadmissions.domain.definitions.PrismDisplayProperty.APPLICATION_PASSPORT_ISSUE_DATE;
import static com.zuehlke.pgadmissions.domain.definitions.PrismDisplayProperty.APPLICATION_PASSPORT_NAME;
import static com.zuehlke.pgadmissions.domain.definitions.PrismDisplayProperty.APPLICATION_PASSPORT_NUMBER;
...
import static com.zuehlke.pgadmissions.domain.definitions.PrismDisplayProperty.APPLICATION_POSITION_TITLE;
import static com.zuehlke.pgadmissions.domain.definitions.PrismDisplayProperty.APPLICATION_PROGRAM_DETAIL_HEADER;
import static com.zuehlke.pgadmissions.domain.definitions.PrismDisplayProperty.APPLICATION_PROOF_OF_AWARD;
import static com.zuehlke.pgadmissions.domain.definitions.PrismDisplayProperty.APPLICATION_QUALIFICATION_APPENDIX;
import static com.zuehlke.pgadmissions.domain.definitions.PrismDisplayProperty.APPLICATION_QUALIFICATION_CONFIRMED_AWARD_DATE;
import static com.zuehlke.pgadmissions.domain.definitions.PrismDisplayProperty.APPLICATION_QUALIFICATION_CONFIRMED_RESULT;
import static com.zuehlke.pgadmissions.domain.definitions.PrismDisplayProperty.APPLICATION_QUALIFICATION_COUNTRY;
import static com.zuehlke.pgadmissions.domain.definitions.PrismDisplayProperty.APPLICATION_QUALIFICATION_EXPECTED_AWARD_DATE;
import static com.zuehlke.pgadmissions.domain.definitions.PrismDisplayProperty.APPLICATION_QUALIFICATION_EXPECTED_RESULT;
import static com.zuehlke.pgadmissions.domain.definitions.PrismDisplayProperty.APPLICATION_QUALIFICATION_FINAL_TRANSCRIPT;
import static com.zuehlke.pgadmissions.domain.definitions.PrismDisplayProperty.APPLICATION_QUALIFICATION_HEADER;
import static com.zuehlke.pgadmissions.domain.definitions.PrismDisplayProperty.APPLICATION_QUALIFICATION_LANGUAGE;
import static com.zuehlke.pgadmissions.domain.definitions.PrismDisplayProperty.APPLICATION_QUALIFICATION_PROVIDER;
...
import static com.zuehlke.pgadmissions.domain.definitions.PrismDisplayProperty.APPLICATION_REFERRAL_SOURCE;
import static com.zuehlke.pgadmissions.domain.definitions.PrismDisplayProperty.APPLICATION_START_DATE;
import static com.zuehlke.pgadmissions.domain.definitions.PrismDisplayProperty.APPLICATION_SUBMISSION_DATE;
...
import static com.zuehlke.pgadmissions.domain.definitions.PrismDisplayProperty.INSTITUTION_HEADER;
import static com.zuehlke.pgadmissions.domain.definitions.PrismDisplayProperty.PROGRAM_HEADER;
import static com.zuehlke.pgadmissions.domain.definitions.PrismDisplayProperty.PROGRAM_STUDY_OPTION;
import static com.zuehlke.pgadmissions.domain.definitions.PrismDisplayProperty.PROJECT_HEADER;
import static com.zuehlke.pgadmissions.domain.definitions.PrismDisplayProperty.SYSTEM_ADDRESS;
import static com.zuehlke.pgadmissions.domain.definitions.PrismDisplayProperty.SYSTEM_APPENDIX;
import static com.zuehlke.pgadmissions.domain.definitions.PrismDisplayProperty.SYSTEM_AVERAGE_RATING;
import static com.zuehlke.pgadmissions.domain.definitions.PrismDisplayProperty.SYSTEM_CLOSING_DATE;
...
import static com.zuehlke.pgadmissions.domain.definitions.PrismDisplayProperty.SYSTEM_PAGE;
import static com.zuehlke.pgadmissions.domain.definitions.PrismDisplayProperty.SYSTEM_SEE;
...
import static com.zuehlke.pgadmissions.domain.definitions.PrismDisplayProperty.SYSTEM_VALUE_PROVIDED;
...
public class ApplicationDownloadBuilder {
    ...
    private void addCoverPage(Application application, Document pdfDocument, PdfWriter writer) throws MalformedURLException, IOException, DocumentException {
        ...
        applicationDownloadBuilderHelper.addContentRowMedium(propertyLoader.load(APPLICATION_CREATOR), application.getUser().getDisplayName(), body);
    ...
    private void addPersonalDetailSection(ApplicationDownloadDTO applicationDownloadDTO, Document pdfDocument) throws DocumentException {
        ...
        applicationDownloadBuilderHelper.addContentRowMedium(propertyLoader.load(PrismDisplayProperty.APPLICATION_PERSONAL_DETAIL_DATE_OF_BIRTH),
    ...
    private void addAddressSection(Application application, Document pdfDocument) throws DocumentException {
        PdfPTable body = applicationDownloadBuilderHelper.startSection(pdfDocument, propertyLoader.load(PrismDisplayProperty.APPLICATION_ADDRESS_HEADER));
        ...
        if (qualifications.isEmpty()) {
            ...
            for (ApplicationQualification qualification : qualifications) {
                ...
                addDocument(subBody, propertyLoader.load(APPLICATION_QUALIFICATION_FINAL_TRANSCRIPT,
                        PrismDisplayProperty.APPLICATION_QUALIFICATION_INTERIM_TRANSCRIPT, completed), qualification.getDocument(),
