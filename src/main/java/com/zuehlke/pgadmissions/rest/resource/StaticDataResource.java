...
public class StaticDataResource {
    ...
    public Map<String, Object> getStaticData() {
        ...
        staticData.put("configurationTypes", configurationTypes);
        ...
        for (PrismNotificationDefinition template : PrismNotificationDefinition.values()) {
            ...
            if (template.getDefaultReminderDuration() != null) {
                definition.put("reminderTemplate", template.getReminderDefinition().name());
            }
