    ...
    <article id="content" role="main"> 
      ...
      <div class="content-box">
        <div class="content-box-inner">
        	<div id="prospectus">
         		<ul class="tabs">				
					<li class="current"><a id="projectsBtn" href="#projects">Projects</a></li>
					<li><a id="ProgrammesBtn" href="#programes">Programmes</a></li>
				</ul>
                <div id="projects" class="tab-page">
               	<p> content projects</p>
                </div>
                <div id="programes" class="tab-page">
               	<p> content programes</p>
                </div>
             </div>
          </div>
        <!-- .content-box-inner --> 
