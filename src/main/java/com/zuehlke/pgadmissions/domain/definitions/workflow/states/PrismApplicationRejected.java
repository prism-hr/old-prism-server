            ...
            .withNotificationTemplate(PrismNotificationDefinition.SYSTEM_APPLICATION_TASK_REQUEST) //
                ...
                .withNotifications(Arrays.asList( //
                    new PrismStateActionNotification() //
                        ...
                        .withDefinition(PrismNotificationDefinition.APPLICATION_CONFIRM_REJECTION_NOTIFICATION), //
                    new PrismStateActionNotification() //
                        .withRole(PrismRole.INSTITUTION_ADMINISTRATOR) //
                        .withDefinition(PrismNotificationDefinition.SYSTEM_APPLICATION_UPDATE_NOTIFICATION), //
                    new PrismStateActionNotification() //
                ...
                .withTransitions(Arrays.asList( //
                    new PrismStateTransition() //
                        ...
                        .withStateTransitionEvaluation(PrismStateTransitionEvaluation.APPLICATION_REJECTED_OUTCOME) //
