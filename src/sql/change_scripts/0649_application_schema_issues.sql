...
INSERT INTO STATE_ACTION (state_id, action_id, raises_urgent_flag)
	SELECT "PROJECT_DEACTIVATED", "PROJECT_CREATE_APPLICATION", 0
		UNION
...
INSERT INTO STATE_ACTION (state_id, action_id, raises_urgent_flag)
	SELECT "PROJECT_DISABLED_PENDING_COMPLETION", "PROJECT_CREATE_APPLICATION", 0
		UNION
...
INSERT INTO STATE_ACTION (state_id, action_id, raises_urgent_flag)
	SELECT "PROJECT_DISABLED_PENDING_PROGRAM_REACTIVATION", "PROJECT_CREATE_APPLICATION", 0
		UNION
	...
	SELECT "PROJECT_DISABLED_PENDING_PROGRAM_REACTIVATION", "PROJECT_TERMINATE", 0
		UNION
	SELECT "PROJECT_DISABLED_PENDING_PROGRAM_REACTIVATION", "PROJECT_REACTIVATE", 0
		UNION
...
INSERT INTO STATE_ACTION (state_id, action_id, raises_urgent_flag)
	SELECT "PROGRAM_DEACTIVATED", "PROGRAM_CREATE_APPLICATION", 0
		UNION
...
INSERT INTO STATE_ACTION (state_id, action_id, raises_urgent_flag)
	SELECT "PROGRAM_DISABLED", "PROGRAM_CREATE_APPLICATION", 0
		UNION
...
INSERT INTO STATE_ACTION (state_id, action_id, raises_urgent_flag)
	SELECT "PROGRAM_DISABLED_PENDING_IMPORT_REACTIVATION", "PROGRAM_CREATE_APPLICATION", 0
		UNION
	...
	SELECT "PROGRAM_DISABLED_PENDING_IMPORT_REACTIVATION", "PROGRAM_ESCALATE", 0
		UNION
	SELECT "PROGRAM_DISABLED_PENDING_IMPORT_REACTIVATION", "PROGRAM_REACTIVATE", 0
		UNION
