...
public class ResourceController {
    ...
    public List<ResourceRepresentationIdentity> getResourcesForWhichUserCanCreateResource(
        ...
        return resourceService.getResourcesForWhichUserCanCreateResource(enclosingResource, responseScope, creationScope, q.orElse(null)).stream()
                .map(resourceMapper::getResourceRepresentationIdentity).collect(Collectors.toList());
    }
