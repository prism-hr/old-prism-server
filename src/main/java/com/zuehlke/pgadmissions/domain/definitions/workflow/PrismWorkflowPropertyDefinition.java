...
public enum PrismWorkflowPropertyDefinition {
    ...
    APPLICATION_ASSIGN_ADMITTER(APPLICATION_WORKFLOW, null, null, true, null, null, APPLICATION), //
    APPLICATION_ASSIGN_REFEREE(APPLICATION_WORKFLOW, null, null, true, null, null, APPLICATION), //
    APPLICATION_ASSIGN_REVIEWER(APPLICATION_WORKFLOW, 1, 0, true, 1, 0, APPLICATION), //
    APPLICATION_ASSIGN_INTERVIEWER(APPLICATION_WORKFLOW, 1, 0, true, 1, 0, APPLICATION), //
    APPLICATION_ASSIGN_PRIMARY_SUPERVISOR(APPLICATION_WORKFLOW, 1, 1, true, 1, 1, APPLICATION), //
    APPLICATION_ASSIGN_SECONDARY_SUPERVISOR(APPLICATION_WORKFLOW, 1, 1, true, 1, 1, APPLICATION), //
    APPLICATION_POSITION_DETAIL(APPLICATION_WORKFLOW, null, null, true, null, null, APPLICATION), //
    APPLICATION_OFFER_DETAIL(APPLICATION_WORKFLOW, null, null, true, null, null, APPLICATION), //
