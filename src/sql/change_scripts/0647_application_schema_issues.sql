...
INSERT INTO STATE
	...
	SELECT "APPLICATION_WITHDRAWN_COMPLETED", "APPLICATION_WITHDRAWN", 0
		UNION
	SELECT "APPLICATION_WITHDRAWN_UNSUBMITTED", "APPLICATION_WITHDRAWN", 0
		UNION
...
WHERE state_id = "APPLICATION_WITHDRAWN"
	AND is_exported = 1
	AND last_state_id != "APPLICATION_UNSUBMITTED"
;

UPDATE APPLICATION
SET state_id = "APPLICATION_WITHDRAWN_UNSUBMITTED"
WHERE state_id = "APPLICATION_WITHDRAWN"
	AND last_state_id = "APPLICATION_UNSUBMITTED"
;
...
INSERT INTO ROLE
	...
	SELECT "APPLICATION_VIEWER_RECRUITER", 0, NULL
		UNION
	SELECT "APPLICATION_INTERVIEW_PARTICIPANT_INTERVIEWEE", 0, "APPLICATION_APPLICANT"
		UNION
	SELECT "APPLICATION_INTERVIEW_PARTICIPANT_INTERVIEWER", 0, "APPLICATION_VIEWER_RECRUITER"
		UNION
...
INSERT INTO USER_ROLE (application_id, user_id, role_id, requesting_user_id, assigned_timestamp)
	SELECT APPLICATION.id, APPLICATION.user_id, "APPLICATION_INTERVIEW_PARTICIPANT_INTERVIEWEE", ADVERT.user_id, INTERVIEW.created_date
...
INSERT INTO USER_ROLE (application_id, user_id, role_id, requesting_user_id, assigned_timestamp)
	SELECT APPLICATION.id, INTERVIEW_PARTICIPANT.user_id, "APPLICATION_INTERVIEW_PARTICIPANT_INTERVIEWER", ADVERT.user_id, INTERVIEW.created_date
	FROM APPLICATION INNER JOIN ADVERT
		ON APPLICATION.program_id = ADVERT.id
	INNER JOIN INTERVIEW
		ON APPLICATION.latest_interview_id = INTERVIEW.id
...
INSERT IGNORE INTO USER_ROLE (institution_id, user_id, role_id, requesting_user_id)
	SELECT 5243, user_id, "INSTITUTION_PROGRAM_CREATOR", 2048
	FROM USER_ROLE
...
INSERT INTO ROLE_TRANSITION (role_id, action_id, transition_role_id)
	...
	SELECT "APPLICATION_REVIEWER", "APPLICATION_WITHDRAW", "APPLICATION_VIEWER_RECRUITER"
		UNION
	SELECT "APPLICATION_INTERVIEW_PARTICIPANT_INTERVIEWEE", "APPLICATION_CONFIRM_INTERVIEW_ARRANGEMENTS", "APPLICATION_APPLICANT"
		UNION
	SELECT "APPLICATION_INTERVIEW_PARTICIPANT_INTERVIEWEE", "APPLICATION_COMPLETE_INTERVIEW_STAGE", "APPLICATION_APPLICANT"
		UNION
	SELECT "APPLICATION_INTERVIEW_PARTICIPANT_INTERVIEWEE", "APPLICATION_WITHDRAW", "APPLICATION_APPLICANT"
		UNION
	SELECT "APPLICATION_INTERVIEW_PARTICIPANT_INTERVIEWER", "APPLICATION_CONFIRM_INTERVIEW_ARRANGEMENTS", "APPLICATION_VIEWER_RECRUITER"
		UNION
	SELECT "APPLICATION_INTERVIEW_PARTICIPANT_INTERVIEWER", "APPLICATION_COMPLETE_INTERVIEW_STAGE", "APPLICATION_VIEWER_RECRUITER"
		UNION
	SELECT "APPLICATION_INTERVIEW_PARTICIPANT_INTERVIEWER", "APPLICATION_WITHDRAW", "APPLICATION_VIEWER_RECRUITER"
		UNION
