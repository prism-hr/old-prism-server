...
public enum PrismStateGroup implements PrismLocalizableDefinition {
    ...
    PROJECT_APPROVAL_PARTNER_INSTITUTION(PROJECT), //
    PROJECT_APPROVAL_PARTNER(PROJECT), //
    ...
    PROGRAM_APPROVAL_PARTNER_INSTITUTION(PROGRAM), //
    PROGRAM_APPROVAL_PARTNER(PROGRAM), //
