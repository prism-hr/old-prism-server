...
public class ReviewerNotificationTaskTest {
	private SessionFactory sessionFactoryMock;
	private Session sessionMock;
	private ReviewerNotificationTask reviewerNotificationTask;
	...
	public void shouldGetReviewersAndSendReminders() throws UnsupportedEncodingException {
		...
		EasyMock.expect(reviewerDAOMock.getReviewersDueNotification()).andReturn(reviewerList);
		
		transactionOne.commit();

		mailServiceMock.sendReviewerNotification(reviewerOne);
		reviewerDAOMock.save(reviewerOne);
		transactionTwo.commit();

		mailServiceMock.sendReviewerNotification(reviewerTwo);
	...
	public void shouldRollBackTransactionIfExceptionOccurs() throws UnsupportedEncodingException {
		...
		sessionMock.refresh(reviewerOne);
		sessionMock.refresh(reviewerTwo);
		EasyMock.expect(reviewerDAOMock.getReviewersDueNotification()).andReturn(Arrays.asList(reviewerOne, reviewerTwo));
	...
	public void setup() {
		...
		reviewerNotificationTask = new ReviewerNotificationTask(sessionFactoryMock, mailServiceMock, reviewerDAOMock);
