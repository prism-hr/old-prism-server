...
public class EntityExportIT {
    ...
    public void exportEntities() throws Exception {
        Class[] exportClasses = new Class[]{Title.class, FundingSource.class, StudyOption.class, ImportedInstitution.class, LanguageQualificationType.class};
        String[] entityNames = new String[]{"title", "fundingSource", "studyOption", "institution", "languageQualificationType"};
