...
public class CreateNewSupervisorControllerTest {
    ...
    public void shouldCreateNewUserIfUserDoesNotExists() {
        ...
        EasyMock.expect(
                userServiceMock.createNewUserInRole("bob", "bobson", "bobson@bob.com", DirectURLsEnum.VIEW_APPLIATION_AS_SUPERVISOR, application,
                        Authority.SUPERVISOR)).andReturn(user);
