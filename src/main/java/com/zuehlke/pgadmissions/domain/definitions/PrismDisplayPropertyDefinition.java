...
public enum PrismDisplayPropertyDefinition implements PrismConfigurationCategorizable<PrismDisplayPropertyCategory> {
    ...
    SYSTEM_RESOURCE_PARENT_ACCEPT_APPLICATION_HINT(SYSTEM_ADVERTISE_SECTION, "Allow visitors to your advert to submit applications directly to you"),
    SYSTEM_RESOURCE_PARENT_ACCEPT_DEPARTMENT_LABEL(SYSTEM_ADVERTISE_SECTION, "Enable divisions"),
    SYSTEM_RESOURCE_PARENT_ACCEPT_DEPARTMENT_HINT(SYSTEM_ADVERTISE_SECTION, "Allow users to create new divisions"),
    SYSTEM_RESOURCE_PARENT_ACCEPT_PROGRAM_LABEL(SYSTEM_ADVERTISE_SECTION, "Enable programs"),
    SYSTEM_RESOURCE_PARENT_ACCEPT_PROGRAM_HINT(SYSTEM_ADVERTISE_SECTION, "Allow users to create new programs"),
    SYSTEM_RESOURCE_PARENT_ACCEPT_PROJECT_LABEL(SYSTEM_ADVERTISE_SECTION, "Enable positions"),
    SYSTEM_RESOURCE_PARENT_ACCEPT_PROJECT_HINT(SYSTEM_ADVERTISE_SECTION, "Allow users to create new positions"),
