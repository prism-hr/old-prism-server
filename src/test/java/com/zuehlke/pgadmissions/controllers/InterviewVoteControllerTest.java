...
public class InterviewVoteControllerTest {
    ...
    public void shouldNotSubmitInterviewVotesIfValidationErrors() {
        ...
        controller.submitInterviewVotes(participant, errors, null);
    }
    ...
    public void shouldSubmitInterviewVotes() {
        ...
        interviewServiceMock.postVote(participant);

        EasyMock.replay(interviewServiceMock);
        String result = controller.submitInterviewVotes(participant, errors, applicationForm);
