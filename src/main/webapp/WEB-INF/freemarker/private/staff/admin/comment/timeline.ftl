							...
							<ul class="status-info">
								...
								<li class="${timelineObject.type}">
									<div class="box">
										...
										<#if timelineObject.interview.locationURL?length &gt; 0><p class="location"><span data-desc="Location"></span><a href="${timelineObject.interview.locationURL}">${timelineObject.interview.locationURL?html}</a></p></#if>
									</div>
								</li>
							</ul>
							</#if>
