...
public class NotificationTemplateServiceTest {
    ...
    public void shouldGetById(){
        ...
        expect(daoMock.getById(PrismNotificationTemplate.APPLICATION_TASK_REQUEST)).andReturn(template);
        
        EasyMockUnitils.replay();
        
        NotificationTemplate returned = service.getById(PrismNotificationTemplate.APPLICATION_TASK_REQUEST);
