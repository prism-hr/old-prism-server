...
public enum PrismAction {
    ...
    APPLICATION_ASSIGN_INTERVIEWERS(USER_INVOCATION, PROCESS_RESOURCE, false, false, false, true, false, false, APPLICATION, null, Arrays.asList(
            ...
            .setCustomValidator(new AssignInterviewersCommentCustomValidator()).build(), null), //
    APPLICATION_ASSIGN_REVIEWERS(USER_INVOCATION, PROCESS_RESOURCE, false, false, false, true, false, false, APPLICATION, null, Arrays.asList(
            ...
            .addResolution(ASSIGNED_USERS, new PrismActionValidationFieldResolution(SIZE, "min", 1)).build(), null), //
    APPLICATION_ASSIGN_SUPERVISORS(USER_INVOCATION, PROCESS_RESOURCE, false, false, false, true, false, false, APPLICATION, null, Arrays.asList(
            new PrismActionRedaction().withRole(APPLICATION_CREATOR).withRedactionType(ALL_CONTENT), new PrismActionRedaction().withRole(APPLICATION_REFEREE)
                    .withRedactionType(ALL_CONTENT)), PrismActionValidationDefinition.builder()
            .addResolution(ASSIGNED_USERS, new PrismActionValidationFieldResolution(SIZE, "min", 2)).addResolution(POSITION_TITLE)
            .addResolution(POSITION_DESCRIPTION).addResolution(POSITION_PROVISIONAL_START_DATE, NOT_NULL).addResolution(APPOINTMENT_CONDITIONS).build(), null), //
    APPLICATION_COMMENT(USER_INVOCATION, PROCESS_RESOURCE, false, false, false, true, false, false, APPLICATION, null, Arrays.asList(new PrismActionRedaction()
            .withRole(APPLICATION_CREATOR).withRedactionType(ALL_CONTENT),
            new PrismActionRedaction().withRole(APPLICATION_REFEREE).withRedactionType(ALL_CONTENT)), PrismActionValidationDefinition.builder()
            .addResolution(CONTENT, NOT_EMPTY).addResolution(DOCUMENTS, new PrismActionValidationFieldResolution(SIZE, "min", 0)).build(), null), //
    APPLICATION_COMPLETE(USER_INVOCATION, VIEW_EDIT_RESOURCE, false, true, false, true, false, true, APPLICATION, null, null, null, null), //
    APPLICATION_COMPLETE_APPROVAL_STAGE(USER_INVOCATION, PROCESS_RESOURCE, false, true, false, true, false, false, APPLICATION, null, Arrays.asList(
            new PrismActionRedaction().withRole(APPLICATION_CREATOR).withRedactionType(ALL_CONTENT), new PrismActionRedaction().withRole(APPLICATION_REFEREE)
                    .withRedactionType(ALL_CONTENT)), PrismActionValidationDefinition.builder().addResolution(CONTENT, NOT_EMPTY)
            .addResolution(DOCUMENTS, new PrismActionValidationFieldResolution(SIZE, "min", 0)).addResolution(TRANSITION_STATE, NOT_NULL).build(), null), //
    APPLICATION_COMPLETE_INTERVIEW_STAGE(USER_INVOCATION, PROCESS_RESOURCE, false, true, false, true, false, false, APPLICATION, null, Arrays.asList(
            new PrismActionRedaction().withRole(APPLICATION_CREATOR).withRedactionType(ALL_CONTENT), new PrismActionRedaction().withRole(APPLICATION_REFEREE)
                    .withRedactionType(ALL_CONTENT)), PrismActionValidationDefinition.builder().addResolution(CONTENT, NOT_EMPTY)
            .addResolution(DOCUMENTS, new PrismActionValidationFieldResolution(SIZE, "min", 0)).addResolution(TRANSITION_STATE, NOT_NULL).build(), null), //
    APPLICATION_COMPLETE_REVIEW_STAGE(USER_INVOCATION, PROCESS_RESOURCE, false, true, false, true, false, false, APPLICATION, null, Arrays.asList(
            new PrismActionRedaction().withRole(APPLICATION_CREATOR).withRedactionType(ALL_CONTENT), new PrismActionRedaction().withRole(APPLICATION_REFEREE)
                    .withRedactionType(ALL_CONTENT)), PrismActionValidationDefinition.builder().addResolution(CONTENT, NOT_EMPTY)
            .addResolution(DOCUMENTS, new PrismActionValidationFieldResolution(SIZE, "min", 0)).addResolution(TRANSITION_STATE, NOT_NULL).build(), null), //
    APPLICATION_COMPLETE_VALIDATION_STAGE(USER_INVOCATION, PROCESS_RESOURCE, false, true, false, true, false, false, APPLICATION, null, Arrays.asList(
            new PrismActionRedaction().withRole(APPLICATION_CREATOR).withRedactionType(ALL_CONTENT), new PrismActionRedaction().withRole(APPLICATION_REFEREE)
                    .withRedactionType(ALL_CONTENT)), PrismActionValidationDefinition.builder().addResolution(CONTENT, NOT_EMPTY)
            .addResolution(DOCUMENTS, new PrismActionValidationFieldResolution(SIZE, "min", 0)).addResolution(TRANSITION_STATE, NOT_NULL).build(), null), //
    APPLICATION_CONFIRM_ELIGIBILITY(USER_INVOCATION, PROCESS_RESOURCE, false, false, false, true, false, false, APPLICATION, null, Arrays.asList(
            new PrismActionRedaction().withRole(APPLICATION_CREATOR).withRedactionType(ALL_CONTENT), new PrismActionRedaction().withRole(APPLICATION_REFEREE)
                    .withRedactionType(ALL_CONTENT)), PrismActionValidationDefinition.builder().addResolution(CONTENT, NOT_EMPTY)
    ...
    APPLICATION_CONFIRM_INTERVIEW_ARRANGEMENTS(USER_INVOCATION, PROCESS_RESOURCE, false, false, false, true, false, false, APPLICATION, null, Arrays.asList(
            ...
            .addResolution(INTERVIEW_LOCATION).build(), null), //
    APPLICATION_CONFIRM_OFFER_RECOMMENDATION(USER_INVOCATION, PROCESS_RESOURCE, false, false, false, true, false, false, APPLICATION, null, null,
            PrismActionValidationDefinition.builder().addResolution(ASSIGNED_USERS, new PrismActionValidationFieldResolution(SIZE, "min", 2))
                    ...
                    .addResolution(APPOINTMENT_CONDITIONS).build(), null), //
    APPLICATION_CONFIRM_REJECTION(USER_INVOCATION, PROCESS_RESOURCE, false, false, false, true, false, false, APPLICATION, null, null,
            PrismActionValidationDefinition.builder().addResolution(REJECTION_REASON, NOT_NULL).build(), null), //
    APPLICATION_CONFIRM_PRIMARY_SUPERVISION(USER_INVOCATION, PROCESS_RESOURCE, false, false, false, true, false, false, APPLICATION, null, Arrays.asList(
            ...
            .setCustomValidator(new ConfirmSupervisionCommentCustomValidator()).build(), null), //
    APPLICATION_CONFIRM_SECONDARY_SUPERVISION(USER_INVOCATION, PROCESS_RESOURCE, false, false, false, true, false, false, APPLICATION, null, Arrays.asList(
            ...
            .setCustomValidator(new ConfirmSupervisionCommentCustomValidator()).build(), null), //
    APPLICATION_CORRECT(USER_INVOCATION, PROCESS_RESOURCE, false, false, false, true, false, false, APPLICATION, null, null, null, null), //
    APPLICATION_EMAIL_CREATOR(USER_INVOCATION, EMAIL_RESOURCE_CREATOR, false, false, false, false, false, false, APPLICATION, null, null, null, null), //
    APPLICATION_ESCALATE(SYSTEM_INVOCATION, ESCALATE_RESOURCE, false, false, false, false, false, false, APPLICATION, null, null, null, null), //
    APPLICATION_EXPORT(SYSTEM_INVOCATION, EXPORT_RESOURCE, false, false, false, true, false, false, APPLICATION, null, null, null, null), //
    APPLICATION_MOVE_TO_DIFFERENT_STAGE(USER_INVOCATION, PROCESS_RESOURCE, false, true, false, true, false, false, APPLICATION, null, Arrays.asList(
            new PrismActionRedaction().withRole(APPLICATION_CREATOR).withRedactionType(ALL_CONTENT), new PrismActionRedaction().withRole(APPLICATION_REFEREE)
                    .withRedactionType(ALL_CONTENT)), PrismActionValidationDefinition.builder().addResolution(CONTENT, NOT_EMPTY)
            .addResolution(DOCUMENTS, new PrismActionValidationFieldResolution(SIZE, "min", 0)).addResolution(TRANSITION_STATE, NOT_NULL).build(), null), //
    APPLICATION_PROVIDE_INTERVIEW_AVAILABILITY(USER_INVOCATION, PROCESS_RESOURCE, false, false, false, true, false, false, APPLICATION, null, Arrays.asList(
            new PrismActionRedaction().withRole(APPLICATION_CREATOR).withRedactionType(ALL_CONTENT), new PrismActionRedaction().withRole(APPLICATION_REFEREE)
                    .withRedactionType(ALL_CONTENT)), PrismActionValidationDefinition.builder()
            .addResolution(APPOINTMENT_PREFERENCES, new PrismActionValidationFieldResolution(SIZE, "min", 0)).build(), null), //
    APPLICATION_PROVIDE_INTERVIEW_FEEDBACK(USER_INVOCATION, PROCESS_RESOURCE, true, false, false, true, false, true, APPLICATION, null, Arrays.asList(
            new PrismActionRedaction().withRole(APPLICATION_CREATOR).withRedactionType(ALL_CONTENT), new PrismActionRedaction().withRole(APPLICATION_REFEREE)
                    .withRedactionType(ALL_CONTENT)), PrismActionValidationDefinition.builder().addResolution(CONTENT, NOT_EMPTY)
            ...
            .build(), null), //
    APPLICATION_PROVIDE_REFERENCE(USER_INVOCATION, PROCESS_RESOURCE, true, false, true, true, true, true, APPLICATION, null, Arrays.asList(
            new PrismActionRedaction().withRole(APPLICATION_CREATOR).withRedactionType(ALL_CONTENT), new PrismActionRedaction().withRole(APPLICATION_REFEREE)
                    .withRedactionType(ALL_CONTENT)), PrismActionValidationDefinition.builder().addResolution(CONTENT, NOT_EMPTY)
    ...
    APPLICATION_UPDATE_INTERVIEW_AVAILABILITY(USER_INVOCATION, PROCESS_RESOURCE, false, false, false, true, false, false, APPLICATION, null, Arrays.asList(
            new PrismActionRedaction().withRole(APPLICATION_CREATOR).withRedactionType(ALL_CONTENT), new PrismActionRedaction().withRole(APPLICATION_REFEREE)
                    .withRedactionType(ALL_CONTENT)), PrismActionValidationDefinition.builder()
            .addResolution(APPOINTMENT_PREFERENCES, new PrismActionValidationFieldResolution(SIZE, "min", 0)).build(), null), //
    APPLICATION_VIEW_EDIT(USER_INVOCATION, VIEW_EDIT_RESOURCE, false, false, false, true, false, false, APPLICATION, null, Arrays.asList(
            new PrismActionRedaction().withRole(APPLICATION_CREATOR).withRedactionType(ALL_CONTENT), new PrismActionRedaction().withRole(APPLICATION_REFEREE)
                    .withRedactionType(ALL_CONTENT)), null, null), //
    APPLICATION_WITHDRAW(USER_INVOCATION, WITHDRAW_RESOURCE, false, true, false, true, false, false, APPLICATION, null, null, null, null), //
    INSTITUTION_COMPLETE_APPROVAL_STAGE(USER_INVOCATION, PROCESS_RESOURCE, false, true, false, true, false, false, INSTITUTION, null, null, null, null), //
    INSTITUTION_STARTUP(SYSTEM_INVOCATION, INITIALISE_RESOURCE, false, false, false, true, false, false, INSTITUTION, null, null, null, null), //
    INSTITUTION_VIEW_EDIT(USER_INVOCATION, VIEW_EDIT_RESOURCE, false, false, false, false, false, false, INSTITUTION, null, null, null, null), //
    INSTITUTION_CORRECT(USER_INVOCATION, PROCESS_RESOURCE, false, true, false, true, false, false, INSTITUTION, null, null, null, null), //
    INSTITUTION_CREATE_PROGRAM(USER_INVOCATION, CREATE_RESOURCE, false, true, false, true, false, false, INSTITUTION, PROGRAM, null, null, null), //
    INSTITUTION_EMAIL_CREATOR(USER_INVOCATION, EMAIL_RESOURCE_CREATOR, false, false, false, false, false, false, INSTITUTION, null, null, null, null), //
    INSTITUTION_ESCALATE(SYSTEM_INVOCATION, ESCALATE_RESOURCE, false, false, false, false, false, false, INSTITUTION, null, null, null, null), //
    INSTITUTION_IMPORT_PROGRAM(SYSTEM_INVOCATION, CREATE_RESOURCE, false, true, false, true, false, false, INSTITUTION, PROGRAM, null, null, null), //
    INSTITUTION_WITHDRAW(USER_INVOCATION, WITHDRAW_RESOURCE, false, true, false, true, false, false, INSTITUTION, null, null, null, null), //
    PROGRAM_COMPLETE_APPROVAL_STAGE(USER_INVOCATION, PROCESS_RESOURCE, false, true, false, true, false, false, PROGRAM, null, null, null, null), //
    PROGRAM_CONCLUDE(SYSTEM_INVOCATION, PROPAGATE_RESOURCE, false, true, false, true, false, false, PROGRAM, null, null, null, null), //
    PROGRAM_VIEW_EDIT(USER_INVOCATION, VIEW_EDIT_RESOURCE, false, false, false, false, false, false, PROGRAM, null, null, null, null), //
    PROGRAM_CORRECT(USER_INVOCATION, PROCESS_RESOURCE, false, true, false, true, false, false, PROGRAM, null, null, null, null), //
    PROGRAM_CREATE_APPLICATION(USER_INVOCATION, CREATE_RESOURCE, false, true, false, true, false, false, PROGRAM, APPLICATION, null, null, null), //
    PROGRAM_CREATE_PROJECT(USER_INVOCATION, CREATE_RESOURCE, false, true, false, true, false, false, PROGRAM, PROJECT, null, null, null), //
    PROGRAM_EMAIL_CREATOR(USER_INVOCATION, EMAIL_RESOURCE_CREATOR, false, false, false, false, false, false, PROGRAM, null, null, null, null), //
    PROGRAM_ESCALATE(SYSTEM_INVOCATION, ESCALATE_RESOURCE, false, false, false, false, false, false, PROGRAM, null, null, null, null), //
    PROGRAM_RESTORE(SYSTEM_INVOCATION, PROPAGATE_RESOURCE, false, true, false, true, false, false, PROGRAM, null, null, null, null), //
    PROGRAM_WITHDRAW(USER_INVOCATION, WITHDRAW_RESOURCE, false, true, false, true, false, false, PROGRAM, null, null, null, null), //
    PROJECT_COMPLETE_APPROVAL_STAGE(USER_INVOCATION, PROCESS_RESOURCE, false, true, false, true, false, false, PROJECT, null, null, null, null), //
    PROJECT_CONCLUDE(SYSTEM_INVOCATION, PROPAGATE_RESOURCE, false, true, false, true, false, false, PROJECT, null, null, null, null), //
    PROJECT_VIEW_EDIT(USER_INVOCATION, VIEW_EDIT_RESOURCE, false, false, false, false, false, false, PROJECT, null, null, null, null), //
    PROJECT_CORRECT(USER_INVOCATION, PROCESS_RESOURCE, false, true, false, true, false, false, PROJECT, null, null, null, null), //
    PROJECT_CREATE_APPLICATION(USER_INVOCATION, CREATE_RESOURCE, false, true, false, true, false, false, PROJECT, APPLICATION, null, null, null), //
    PROJECT_EMAIL_CREATOR(USER_INVOCATION, EMAIL_RESOURCE_CREATOR, false, false, false, false, false, false, PROJECT, null, null, null, null), //
    PROJECT_ESCALATE(SYSTEM_INVOCATION, ESCALATE_RESOURCE, false, false, false, false, false, false, PROJECT, null, null, null, null), //
    PROJECT_RESTORE(SYSTEM_INVOCATION, PROPAGATE_RESOURCE, false, true, false, true, false, false, PROJECT, null, null, null, null), //
    PROJECT_SUSPEND(SYSTEM_INVOCATION, PROPAGATE_RESOURCE, false, true, false, true, false, false, PROJECT, null, null, null, null), //
    PROJECT_TERMINATE(SYSTEM_INVOCATION, PROPAGATE_RESOURCE, false, true, false, true, false, false, PROJECT, null, null, null, null), //
    PROJECT_WITHDRAW(USER_INVOCATION, WITHDRAW_RESOURCE, false, true, false, true, false, false, PROJECT, null, null, null, null), //
    SYSTEM_VIEW_EDIT(USER_INVOCATION, VIEW_EDIT_RESOURCE, false, false, false, false, false, false, SYSTEM, null, null, null, null), //
    SYSTEM_CREATE_INSTITUTION(USER_INVOCATION, CREATE_RESOURCE, false, true, false, true, false, false, SYSTEM, INSTITUTION, null, null, null), //
    SYSTEM_STARTUP(SYSTEM_INVOCATION, INITIALISE_RESOURCE, false, false, false, true, false, false, SYSTEM, SYSTEM, null, null, null), //
    SYSTEM_MANAGE_ACCOUNT(USER_INVOCATION, MANAGE_ACCOUNT, false, false, false, false, false, false, SYSTEM, null, null, null, null), //
    SYSTEM_VIEW_APPLICATION_LIST(USER_INVOCATION, VIEW_RESOURCE_LIST, false, false, false, false, false, false, SYSTEM, null, null, null, null), //
    SYSTEM_VIEW_INSTITUTION_LIST(USER_INVOCATION, VIEW_RESOURCE_LIST, false, false, false, false, false, false, SYSTEM, null, null, null, null), //
    SYSTEM_VIEW_PROGRAM_LIST(USER_INVOCATION, VIEW_RESOURCE_LIST, false, false, false, false, false, false, SYSTEM, null, null, null, null), //
    SYSTEM_VIEW_PROJECT_LIST(USER_INVOCATION, VIEW_RESOURCE_LIST, false, false, false, false, false, false, SYSTEM, null, null, null, null);
    ...
    private PrismActionConfigurationDefinition configurationDefinition;
    ...
    private PrismAction(PrismActionType actionType, PrismActionCategory actionCategory, boolean ratingAction, boolean transitionAction,
            boolean declinableAction, boolean visibleAction, boolean emphasizedAction, boolean customizableAction, PrismScope scope, PrismScope creationScope,
            List<PrismActionRedaction> redactions, PrismActionValidationDefinition validationDefinition,
            PrismActionConfigurationDefinition configurationDefinition) {
    ...
    public final boolean isCustomizableAction() {
        return customizableAction;
    }

    public final boolean isConfigurableAction() {
    ...
    public PrismStateGroup getMinimumStartStateGroup() {
        return configurationDefinition == null ? null : configurationDefinition.getMinimumStartStateGroup();
    }

    public PrismStateGroup getMaximumStartStateGroup() {
        return configurationDefinition == null ? null : configurationDefinition.getMaximumStartStateGroup();
    }
    ...
    public static class PrismActionConfigurationDefinition {

        private PrismStateGroup minimumStartStateGroup;

        private PrismStateGroup maximumStartStateGroup;
        ...
        public final PrismStateGroup getMinimumStartStateGroup() {
            return minimumStartStateGroup;
        }

        public final PrismStateGroup getMaximumStartStateGroup() {
            return maximumStartStateGroup;
        }
        ...
        public PrismActionConfigurationDefinition withMinimumStartStateGroup(PrismStateGroup minimumStartStateGroup) {
            this.minimumStartStateGroup = minimumStartStateGroup;
            return this;
        }

        public PrismActionConfigurationDefinition withMaximumStartStateGroup(PrismStateGroup maximumStartStateGroup) {
            this.maximumStartStateGroup = maximumStartStateGroup;
            return this;
        }

        public PrismActionConfigurationDefinition withDefaultStartStateGroup(PrismStateGroup defaultStartStateGroup) {
            this.defaultStartStateGroup = defaultStartStateGroup;
            return this;
        }
