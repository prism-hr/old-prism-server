...
public class PrismApplicationApproval extends PrismWorkflowState {
    ...
    protected void setStateActions() {
        stateActions.add(new PrismStateAction() //
            .withAction(PrismAction.APPLICATION_ASSIGN_SUPERVISORS) //
            ...
            .withNotificationTemplate(PrismNotificationDefinition.SYSTEM_APPLICATION_TASK_REQUEST) //
                ...
                .withTransitions(Arrays.asList( //
                    new PrismStateTransition() //
                        ...
                        .withStateTransitionEvaluation(PrismStateTransitionEvaluation.APPLICATION_ASSIGNED_SUPERVISOR_OUTCOME) //
