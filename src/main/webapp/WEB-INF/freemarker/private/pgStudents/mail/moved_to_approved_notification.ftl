    ...
    <table width="600" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
            ...
            <td width="500">
                ...
                <p>
                    <font face="Arial, Helvetica, sans-serif" size="2">Our Programme Director has completed their assessment of your Application ${application.applicationNumber} for UCL <#if application.researchHomePage??> <a href="${application.researchHomePage}">${application.program.title}.</a> <#else> ${application.program.title}. </#if>
                    </font>
                ...
                <p>
                    <font face="Arial, Helvetica, sans-serif" size="2">UCL Admissions aim to be in contact with you within ${admissionOfferServiceLevel}. Should you have any further questions on your Application, you should now contact <a id="feedbackButton" href="mailto:admissions@ucl.ac.uk" target="_blank">UCL Admissions</a>.
                    </font>
                </p>

                <p>
                    <font face="Arial, Helvetica, sans-serif" size="2">Yours sincerely,<br />UCL Prism
                    </font>
                </p>
            </td>
            <td width="50"><img src="${host}/pgadmissions/design/default/images/shim.gif" width="50" height="10" alt="" /></td>
            ...
            <td colspan="3" bgcolor="#6D6E71" style="background-color: #6D6E71; line-height: 1; white-space: nowrap;">
                <table width="600" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                        ...
                        <td width="288"><font face="Arial, Helvetica, sans-serif" size="1" color="#BEBEC0" style="font-size: 7pt;"> University College London, Gower Street, London, WC1E 6BT<br /> Tel: +44 (0) 20 7679 2000<br /> &copy; UCL 1999&ndash;2012
                        </font></td>
