...
public enum PrismNotificationDefinition {
    ...
    PROJECT_COMPLETE_APPROVAL_PARTNER_STAGE_NOTIFICATION(INDIVIDUAL, UPDATE, PROJECT, //
            Lists.newArrayList(INSTITUTION_GLOBAL, PROJECT_GLOBAL, ACTION_GLOBAL, COMMENT_GLOBAL, COMMENT_TRANSITION, TEMPLATE_GLOBAL)), //
    ...
    PROJECT_SPONSOR_NOTIFICATION(INDIVIDUAL, UPDATE, PROJECT, //
            Lists.newArrayList(INSTITUTION_GLOBAL, PROJECT_GLOBAL, COMMENT_GLOBAL, COMMENT_SPONSOR, TEMPLATE_GLOBAL)), //
    ...
    PROGRAM_SPONSOR_NOTIFICATION(INDIVIDUAL, UPDATE, PROGRAM, //
            Lists.newArrayList(INSTITUTION_GLOBAL, PROGRAM_GLOBAL, COMMENT_GLOBAL, COMMENT_SPONSOR, TEMPLATE_GLOBAL)), //
    ...
    INSTITUTION_SPONSOR_NOTIFICATION(INDIVIDUAL, UPDATE, INSTITUTION, //
            Lists.newArrayList(INSTITUTION_GLOBAL, COMMENT_GLOBAL, COMMENT_SPONSOR, TEMPLATE_GLOBAL)), //
