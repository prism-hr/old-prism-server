...
INSERT INTO STATE_TRANSITION (state_action_id, state_transition_type_id, transition_state_id, state_transition_evaluation_id)
	...
	WHERE STATE.parent_state_id = "APPLICATION_UNSUBMITTED"
		...
		UNION
	SELECT STATE_ACTION.id, "ONE_COMPLETED", TRANSITION_STATE.id, "APPLICATION_PROCESSING_COMPLETED_OUTCOME"
	FROM STATE_ACTION INNER JOIN STATE
		ON STATE_ACTION.state_id = STATE.id
	...
	WHERE STATE.parent_state_id IN ("APPLICATION_VALIDATION", "APPLICATION_REVIEW", "APPLICATION_INTERVIEW", "APPLICATION_APPROVAL")
		...
		UNION
	SELECT STATE_ACTION.id, "ONE_COMPLETED", STATE.id, "APPLICATION_PROCESSING_COMPLETED_OUTCOME"
	FROM STATE_ACTION INNER JOIN STATE
...
INSERT INTO STATE_TRANSITION (state_action_id, state_transition_type_id, transition_state_id, state_transition_evaluation_id)
	SELECT id, "ONE_COMPLETED", state_id, "APPLICATION_COMPLETED_OUTCOME"
	FROM STATE_ACTION
	WHERE action_id = "APPLICATION_COMPLETE"
		UNION
	SELECT id, "ONE_COMPLETED", "APPLICATION_VALIDATION", "APPLICATION_COMPLETED_OUTCOME"
	FROM STATE_ACTION
	WHERE action_id = "APPLICATION_COMPLETE"
;
...
INSERT INTO STATE_TRANSITION (state_action_id, state_transition_type_id, transition_state_id, state_transition_evaluation_id)
	SELECT STATE_ACTION.id, "ONE_COMPLETED", STATE.id, "APPLICATION_ELIGIBILITY_ASSESSED_OUTCOME"
	FROM STATE_ACTION INNER JOIN STATE
...
INSERT INTO STATE_TRANSITION (state_action_id, state_transition_type_id, transition_state_id, state_transition_evaluation_id, display_order)
	SELECT id, "ONE_COMPLETED", "APPLICATION_REVIEW", "APPLICATION_STAGE_COMPLETED_OUTCOME", 0
	FROM STATE_ACTION
	WHERE action_id IN ("APPLICATION_COMPLETE_VALIDATION_STAGE", "APPLICATION_COMPLETE_REVIEW_STAGE", 
		...
		UNION
	SELECT id, "ONE_COMPLETED", "APPLICATION_INTERVIEW", "APPLICATION_STAGE_COMPLETED_OUTCOME", 1
	FROM STATE_ACTION
	WHERE action_id IN ("APPLICATION_COMPLETE_VALIDATION_STAGE", "APPLICATION_COMPLETE_REVIEW_STAGE", 
		"APPLICATION_COMPLETE_INTERVIEW_STAGE", "APPLICATION_COMPLETE_APPROVAL_STAGE")
		UNION
	SELECT id, "ONE_COMPLETED", "APPLICATION_APPROVAL", "APPLICATION_STAGE_COMPLETED_OUTCOME", 2
	FROM STATE_ACTION
	WHERE action_id IN ("APPLICATION_COMPLETE_VALIDATION_STAGE", "APPLICATION_COMPLETE_REVIEW_STAGE", 
		"APPLICATION_COMPLETE_INTERVIEW_STAGE", "APPLICATION_COMPLETE_APPROVAL_STAGE")
		UNION
	SELECT id, "ONE_COMPLETED", "APPLICATION_APPROVED", "APPLICATION_STAGE_COMPLETED_OUTCOME", 3
	FROM STATE_ACTION
	WHERE action_id IN ("APPLICATION_COMPLETE_VALIDATION_STAGE", "APPLICATION_COMPLETE_REVIEW_STAGE", 
		"APPLICATION_COMPLETE_INTERVIEW_STAGE", "APPLICATION_COMPLETE_APPROVAL_STAGE")
		UNION
	SELECT id, "ONE_COMPLETED", "APPLICATION_REJECTED", "APPLICATION_STAGE_COMPLETED_OUTCOME", 4
	FROM STATE_ACTION
	WHERE action_id IN ("APPLICATION_COMPLETE_VALIDATION_STAGE", "APPLICATION_COMPLETE_REVIEW_STAGE", 
		"APPLICATION_COMPLETE_INTERVIEW_STAGE", "APPLICATION_COMPLETE_APPROVAL_STAGE")
;
...
INSERT INTO STATE_TRANSITION (state_action_id, state_transition_type_id, transition_state_id, state_transition_evaluation_id, display_order)
	SELECT id, "ONE_COMPLETED", "APPLICATION_INTERVIEW", "APPLICATION_STAGE_COMPLETED_OUTCOME", 0
	FROM STATE_ACTION
	WHERE action_id = "APPLICATION_MOVE_TO_DIFFERENT_STAGE"
		AND state_id = "APPLICATION_REVIEW"
		UNION
	SELECT id, "ONE_COMPLETED", "APPLICATION_APPROVAL", "APPLICATION_STAGE_COMPLETED_OUTCOME", 1
	FROM STATE_ACTION
	WHERE action_id = "APPLICATION_MOVE_TO_DIFFERENT_STAGE"
		AND state_id = "APPLICATION_REVIEW"
		UNION		
	SELECT id, "ONE_COMPLETED", "APPLICATION_APPROVED", "APPLICATION_STAGE_COMPLETED_OUTCOME", 2
	FROM STATE_ACTION
	WHERE action_id = "APPLICATION_MOVE_TO_DIFFERENT_STAGE"
		AND state_id = "APPLICATION_REVIEW"
		UNION
	SELECT id, "ONE_COMPLETED", "APPLICATION_REJECTED", "APPLICATION_STAGE_COMPLETED_OUTCOME", 3
	FROM STATE_ACTION
	WHERE action_id = "APPLICATION_MOVE_TO_DIFFERENT_STAGE"
		AND state_id = "APPLICATION_REVIEW"
		UNION
...
INSERT INTO STATE_TRANSITION (state_action_id, state_transition_type_id, transition_state_id, state_transition_evaluation_id)
	SELECT STATE_ACTION.id, "ONE_COMPLETED", STATE.id, "APPLICATION_INTERVIEW_SCHEDULED_OUTCOME"
	FROM STATE_ACTION INNER JOIN STATE
...
INSERT INTO STATE_TRANSITION (state_action_id, state_transition_type_id, transition_state_id, state_transition_evaluation_id)
	SELECT id, "ONE_COMPLETED", "APPLICATION_APPROVED_PENDING_EXPORT", "APPLICATION_PROCESSING_COMPLETED_OUTCOME"
	FROM STATE_ACTION
	WHERE action_id = "APPLICATION_CONFIRM_OFFER_RECOMMENDATION"
		UNION
	SELECT id, "ONE_COMPLETED", "APPLICATION_APPROVED_COMPLETED", "APPLICATION_PROCESSING_COMPLETED_OUTCOME"
	FROM STATE_ACTION
	WHERE action_id = "APPLICATION_CONFIRM_OFFER_RECOMMENDATION"
;
...
INSERT INTO STATE_TRANSITION (state_action_id, state_transition_type_id, transition_state_id, state_transition_evaluation_id)
	SELECT id, "ONE_COMPLETED", "APPLICATION_REJECTED_PENDING_EXPORT", "APPLICATION_PROCESSING_COMPLETED_OUTCOME"
	FROM STATE_ACTION
	WHERE action_id = "APPLICATION_CONFIRM_REJECTION"
		UNION
	SELECT id, "ONE_COMPLETED", "APPLICATION_REJECTED_COMPLETED", "APPLICATION_PROCESSING_COMPLETED_OUTCOME"
	FROM STATE_ACTION
	WHERE action_id = "APPLICATION_CONFIRM_REJECTION"
;
...
INSERT INTO STATE_TRANSITION (state_action_id, state_transition_type_id, transition_state_id, state_transition_evaluation_id)
	SELECT id, "ONE_COMPLETED", "PROGRAM_APPROVAL", "PROGRAM_CREATED_OUTCOME"
	FROM STATE_ACTION
	WHERE action_id = "INSTITUTION_CREATE_PROGRAM"
		UNION
	SELECT id, "ONE_COMPLETED", "PROGRAM_APPROVED", "PROGRAM_CREATED_OUTCOME"
	FROM STATE_ACTION
	WHERE action_id = "INSTITUTION_CREATE_PROGRAM"	
;
...
INSERT INTO STATE_TRANSITION (state_action_id, state_transition_type_id, transition_state_id, state_transition_evaluation_id)
	SELECT id, "ONE_COMPLETED", "PROGRAM_APPROVAL", "PROGRAM_APPROVED_OUTCOME"
	FROM STATE_ACTION
	WHERE state_id = "PROGRAM_APPROVAL"
		AND action_id = "PROGRAM_COMPLETE_APPROVAL_STAGE"
		UNION
	SELECT id, "ONE_COMPLETED", "PROGRAM_APPROVAL_PENDING_CORRECTION", "PROGRAM_APPROVED_OUTCOME"
	FROM STATE_ACTION
	WHERE state_id = "PROGRAM_APPROVAL"
		AND action_id = "PROGRAM_COMPLETE_APPROVAL_STAGE"
		UNION
	SELECT id, "ONE_COMPLETED", "PROGRAM_APPROVED", "PROGRAM_APPROVED_OUTCOME"
	FROM STATE_ACTION
	WHERE state_id = "PROGRAM_APPROVAL"
		AND action_id = "PROGRAM_COMPLETE_APPROVAL_STAGE"
		UNION
	SELECT id, "ONE_COMPLETED", "PROGRAM_REJECTED", "PROGRAM_APPROVED_OUTCOME"
	FROM STATE_ACTION
	WHERE state_id = "PROGRAM_APPROVAL"
		AND action_id = "PROGRAM_COMPLETE_APPROVAL_STAGE"
;
...
INSERT INTO STATE_TRANSITION (state_action_id, state_transition_type_id, transition_state_id)
	SELECT id, "ONE_COMPLETED", "PROGRAM_WITHDRAWN"
	FROM STATE_ACTION
...
INSERT INTO STATE_TRANSITION (state_action_id, state_transition_type_id, transition_state_id)
	SELECT id, "ONE_COMPLETED", "PROJECT_APPROVED"
	FROM STATE_ACTION
