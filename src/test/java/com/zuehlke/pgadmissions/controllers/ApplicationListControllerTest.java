...
public class ApplicationListControllerTest {
	...
	public void shouldReturnViewForApplicationListPageWithNoFilters() {
		...
		assertEquals("private/my_applications_page", controller.getApplicationListPage(model));
	...
	public void shouldGetApplicationFormByNumber() {
		...
		EasyMock.expect(applicationsServiceMock.getApplicationByApplicationNumber(appNumber))
	...
	public void shouldApplyanExistingFilter() {
		...
		expect(applicationsServiceMock.getAllVisibleAndMatchedApplications(user, filter.getSearchCategory(), filter.getSearchTerm(), SortCategory.APPLICANT_NAME, SortOrder.ASCENDING, 4))
		.andReturn(asList(application));
		
		EasyMock.replay(userServiceMock, applicationsServiceMock);
		assertEquals("private/my_applications_section", controller.getApplicationListSection(null, null, SortCategory.APPLICANT_NAME, SortOrder.ASCENDING, 4, false, model));
	...
	public void shouldCreateANewFilter() {
		...
		expect(applicationsServiceMock.getAllVisibleAndMatchedApplications(user, SearchCategory.APPLICANT_NAME, "Johnno", SortCategory.APPLICANT_NAME, SortOrder.ASCENDING, 4))
		.andReturn(asList(application));
		
		EasyMock.replay(userServiceMock, applicationsServiceMock);
		assertEquals("private/my_applications_section", controller.getApplicationListSection(SearchCategory.APPLICANT_NAME, "Johnno", SortCategory.APPLICANT_NAME, SortOrder.ASCENDING, 4, false, model));
	...
	public void shouldClearApplicationFilterForUser() {
		...
		EasyMock.replay(userServiceMock, applicationsServiceMock);
		assertEquals("private/my_applications_section", controller.getApplicationListSection(SearchCategory.APPLICANT_NAME, "Johnno", SortCategory.APPLICANT_NAME, SortOrder.ASCENDING, 4, true, model));
	...
	public void shouldAddAllApplications() {
		...
		List<ApplicationForm> applications = controller.getApplications(SearchCategory.APPLICATION_DATE, "bladibla",
				SortCategory.APPLICANT_NAME, SortOrder.ASCENDING, 4);
	...
	public void shouldReturnFirstBlockOfApplications() {
		...
		List<ApplicationForm> applications = controller.getApplications(SearchCategory.APPLICATION_DATE, "bladibla",
				SortCategory.APPLICANT_NAME, SortOrder.ASCENDING, 1);
