...
public class ApplicationExportService {
    ...
    public void submitExportRequest(Integer applicationId) throws Exception {
        ...
        try {
            ...
            sendDocumentExportRequest(application, exportId);
            applicationService.executeExportAction(applicationId, exportRequest, exportId, exportUserId, null);
        } catch (Throwable t) {
            logger.error("Error exporting application: " + application.getCode(), t);
            applicationService.executeExportAction(applicationId, exportRequest, exportId, exportUserId, ExceptionUtils.getStackTrace(t));
        }
    }
