...
public class AdvertDAO {
    ...
    public List<AdvertUserApplyingForDTO> getAdvertsUserApplyingFor(User user, Collection<Integer> adverts) {
        return (List<AdvertUserApplyingForDTO>) sessionFactory.getCurrentSession().createCriteria(Application.class) //
                .setProjection(Projections.projectionList()
                ...
                .setResultTransformer(Transformers.aliasToBean(AdvertUserApplyingForDTO.class))
                .list();
    }
