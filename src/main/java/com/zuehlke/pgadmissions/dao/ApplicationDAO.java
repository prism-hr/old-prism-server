...
public class ApplicationDAO {
    ...
    public List<ApplicationProcessingSummaryDTO> getApplicationProcessingSummariesByYear(PrismScope resourceScope, Integer resourceId) throws Exception {
        return (List<ApplicationProcessingSummaryDTO>) getApplicationProcessingSummaryQuery(resourceScope, "sql/application_processing_summary_year.ftl")
    ...
    public List<ApplicationProcessingSummaryDTO> getApplicationProcessingSummariesByMonth(PrismScope resourceScope, Integer resourceId)
            throws Exception {
        return (List<ApplicationProcessingSummaryDTO>) getApplicationProcessingSummaryQuery(resourceScope, "sql/application_processing_summary_month.ftl")
    ...
    private SQLQuery getApplicationProcessingSummaryQuery(PrismScope resourceScope, String templateLocation) throws Exception {
        ...
        SQLQuery query = (SQLQuery) sessionFactory.getCurrentSession().createSQLQuery( //
                ...
                .setParameter("resourceReference", model.get("resourceReference")) //
                .setParameter("resourceId", model.get("resourceId")); //

        return (SQLQuery) query.addScalar("advertCount", LongType.INSTANCE) //
