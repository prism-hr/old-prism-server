...
CREATE TABLE STATE_TRANSITION_EVALUATION (
	...
	SELECT "PROGRAM_CONFIGURATION_OUTCOME"
		UNION
	SELECT "PROGRAM_STATE_REVERSION"
		UNION
	SELECT "PROGRAM_EXPIRY_OUTCOME"
		UNION
	SELECT "APPLICATION_STATE_OUTCOME"
		UNION
...
INSERT INTO STATE_TRANSITION (state_action_id, state_transition_type_id, transition_state_id, state_transition_evaluation_id)
	SELECT id, "ONE_COMPLETED", "APPLICATION_VALIDATION_PENDING_FEEDBACK", "APPLICATION_ASSESSMENT_OUTCOME"
	FROM STATE_ACTION
	WHERE state_id = "APPLICATION_VALIDATION"
		AND action_id = "APPLICATION_ASSESS_ELIGIBILITY"
		UNION
	SELECT id, "ONE_COMPLETED", "APPLICATION_VALIDATION_PENDING_COMPLETION", "APPLICATION_ASSESSMENT_OUTCOME"
	FROM STATE_ACTION
	WHERE state_id = "APPLICATION_VALIDATION"
		AND action_id = "APPLICATION_ASSESS_ELIGIBILITY"
		UNION
...
INSERT INTO STATE_TRANSITION (state_action_id, state_transition_type_id, transition_state_id, state_transition_evaluation_id, display_order)
	...
	WHERE state_id = "APPLICATION_VALIDATION_PENDING_FEEDBACK"
		...
		UNION
	SELECT id, "ONE_COMPLETED", "APPLICATION_REVIEW", "APPLICATION_STATE_OUTCOME", 0
	FROM STATE_ACTION
	WHERE state_id = "APPLICATION_VALIDATION_PENDING_FEEDBACK"
		AND action_id = "APPLICATION_COMPLETE_VALIDATION_STAGE"
		UNION
	SELECT id, "ONE_COMPLETED", "APPLICATION_INTERVIEW", "APPLICATION_STATE_OUTCOME", 1
	FROM STATE_ACTION
	WHERE state_id = "APPLICATION_VALIDATION_PENDING_FEEDBACK"
		AND action_id = "APPLICATION_COMPLETE_VALIDATION_STAGE"
		UNION
	SELECT id, "ONE_COMPLETED", "APPLICATION_APPROVAL", "APPLICATION_STATE_OUTCOME", 2
	FROM STATE_ACTION
	WHERE state_id = "APPLICATION_VALIDATION_PENDING_FEEDBACK"
		AND action_id = "APPLICATION_COMPLETE_VALIDATION_STAGE"
		UNION
	SELECT id, "ONE_COMPLETED", "APPLICATION_APPROVED", "APPLICATION_STATE_OUTCOME", 3
	FROM STATE_ACTION
	WHERE state_id = "APPLICATION_VALIDATION_PENDING_FEEDBACK"
		AND action_id = "APPLICATION_COMPLETE_VALIDATION_STAGE"
		UNION
	SELECT id, "ONE_COMPLETED", "APPLICATION_REJECTED", "APPLICATION_STATE_OUTCOME", 4
	FROM STATE_ACTION
	WHERE state_id = "APPLICATION_VALIDATION_PENDING_FEEDBACK"
		AND action_id = "APPLICATION_COMPLETE_VALIDATION_STAGE"
		UNION
...
INSERT INTO STATE_TRANSITION (state_action_id, state_transition_type_id, transition_state_id, state_transition_evaluation_id, display_order)
	...
	WHERE state_id = "APPLICATION_REVIEW"
		...
		UNION
	SELECT id, "ONE_COMPLETED", "APPLICATION_INTERVIEW", "APPLICATION_STATE_OUTCOME", 0
	FROM STATE_ACTION
	WHERE state_id = "APPLICATION_REVIEW"
		AND action_id = "APPLICATION_MOVE_TO_DIFFERENT_STAGE"
		UNION
	SELECT id, "ONE_COMPLETED", "APPLICATION_APPROVAL", "APPLICATION_STATE_OUTCOME", 1
	FROM STATE_ACTION
	WHERE state_id = "APPLICATION_REVIEW"
		AND action_id = "APPLICATION_MOVE_TO_DIFFERENT_STAGE"
		UNION
	SELECT id, "ONE_COMPLETED", "APPLICATION_APPROVED", "APPLICATION_STATE_OUTCOME", 2
	FROM STATE_ACTION
	WHERE state_id = "APPLICATION_REVIEW"
		AND action_id = "APPLICATION_MOVE_TO_DIFFERENT_STAGE"
		UNION
	SELECT id, "ONE_COMPLETED", "APPLICATION_REJECTED", "APPLICATION_STATE_OUTCOME", 3
	FROM STATE_ACTION
	WHERE state_id = "APPLICATION_REVIEW"
		AND action_id = "APPLICATION_MOVE_TO_DIFFERENT_STAGE"
		UNION
...
INSERT INTO ROLE_TRANSITION (state_transition_id, role_id, role_transition_type_id, transition_role_id)
	...
	FROM STATE_TRANSITION INNER JOIN STATE_ACTION
		ON STATE_TRANSITION.state_action_id = STATE_ACTION.id
	INNER JOIN ROLE
	WHERE STATE_ACTION.action_id IN ("APPLICATION_WITHDRAW", "APPLICATION_COMPLETE_REVIEW_STAGE")
		AND STATE_ACTION.state_id = "APPLICATION_REVIEW_PENDING_FEEDBACK"
		AND ROLE.id IN ("APPLICATION_ADMINISTRATOR", "APPLICATION_REVIEWER")
		UNION
	SELECT STATE_TRANSITION.id, ROLE.id, "UPDATE_ALL", "APPLICATION_VIEWER_RECRUITER"
...
INSERT INTO STATE_TRANSITION (state_action_id, state_transition_type_id, transition_state_id, state_transition_evaluation_id, display_order)
	SELECT id, "ONE_COMPLETED", "APPLICATION_INTERVIEW_PENDING_SCHEDULING", "APPLICATION_INTERVIEW_SCHEDULING_OUTCOME", NULL
	FROM STATE_ACTION
	WHERE state_id = "APPLICATION_INTERVIEW"
		AND action_id = "APPLICATION_ASSIGN_INTERVIEWERS"
		UNION
	SELECT id, "ONE_COMPLETED", "APPLICATION_INTERVIEW_PENDING_INTERVIEW", "APPLICATION_INTERVIEW_SCHEDULING_OUTCOME", NULL
	FROM STATE_ACTION
	WHERE state_id = "APPLICATION_INTERVIEW"
		AND action_id = "APPLICATION_ASSIGN_INTERVIEWERS"
		UNION
	SELECT id, "ONE_COMPLETED", "APPLICATION_INTERVIEW_PENDING_FEEDBACK", "APPLICATION_INTERVIEW_SCHEDULING_OUTCOME", NULL
	FROM STATE_ACTION
	WHERE state_id = "APPLICATION_INTERVIEW"
		AND action_id = "APPLICATION_ASSIGN_INTERVIEWERS"
		UNION
...
INSERT INTO ROLE_TRANSITION (state_transition_id, role_id, role_transition_type_id, transition_role_id)
	...
	FROM STATE_TRANSITION INNER JOIN STATE_ACTION
		ON STATE_TRANSITION.state_action_id = STATE_ACTION.id
	INNER JOIN ROLE
	WHERE STATE_ACTION.action_id IN ("APPLICATION_WITHDRAW", "APPLICATION_COMPLETE_INTERVIEW_STAGE")
		AND STATE_ACTION.state_id = "APPLICATION_INTERVIEW_PENDING_AVAILABILITY"
...
INSERT INTO ROLE_TRANSITION (state_transition_id, role_id, role_transition_type_id, transition_role_id)
	...
	FROM STATE_TRANSITION INNER JOIN STATE_ACTION
		ON STATE_TRANSITION.state_action_id = STATE_ACTION.id
	INNER JOIN ROLE
	WHERE STATE_ACTION.action_id IN ("APPLICATION_WITHDRAW", "APPLICATION_COMPLETE_APPROVAL_STAGE")
		AND STATE_ACTION.state_id = "APPLICATION_APPROVAL_PENDING_FEEDBACK"
...
INSERT INTO STATE_TRANSITION (state_action_id, state_transition_type_id, transition_state_id, state_transition_evaluation_id, display_order)
	SELECT id, "ONE_COMPLETED", "PROGRAM_APPROVED", "PROGRAM_APPROVAL_OUTCOME", 0
	FROM STATE_ACTION
	WHERE state_id = "PROGRAM_APPROVAL"
		AND action_id = "PROGRAM_COMPLETE_APPROVAL_STAGE"
		UNION
	SELECT id, "ONE_COMPLETED", "PROGRAM_REJECTED", "PROGRAM_APPROVAL_OUTCOME", 1
	FROM STATE_ACTION
	WHERE state_id = "PROGRAM_APPROVAL"
		AND action_id = "PROGRAM_COMPLETE_APPROVAL_STAGE"
;
...
INSERT INTO STATE_TRANSITION (state_action_id, state_transition_type_id, transition_state_id, state_transition_evaluation_id)
	...
	WHERE state_id = "PROGRAM_APPROVED"
		AND action_id = "PROGRAM_ESCALATE"
		UNION
	SELECT id, "ONE_COMPLETED", "APPLICATION_UNSUBMITTED", NULL
	FROM STATE_ACTION
	WHERE state_id = "PROGRAM_APPROVED"
...
INSERT INTO ROLE_TRANSITION (state_transition_id, role_id, role_transition_type_id, transition_role_id)
	SELECT STATE_TRANSITION.id, "PROGRAM_APPLICATION_CREATOR", "REMOVE_ONE", NULL
	FROM STATE_TRANSITION INNER JOIN STATE_ACTION
		ON STATE_TRANSITION.state_action_id = STATE_ACTION.id
	WHERE STATE_ACTION.action_id = "PROGRAM_CREATE_APPLICATION"
		...
		UNION
	SELECT STATE_TRANSITION.id, "APPLICATION_CREATOR", "CREATE_ONE", NULL
	FROM STATE_TRANSITION INNER JOIN STATE_ACTION
		ON STATE_TRANSITION.state_action_id = STATE_ACTION.id
	WHERE STATE_ACTION.action_id = "PROGRAM_CREATE_APPLICATION"
		AND STATE_ACTION.state_id = "PROGRAM_APPROVED"
...
INSERT INTO STATE_TRANSITION (state_action_id, state_transition_type_id, transition_state_id, state_transition_evaluation_id)
	SELECT id, "PROPAGATION", "PROGRAM_APPROVED", "PROGRAM_STATE_REVERSION"
	FROM STATE_ACTION
	WHERE state_id = "PROGRAM_DISABLED_PENDING_IMPORT_REACTIVATION"
		AND action_id = "PROGRAM_REACTIVATE"
		UNION
	SELECT id, "PROPAGATION", "PROGRAM_DEACTIVATED", "PROGRAM_STATE_REVERSION"
	FROM STATE_ACTION
	WHERE state_id = "PROGRAM_DISABLED_PENDING_IMPORT_REACTIVATION"
		AND action_id = "PROGRAM_REACTIVATE"
		UNION
...
INSERT INTO STATE_TRANSITION (state_action_id, state_transition_type_id, transition_state_id, state_transition_evaluation_id, display_order)
	SELECT id, "ONE_COMPLETED", "PROJECT_DEACTIVATED", "PROJECT_CONFIGURATION_OUTCOME", 0
	FROM STATE_ACTION
	WHERE state_id = "PROJECT_APPROVED"
		AND action_id = "PROJECT_CONFIGURE"
		UNION
	SELECT id, "ONE_COMPLETED", "PROJECT_DISABLED", "PROJECT_CONFIGURATION_OUTCOME", 1
	FROM STATE_ACTION
	WHERE state_id = "PROJECT_APPROVED"
		AND action_id = "PROJECT_CONFIGURE"
		UNION
	SELECT id, "DUE_DATE_EXPIRY", "PROJECT_DISABLED_PENDING_REACTIVATION", NULL, NULL
	FROM STATE_ACTION
	WHERE state_id = "PROJECT_APPROVED"
...
INSERT INTO ROLE_TRANSITION (state_transition_id, role_id, role_transition_type_id, transition_role_id)
	SELECT STATE_TRANSITION.id, "PROJECT_APPLICATION_CREATOR", "REMOVE_ONE", NULL
	FROM STATE_TRANSITION INNER JOIN STATE_ACTION
		ON STATE_TRANSITION.state_action_id = STATE_ACTION.id
...
INSERT INTO STATE_TRANSITION (state_action_id, state_transition_type_id, transition_state_id, state_transition_evaluation_id, display_order)
	SELECT id, "ONE_COMPLETED", "PROJECT_APPROVED", "PROJECT_CONFIGURATION_OUTCOME", 0
	FROM STATE_ACTION
...
INSERT INTO STATE_TRANSITION (state_action_id, state_transition_type_id, transition_state_id, state_transition_evaluation_id, display_order)
	...
	WHERE state_id = "PROJECT_DISABLED_PENDING_REACTIVATION"
		AND action_id = "PROJECT_CONFIGURE"
		UNION
	SELECT id, "ONE_COMPLETED", "PROJECT_DEACTIVATED", "PROJECT_CONFIGURATION_OUTCOME", 1
	FROM STATE_ACTION
	WHERE state_id = "PROJECT_DISABLED_PENDING_REACTIVATION"
		AND action_id = "PROJECT_CONFIGURE"
		UNION
...
INSERT INTO STATE_TRANSITION (state_action_id, state_transition_type_id, transition_state_id, state_transition_evaluation_id)
	...
	WHERE state_id = "PROJECT_DISABLED_PENDING_PROGRAM_REACTIVATION"
		AND action_id = "PROJECT_REACTIVATE"
		UNION
	SELECT id, "PROPAGATION", "PROJECT_DISABLED_COMPLETED", NULL
	FROM STATE_ACTION
	WHERE state_id = "PROJECT_DISABLED_PENDING_PROGRAM_REACTIVATION"
		AND action_id = "PROJECT_ESCALATE"
		UNION
