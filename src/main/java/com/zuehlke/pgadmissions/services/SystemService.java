...
public class SystemService {
    ...
    public <T extends ImportedEntityRequest> void initializeSystemData() {
        for (PrismImportedEntity prismImportedEntity : PrismImportedEntity.values()) {
            ...
            try (InputStream iStream = documentService.getImportedDataSource(entityImport)) {
                if (iStream != null) {
                    List<T> representations = importedEntityMapper.getImportedEntityRepresentations(prismImportedEntity, iStream);
