...
INSERT INTO ROLE_TRANSITION (state_transition_id, role_id, role_transition_type_id, transition_role_id)
	...
	FROM STATE_TRANSITION INNER JOIN STATE_ACTION
		ON STATE_TRANSITION.state_action_id = STATE_ACTION.id
	INNER JOIN ROLE
	WHERE STATE_ACTION.action_id = "COMPLETE_REVIEW_STAGE"
		AND STATE_ACTION.state_id = "APPLICATION_REVIEW_PENDING_FEEDBACK"
...
INSERT INTO ROLE_TRANSITION (state_transition_id, role_id, role_transition_type_id, transition_role_id)
	...
	WHERE STATE_ACTION.action_id = "APPLICATION_COMPLETE_INTERVIEW_STAGE"
		...
		UNION
	SELECT STATE_TRANSITION.id, ROLE.id, "REMOVE_ONE", NULL
	FROM STATE_TRANSITION INNER JOIN STATE_ACTION
		ON STATE_TRANSITION.state_action_id = STATE_ACTION.id
	INNER JOIN ROLE
	WHERE STATE_ACTION.action_id = "APPLICATION_COMPLETE_INTERVIEW_STAGE"
...
INSERT INTO ROLE_TRANSITION (state_transition_id, role_id, role_transition_type_id, transition_role_id)
	...
	WHERE STATE_ACTION.action_id = "APPLICATION_COMPLETE_INTERVIEW_STAGE"
		...
		AND ROLE.id IN ("APPLICATION_ADMINISTRATOR", "APPLICATION_INTERVIEWER")
		UNION
	SELECT STATE_TRANSITION.id, "APPLICATION_INTERVIEWEE", "REMOVE_ONE", NULL
	FROM STATE_TRANSITION INNER JOIN STATE_ACTION
		ON STATE_TRANSITION.state_action_id = STATE_ACTION.id
	WHERE STATE_ACTION.action_id = "APPLICATION_COMPLETE_INTERVIEW_STAGE"
		AND STATE_ACTION.state_id = "APPLICATION_INTERVIEW_PENDING_INTERVIEW"
...
INSERT INTO ROLE_TRANSITION (state_transition_id, role_id, role_transition_type_id, transition_role_id)
	...
	FROM STATE_TRANSITION INNER JOIN STATE_ACTION
		ON STATE_TRANSITION.state_action_id = STATE_ACTION.id
	INNER JOIN ROLE
	WHERE STATE_ACTION.action_id = "COMPLETE_APPROVAL_STAGE"
		AND STATE_ACTION.state_id = "APPLICATION_APPROVAL_PENDING_FEEDBACK"
		AND ROLE.id IN ("APPLICATION_ADMINISTRATOR", "APPLICATION_PRIMARY_SUPERVISOR")
		UNION
	SELECT STATE_TRANSITION.id, "APPLICATION_ADMINISTRATOR", "CREATE_ALL", NULL
	FROM STATE_TRANSITION INNER JOIN STATE_ACTION
		ON STATE_TRANSITION.state_action_id = STATE_ACTION.id
...
INSERT INTO STATE_TRANSITION (state_action_id, state_transition_type_id, transition_state_id, display_order)
	...
	WHERE state_id = "PROGRAM_APPROVAL"
		AND action_id = "PROGRAM_COMPLETE_APPROVAL_STAGE"
		UNION
	SELECT id, "DUE_DATE_EXPIRY", "PROGRAM_DISABLED_COMPLETED", 0
	FROM STATE_ACTION
	WHERE state_id = "PROGRAM_APPROVAL"
...
INSERT INTO STATE_TRANSITION (state_action_id, state_transition_type_id, transition_state_id, display_order)
	...
	WHERE state_id = "PROGRAM_APPROVED"
		...
		UNION
	SELECT id, "ONE_COMPLETED", "PROGRAM_APPROVAL", 1
	FROM STATE_ACTION
	WHERE state_id = "PROGRAM_APPROVED"
		AND action_id = "PROGRAM_CONFIGURE"
		UNION
	SELECT id, "DUE_DATE_EXPIRY", "PROGRAM_DISABLED", NULL
	FROM STATE_ACTION
	WHERE state_id = "PROGRAM_APPROVED"
		AND action_id = "PROGRAM_ESCALATE"
;
...
INSERT INTO STATE_TRANSITION (state_action_id, state_transition_type_id, transition_state_id)
	SELECT id, "ONE_COMPLETED", "PROJECT_DEACTIVATED"
	FROM STATE_ACTION
	WHERE state_id = "PROJECT_APPROVED"
		AND action_id = "PROJECT_CONFIGURE"
		UNION
	SELECT id, "DUE_DATE_EXPIRY", "PROJECT_DISABLED"
	FROM STATE_ACTION
	WHERE state_id = "PROJECT_APPROVED"
...
CREATE TABLE STATE_TRANSITION_PROPAGATION (
	...
	invoked_state_id VARCHAR(50) NOT NULL,
	PRIMARY KEY (id),
	UNIQUE INDEX (trigger_state_id, current_state_id, invoked_state_id),
	INDEX (current_state_id),
	INDEX (invoked_state_id),
	FOREIGN KEY (trigger_state_id) REFERENCES STATE (id),
	FOREIGN KEY (current_state_id) REFERENCES STATE (id),
	FOREIGN KEY (invoked_state_id) REFERENCES STATE (id)
) ENGINE = INNODB
;

INSERT INTO STATE_TRANSITION_PROPAGATION (trigger_state_id, current_state_id, invoked_state_id)
	SELECT "PROGRAM_DISABLED_COMPLETED", id, "APPLICATION_WITHDRAWN_COMPLETED"
	FROM STATE
	WHERE parent_state_id = "APPLICATION_UNSUBMITTED"
;

INSERT INTO STATE_TRANSITION_PROPAGATION (trigger_state_id, current_state_id, invoked_state_id)
	SELECT "PROGRAM_REJECTED", id, "APPLICATION_WITHDRAWN_COMPLETED"
	FROM STATE
	WHERE parent_state_id = "APPLICATION_UNSUBMITTED"
;

INSERT INTO STATE_TRANSITION_PROPAGATION (trigger_state_id, current_state_id, invoked_state_id)
	SELECT "PROGRAM_DISABLED_COMPLETED", id, "APPLICATION_REJECTED_PENDING_EXPORT"
	FROM STATE
...
INSERT INTO STATE_TRANSITION_PROPAGATION (trigger_state_id, current_state_id, invoked_state_id)
	SELECT "PROGRAM_REJECTED", id, "APPLICATION_REJECTED_PENDING_EXPORT"
	FROM STATE
	WHERE parent_state_id IN ("APPLICATION_VALIDATION", "APPLICATION_REVIEW", 
		"APPLICATION_INTERVIEW", "APPLICATION_APPROVAL")
		OR id IN ("APPLICATION_APPROVED", "APPLICATION_REJECTED")
...
INSERT INTO STATE_TRANSITION_PROPAGATION (trigger_state_id, current_state_id, invoked_state_id)
	SELECT "PROJECT_DISABLED_COMPLETED", id, "APPLICATION_WITHDRAWN_COMPLETED"
	FROM STATE
	WHERE parent_state_id = "APPLICATION_UNSUBMITTED"
;

INSERT INTO STATE_TRANSITION_PROPAGATION (trigger_state_id, current_state_id, invoked_state_id)
	SELECT "PROJECT_DISABLED_COMPLETED", id, "APPLICATION_REJECTED_PENDING_EXPORT"
	FROM STATE
	WHERE parent_state_id IN ("APPLICATION_VALIDATION", "APPLICATION_REVIEW", 
		"APPLICATION_INTERVIEW", "APPLICATION_APPROVAL")
		OR id IN ("APPLICATION_APPROVED", "APPLICATION_REJECTED")
...
INSERT INTO STATE_TRANSITION_PROPAGATION (trigger_state_id, current_state_id, invoked_state_id)
	SELECT "PROGRAM_DISABLED_COMPLETED", id, "PROJECT_DISABLED_COMPLETED"
	FROM STATE
	WHERE id IN ("PROJECT_APPROVED", "PROJECT_DEACTIVATED", "PROJECT_DISABLED")
;

INSERT INTO STATE_TRANSITION_PROPAGATION (trigger_state_id, current_state_id, invoked_state_id)
	SELECT "PROGRAM_APPROVED", "PROJECT_DISABLED", "PROJECT_APPROVED"
;

INSERT INTO STATE_TRANSITION_PROPAGATION (trigger_state_id, current_state_id, invoked_state_id)
	SELECT "PROGRAM_REJECTED", "PROGRAM_APPROVAL", "PROJECT_DISABLED_COMPLETED"
;
