...
public class NotificationService {
    ...
    public NotificationConfiguration getNotificationConfiguration(Resource resource, User user, NotificationDefinition definition) {
        return (NotificationConfiguration) customizationService.getConfiguration(PrismConfiguration.NOTIFICATION, resource, resource.getLocale(),
                resource.getProgramType(), definition);
    }
