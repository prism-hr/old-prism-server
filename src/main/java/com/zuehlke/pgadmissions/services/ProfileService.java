...
public class ProfileService {
    ...
    private <T extends ProfileEntity<?, ?, ?, ?, ?, ?, ?>, U extends ProfilePersonalDetail<T>> U updatePersonalDetail(T profile, Class<U> personalDetailClass,
        ...
        personalDetail.setNationality(importedEntityService.getById(ImportedDomicile.class, getImportedEntityId(personalDetailDTO.getNationality())));
        personalDetail.setDomicile(importedEntityService.getById(ImportedDomicile.class, getImportedEntityId(personalDetailDTO.getDomicile())));
