			...
			<div id="middle">
				...
				<article id="content" role="main">
		            ...
		            <ul id="view-toolbar" class="toolbar">
		                ...
		                <li class="print"><a href="<@spring.url '/print?applicationFormId=${applicationForm.applicationNumber}'/>" title="Click to Download">Print</a></li>
					</ul>
									...
									<form>
										...
										<div class="row-group" id="assignSupervisorsToAppSection">			
											...
											<div class="row addremove-buttons">
												<div class="field">
													<span>
														<button class="blue" type="button" id="addSupervisorBtn">Add <span class="icon-down"></span></button>
