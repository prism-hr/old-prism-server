...
public enum PrismDisplayPropertyDefinition implements PrismConfigurationCategorizable<PrismDisplayPropertyCategory> {
    ...
    SYSTEM_OPPORTUNITIES_ADVERT_TAB_DESCRIPTION(SYSTEM_OPPORTUNITIES_SECTION, "Description"),
    SYSTEM_OPPORTUNITIES_ADVERT_TAB_OPPORTUNITIES(SYSTEM_OPPORTUNITIES_SECTION, "Opportunities"),
    SYSTEM_OPPORTUNITIES_ADVERT_TAB_DEPARTMENTS(SYSTEM_OPPORTUNITIES_SECTION, "Departments"),
    SYSTEM_OPPORTUNITIES_ADVERT_TAB_PARTNERS(SYSTEM_OPPORTUNITIES_SECTION, "Recruitment Partners"),
    SYSTEM_OPPORTUNITIES_ADVERT_TAB_EMPLOYERS(SYSTEM_OPPORTUNITIES_SECTION, "Employers"),
    SYSTEM_OPPORTUNITIES_ADVERT_TAB_LOCATION(SYSTEM_OPPORTUNITIES_SECTION, "Location"),
    SYSTEM_OPPORTUNITIES_ADVERT_TAB_COMPETENCES(SYSTEM_OPPORTUNITIES_SECTION, "Person Specification"),
    SYSTEM_OPPORTUNITIES_ADVERT_TAB_PROJECTS(SYSTEM_OPPORTUNITIES_SECTION, "Projects"),
    ...
    APPLICATION_STUDY_DETAIL_DIVISION_HINT(APPLICATION_STUDY_DETAIL,
            "The Department that you have applied to study in (e.g. Department, unit, division, institute)."),
